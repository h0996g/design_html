/*! For license information please see sortable.js.LICENSE.txt */ ! function(t, e) {
                    ...
                    t.exports = function() {
                        ...
                        function O(t, e, n, o, i) {
                            if (t.getBoundingClientRect || t === window) {
                                var r, a, l, s, u, d, h;
                                if (t !== window && t.parentNode && t !== T() ? (a = (r = t.getBoundingClientRect()).top, l = r.left, s = r.bottom, u = r.right, d = r.height, h = r.width) : (a = 0, l = 0, s = window.innerHeight, u = window.innerWidth, d = window.innerHeight, h = window.innerWidth), (e || n) && t !== window && (i = i || t.parentNode, !c))
                                    do {
                        ...
                        function N(t, e) {
                            for (var n = t.lastElementChild; n && (n === Ht.ghost || "none" === _(n, "display") || e && !b(n, e));) n = n.previousElementSibling;
                            return n || null
                        }
                        ...
                        function X(t, e) {
                            return function() {
                                if (!E) {
                                    var n = arguments;
                                    1 === n.length ? t.call(this, n[0]) : t.apply(this, n), E = setTimeout((function() {
                                        E = void 0
                                    }), e)
                                }
                            }
                        ...
                        function H(t, e, n) {
                            ...
                            return Array.from(t.children).forEach((function(i) {
                                ...
                                if (w(i, e.draggable, t, !1) && !i.animated && i !== n) {
                                    var c = O(i);
                                    o.left = Math.min(null !== (r = o.left) && void 0 !== r ? r : 1 / 0, c.left), o.top = Math.min(null !== (a = o.top) && void 0 !== a ? a : 1 / 0, c.top), o.right = Math.max(null !== (l = o.right) && void 0 !== l ? l : -1 / 0, c.right), o.bottom = Math.max(null !== (s = o.bottom) && void 0 !== s ? s : -1 / 0, c.bottom)
                                }
                        ...
                        var $, Q, J, tt, et, nt, ot, it, rt, at, lt, st, ct, ut, dt, ht, ft, pt, gt, vt, mt, bt, yt, wt, Et, Dt = !1,
                            St = !1,
                            _t = [],
                            Ct = !1,
                            xt = !1,
                        ...
                        At && !p && document.addEventListener("click", (function(t) {
                            if (St) return t.preventDefault(), t.stopPropagation && t.stopPropagation(), t.stopImmediatePropagation && t.stopImmediatePropagation(), St = !1, !1
                        }), !0);
                        var jt = function(t) {
                                if ($) {
                        ...
                        function zt(t, e, n, o, i, r, a, l) {
                            ...
                            if (!a)
                                if (l && wt < c * i) {
                                    if (!Ct && (1 === yt ? s > u + c * r / 2 : s < d - c * r / 2) && (Ct = !0), Ct) h = !0;
                                    else if (1 === yt ? s < u + wt : s > d - wt) return -yt
                        ...
                        Ht.prototype = {
                            ...
                            _onTapStart: function(t) {
                                if (t.cancelable) {
                                    ...
                                    if (function(t) {
                                        ...
                                        }(n), !$ && !(/mousedown|pointerdown/.test(r) && 0 !== t.button || o.disabled) && !s.isContentEditable && (this.nativeDraggable || !h || !l || "SELECT" !== l.tagName.toUpperCase()) && !((l = w(l, o.draggable, n, !1)) && l.animated || nt === l)) {
                                        if (rt = I(l), lt = I(l, o.draggable), "function" == typeof c) {
                                            if (c.call(this, t, l, this)) return Z({
                                                sortable: e,
                                                rootEl: s,
                                                name: "filter",
                                                targetEl: l,
                            ...
                            _prepareDragStart: function(t, e, n) {
                                ...
                                if (n && !$ && n.parentNode === r) {
                                    var s = O(n);
                                    if (tt = r, Q = ($ = n).parentNode, et = $.nextSibling, nt = n, ct = a.group, Ht.dragged = $, dt = {
                                            target: $,
                                            clientX: (e || t).clientX,
                                            clientY: (e || t).clientY
                                        }, gt = dt.clientX - s.left, vt = dt.clientY - s.top, this._lastX = (e || t).clientX, this._lastY = (e || t).clientY, $.style["will-change"] = "all", o = function() {
                                            V("delayEnded", i, {
                                                evt: t
                                            }), Ht.eventCanceled ? i._onDrop() : (i._disableDelayedDragEvents(), !d && i.nativeDraggable && ($.draggable = !0), i._triggerDragStart(t, e), Z({
                                                sortable: i,
                                                name: "choose",
                                                originalEvent: t
                                            }), S($, a.chosenClass, !0))
                                            ...
                                            x($, t.trim(), Kt)
                                        })), v(l, "dragover", jt), v(l, "mousemove", jt), v(l, "touchmove", jt), v(l, "mouseup", i._onDrop), v(l, "touchend", i._onDrop), v(l, "touchcancel", i._onDrop), d && this.nativeDraggable && (this.options.touchStartThreshold = 4, $.draggable = !0), V("delayStart", this, {
                                            evt: t
                            ...
                            _triggerDragStart: function(t, e) {
                                e = e || "touch" == t.pointerType && t, !this.nativeDraggable || e ? this.options.supportPointer ? v(document, "pointermove", this._onTouchMove) : v(document, e ? "touchmove" : "mousemove", this._onTouchMove) : (v($, "dragend", this), v(tt, "dragstart", this._onDragStart));
                                try {
                            ...
                            _dragStarted: function(t, e) {
                                if (Dt = !1, tt && $) {
                                    ...
                                    var n = this.options;
                                    !t && S($, n.dragClass, !1), S($, n.ghostClass, !0), Ht.active = this, t && this._appendGhost(), Z({
                                        sortable: this,
                                        name: "start",
                                        originalEvent: e
                                    })
                            ...
                            _emulateDragOver: function() {
                                if (ht) {
                                    ...
                                    if ($.parentNode[L]._isOutsideThisEl(t), e)
                                        do {
                            ...
                            _onTouchMove: function(t) {
                                if (dt) {
                                    ...
                                    if (J) {
                                        ...
                                        _(J, "webkitTransform", d), _(J, "mozTransform", d), _(J, "msTransform", d), _(J, "transform", d), ft = c, pt = u, ht = i
                                    }
                            ...
                            _appendGhost: function() {
                                if (!J) {
                                    ...
                                    if (Nt) {
                                        for (Et = t;
                                            "static" === _(Et, "position") && "none" === _(Et, "transform") && Et !== document;) Et = Et.parentNode;
                                        Et !== document.body && Et !== document.documentElement ? (Et === document && (Et = T()), e.top += Et.scrollTop, e.left += Et.scrollLeft) : Et = T(), Tt = P(Et)
                                    }
                                    S(J = $.cloneNode(!0), n.ghostClass, !1), S(J, n.fallbackClass, !0), S(J, n.dragClass, !0), _(J, "transition", ""), _(J, "transform", ""), _(J, "box-sizing", "border-box"), _(J, "margin", 0), _(J, "top", e.top), _(J, "left", e.left), _(J, "width", e.width), _(J, "height", e.height), _(J, "opacity", "0.8"), _(J, "position", Nt ? "absolute" : "fixed"), _(J, "zIndex", "100000"), _(J, "pointerEvents", "none"), Ht.ghost = J, t.appendChild(J), _(J, "transform-origin", gt / parseInt(J.style.width) * 100 + "% " + vt / parseInt(J.style.height) * 100 + "%")
                                }
                            },
                            _onDragStart: function(t, e) {
                                ...
                                V("dragStart", this, {
                                    evt: t
                                }), Ht.eventCanceled ? this._onDrop() : (V("setupClone", this), Ht.eventCanceled || ((ot = B($)).removeAttribute("id"), ot.draggable = !1, ot.style["will-change"] = "", this._hideClone(), S(ot, this.options.chosenClass, !1), Ht.clone = ot), n.cloneId = Ut((function() {
                                    V("clone", n), Ht.eventCanceled || (n.options.removeCloneOnHide || tt.insertBefore(ot, $), n._hideClone(), Z({
                                        sortable: n,
                                        name: "clone"
                                    }))
                                })), !e && S($, i.dragClass, !0), e ? (St = !0, n._loopId = setInterval(n._emulateDragOver, 50)) : (m(document, "mouseup", n._onDrop), m(document, "touchend", n._onDrop), m(document, "touchcancel", n._onDrop), o && (o.effectAllowed = "move", i.setData && i.setData.call(n, o, $)), v(document, "drop", n), _($, "transform", "translateZ(0)")), Dt = !0, n._dragStartId = Ut(n._dragStarted.bind(n, e, t)), v(document, "selectstart", n), mt = !0, h && _(document.body, "user-select", "none"))
                            },
                            _onDragOver: function(t) {
                                var n, o, i, r, a = this.el,
                                    ...
                                    g = !1;
                                if (!Ot) {
                                    if (void 0 !== t.preventDefault && t.cancelable && t.preventDefault(), l = w(l, s.draggable, a, !0), j("dragOver"), Ht.eventCanceled) return g;
                                    if ($.contains(t.target) || l.animated && l.animatingX && l.animatingY || p._ignoreWhileAnimating === l) return K(!1);
                                    if (St = !1, u && !s.disabled && (d ? h || (i = Q !== tt) : ut === this || (this.lastPutMode = ct.checkPull(this, u, $, t)) && c.checkPut(this, u, $, t))) {
                                        if (r = "vertical" === this._getDirection(t, l), n = O($), j("dragOverValid"), Ht.eventCanceled) return g;
                                        if (i) return Q = tt, F(), this._hideClone(), j("revert"), Ht.eventCanceled || (et ? tt.insertBefore($, et) : tt.appendChild($)), K(!0);
                                        ...
                                        if (!v || function(t, e, n) {
                                            ...
                                            if (v === $) return K(!1);
                                            if (v && a === t.target && (l = v), l && (o = O(l)), !1 !== Lt(tt, a, $, n, l, o, t, !!l)) return F(), v && v.nextSibling ? a.insertBefore($, v.nextSibling) : a.appendChild($), Q = a, W(), K(!0)
                                            ...
                                            var m = A(a, 0, s, !0);
                                            if (m === $) return K(!1);
                                            if (o = O(l = m), !1 !== Lt(tt, a, $, n, l, o, t, !1)) return F(), a.insertBefore($, m), Q = a, W(), K(!0)
                                        } else if (l.parentNode === a) {
                                            o = O(l);
                                            var b, y, E, D = $.parentNode !== a,
                                                C = ! function(t, e, n) {
                                                ...
                                                }($.animated && $.toRect || n, l.animated && l.toRect || o, r),
                                                x = r ? "top" : "left",
                                                T = M(l, "top", "top") || M($, "top", "top"),
                                                P = T ? T.scrollTop : void 0;
                                            if (bt !== l && (b = o[x], Ct = !1, xt = !C && s.invertSwap || D), 0 !== (E = zt(t, l, o, r, C ? 1 : s.swapThreshold, null == s.invertedSwapThreshold ? s.swapThreshold : s.invertedSwapThreshold, xt, bt === l))) {
                                                var k = I($);
                                                do {
                                                    k -= E, y = Q.children[k]
                                                } while (y && ("none" === _(y, "display") || y === J))
                                            }
                                            if (0 === E || y === l) return K(!1);
                                            bt = l, yt = E;
                                            var R = l.nextElementSibling,
                                                X = !1,
                                                B = Lt(tt, a, $, n, l, o, t, X = 1 === E);
                                            if (!1 !== B) return 1 !== B && -1 !== B || (X = 1 === B), Ot = !0, setTimeout(Wt, 30), F(), X && !R ? a.appendChild($) : l.parentNode.insertBefore($, X ? R : l), T && Y(T, 0, P - T.scrollTop), Q = $.parentNode, void 0 === b || xt || (wt = Math.abs(b - O(l)[x])), W(), K(!0)
                                        }
                                        if (a.contains($)) return K(!1)
                                    }
                                    return !1
                                }
                                ...
                                function F() {
                                    j("dragOverAnimationCapture"), p.captureAnimationState(), p !== f && f.captureAnimationState()
                                }

                                function K(e) {
                                    return j("dragOverCompleted", {
                                        insertion: e
                                    }), e && (d ? u._hideClone() : u._showClone(p), p !== f && (S($, ut ? ut.options.ghostClass : u.options.ghostClass, !1), S($, s.ghostClass, !0)), ut !== p && p !== Ht.active ? ut = p : p === Ht.active && ut && (ut = null), f === p && (p._ignoreWhileAnimating = l), p.animateAll((function() {
                                        j("dragOverAnimationComplete"), p._ignoreWhileAnimating = null
                                    })), p !== f && (f.animateAll(), f._ignoreWhileAnimating = null)), (l === $ && !$.animated || l === a && !l.animated) && (bt = null), s.dragoverBubble || t.rootEl || l === document || ($.parentNode[L]._isOutsideThisEl(t.target), !e && jt(t)), !s.dragoverBubble && t.stopPropagation && t.stopPropagation(), g = !0
                                }

                                function W() {
                                    at = I($), st = I($, s.draggable), Z({
                                        sortable: p,
                                        name: "change",
                                        toEl: a,
                                        newIndex: at,
                            ...
                            _offMoveEvents: function() {
                                m(document, "mousemove", this._onTouchMove), m(document, "touchmove", this._onTouchMove), m(document, "pointermove", this._onTouchMove), m(document, "dragover", jt), m(document, "mousemove", jt), m(document, "touchmove", jt)
                            },
                            ...
                            _onDrop: function(t) {
                                var e = this.el,
                                    n = this.options;
                                at = I($), st = I($, n.draggable), V("drop", this, {
                                    evt: t
                                }), Q = $ && $.parentNode, at = I($), st = I($, n.draggable), Ht.eventCanceled || (Dt = !1, xt = !1, Ct = !1, clearInterval(this._loopId), clearTimeout(this._dragStartTimer), qt(this.cloneId), qt(this._dragStartId), this.nativeDraggable && (m(document, "drop", this), m(e, "dragstart", this._onDragStart)), this._offMoveEvents(), this._offUpEvents(), h && _(document.body, "user-select", ""), _($, "transform", ""), t && (mt && (t.cancelable && t.preventDefault(), !n.dropBubble && t.stopPropagation()), J && J.parentNode && J.parentNode.removeChild(J), (tt === Q || ut && "clone" !== ut.lastPutMode) && ot && ot.parentNode && ot.parentNode.removeChild(ot), $ && (this.nativeDraggable && m($, "dragend", this), Kt($), $.style["will-change"] = "", mt && !Dt && S($, ut ? ut.options.ghostClass : this.options.ghostClass, !1), S($, this.options.chosenClass, !1), Z({
                                    sortable: this,
                                    name: "unchoose",
                                    toEl: Q,
                                    newIndex: null,
                                    ...
                                    toEl: Q,
                                    originalEvent: t
                                })), Ht.active && (null != at && -1 !== at || (at = rt, st = lt), Z({
                                    sortable: this,
                                    name: "end",
                                    toEl: Q,
                                    originalEvent: t
                            ...
                            _nulling: function() {
                                V("nulling", this), tt = $ = Q = J = et = ot = nt = it = dt = ht = mt = at = st = rt = lt = bt = yt = ut = ct = Ht.dragged = Ht.ghost = Ht.clone = Ht.active = null, Mt.forEach((function(t) {
                                    t.checked = !0
                                })), Mt.length = ft = pt = 0
                            },
                            ...
                            toArray: function() {
                                for (var t, e = [], n = this.el.children, o = 0, i = n.length, r = this.options; o < i; o++) w(t = n[o], r.draggable, this.el, !1) && e.push(t.getAttribute(r.dataIdAttr) || Gt(t));
                                return e
                            },
                            sort: function(t, e) {
                                var n = {},
                            ...
                            destroy: function() {
                                V("destroy", this);
                                var t = this.el;
                                t[L] = null, m(t, "mousedown", this._onTapStart), m(t, "touchstart", this._onTapStart), m(t, "pointerdown", this._onTapStart), this.nativeDraggable && (m(t, "dragover", this), m(t, "dragenter", this)), Array.prototype.forEach.call(t.querySelectorAll("[draggable]"), (function(t) {
                                    t.removeAttribute("draggable")
                                })), this._onDrop(), this._disableDelayedDragEvents(), _t.splice(_t.indexOf(this.el), 1), this.el = t = null
                            },
                            _hideClone: function() {
                                if (!it) {
                                    if (V("hideClone", this), Ht.eventCanceled) return;
                                    _(ot, "display", "none"), this.options.removeCloneOnHide && ot.parentNode && ot.parentNode.removeChild(ot), it = !0
                                }
                            },
                            _showClone: function(t) {
                                if ("clone" === t.lastPutMode) {
                                    if (it) {
                                        if (V("showClone", this), Ht.eventCanceled) return;
                                        $.parentNode != tt || this.options.group.revertClone ? et ? tt.insertBefore(ot, et) : tt.appendChild(ot) : tt.insertBefore(ot, $), this.options.group.revertClone && this.animate($, ot), _(ot, "display", ""), it = !1
                                    }
                            ...
                            n[0].constructor === Array && (n = n[0]), n.forEach((function(t) {
                                ...
                                t.utils && (Ht.utils = e(e({}, Ht.utils), t.utils)), G.mount(t)
                            }))
                        }, Ht.create = function(t, e) {
                            return new Ht(t, e)
                        }, Ht.version = "1.15.2";
                        var Vt, Zt, $t, Qt, Jt, te, ee = [],
                            ne = !1;
                        ...
                        var re, ae = X((function(t, e, n, o) {
                                if (e.scroll) {
                                    var i, r = (t.touches ? t.touches[0] : t).clientX,
                                        ...
                                        c = T(),
                                        u = !1;
                                    Zt !== n && (Zt = n, oe(), Vt = e.scroll, i = e.scrollFn, !0 === Vt && (Vt = k(n, !0)));
                                    var d = 0,
                                        h = Vt;
                                    do {
                                        var f = h,
                                            ...
                                            M = f.scrollLeft,
                                            A = f.scrollTop;
                                        f === c ? (E = y < S && ("auto" === x.overflowX || "scroll" === x.overflowX || "visible" === x.overflowX), D = w < C && ("auto" === x.overflowY || "scroll" === x.overflowY || "visible" === x.overflowY)) : (E = y < S && ("auto" === x.overflowX || "scroll" === x.overflowX), D = w < C && ("auto" === x.overflowY || "scroll" === x.overflowY));
                                        var N = E && (Math.abs(b - r) <= l && M + y < S) - (Math.abs(m - r) <= l && !!M),
                                            I = D && (Math.abs(v - a) <= l && A + w < C) - (Math.abs(g - a) <= l && !!A);
                                        if (!ee[d])
                                            for (var P = 0; P <= d; P++) ee[P] || (ee[P] = {});
                                        ee[d].vx == N && ee[d].vy == I && ee[d].el === f || (ee[d].el = f, ee[d].vx = N, ee[d].vy = I, clearInterval(ee[d].pid), 0 == N && 0 == I || (u = !0, ee[d].pid = setInterval(function() {
                        ...
                        return Ht.mount(new function() {
                            ...
                            return t.prototype = {
                                ...
                                drop: function() {
                                    this.sortable.nativeDraggable ? m(document, "dragover", this._handleAutoScroll) : (m(document, "pointermove", this._handleFallbackAutoScroll), m(document, "touchmove", this._handleFallbackAutoScroll), m(document, "mousemove", this._handleFallbackAutoScroll)), ie(), oe(), clearTimeout(E), E = void 0
                                },
                                nulling: function() {
                                    Jt = Zt = Vt = ne = te = $t = Qt = null, ee.length = 0
                                },
                                ...
                                _handleAutoScroll: function(t, e) {
                                    ...
                                    if (Jt = t, e || this.options.forceAutoScrollFallback || u || c || h) {
                                        ae(t, this.options, r, e);
                                        var a = k(r, !0);
                                        !ne || te && o === $t && i === Qt || (te && ie(), te = setInterval((function() {
                                            var r = k(document.elementFromPoint(o, i), !0);
                                            r !== a && (a = r, oe()), ae(t, n.options, r, e)
                                        }), 10), $t = o, Qt = i)
                                    } else {
                                        if (!this.options.bubbleScroll || k(r, !0) === T()) return void oe();
                        ...
                        }), Ht.mount(ce, se), Ht.mount(new function() {
                            function t() {
                                this.defaults = {
                            ...
                            return t.prototype = {
                                ...
                                dragOverValid: function(t) {
                                    ...
                                    if (i.options.swap) {
                                        ...
                                        if (n && n !== l) {
                                            var c = re;
                                            !1 !== o(n) ? (S(n, s.swapClass, !0), re = n) : re = null, c && c !== re && S(c, s.swapClass, !1)
                                        }
                                        r(), e(!0), a()
                                    }
                                },
                                drop: function(t) {
                                    var e, n, o, i, r, a, l = t.activeSortable,
                                        s = t.putSortable,
                                        c = t.dragEl,
                                        u = s || this.sortable,
                                        d = this.options;
                                    re && S(re, d.swapClass, !1), re && (d.swap || s && s.options.swap) && c !== re && (u.captureAnimationState(), u !== l && l.captureAnimationState(), n = re, r = (e = c).parentNode, a = n.parentNode, r && a && !r.isEqualNode(n) && !a.isEqualNode(e) && (o = I(e), i = I(n), r.isEqualNode(a) && o < i && i++, r.insertBefore(n, r.children[o]), a.insertBefore(e, a.children[i])), u.animateAll(), u !== l && l.animateAll())
                                },
                                nulling: function() {
                                    re = null
                                }
                            ...
                            function t(t) {
                                ...
                                t.options.avoidImplicitDeselect || (t.options.supportPointer ? v(document, "pointerup", this._deselectMultiDrag) : (v(document, "mouseup", this._deselectMultiDrag), v(document, "touchend", this._deselectMultiDrag))), v(document, "keydown", this._checkKeyDown), v(document, "keyup", this._checkKeyUp), this.defaults = {
                            ...
                            return t.prototype = {
                                ...
                                setupClone: function(t) {
                                    var e = t.sortable,
                                        n = t.cancel;
                                    if (this.isMultiDrag) {
                                        for (var o = 0; o < ge.length; o++) ve.push(B(ge[o])), ve[o].sortableIndex = ge[o].sortableIndex, ve[o].draggable = !1, ve[o].style["will-change"] = "", S(ve[o], this.options.selectedClass, !1), ge[o] === he && S(ve[o], this.options.chosenClass, !1);
                                        e._hideClone(), n()
                                    }
                                },
                                clone: function(t) {
                                    var e = t.sortable,
                                        ...
                                        i = t.cancel;
                                    this.isMultiDrag && (this.options.removeCloneOnHide || ge.length && de === e && (we(!0, n), o("clone"), i()))
                                },
                                showClone: function(t) {
                                    var e = t.cloneNowShown,
                                        n = t.rootEl,
                                        o = t.cancel;
                                    this.isMultiDrag && (we(!1, n), ve.forEach((function(t) {
                                        _(t, "display", "")
                                    })), e(), pe = !1, o())
                                },
                                ...
                                dragStartGlobal: function(t) {
                                    t.sortable, !this.isMultiDrag && de && de.multiDrag._deselectMultiDrag(), ge.forEach((function(t) {
                                        t.sortableIndex = I(t)
                                ...
                                dragStarted: function(t) {
                                    ...
                                    if (this.isMultiDrag) {
                                        ...
                                        n.animateAll((function() {
                                            be = !1, me = !1, e.options.animation && ge.forEach((function(t) {
                                                F(t)
                                            })), e.options.sort && Ee()
                                        }))
                                    }
                                ...
                                revert: function(t) {
                                    ...
                                    ge.length > 1 && (ge.forEach((function(t) {
                                        o.addAnimationState({
                                            target: t,
                                            rect: be ? O(t) : i
                                        }), F(t), t.fromRect = i, e.removeAnimationState(t)
                                    })), be = !1, function(t, e) {
                                ...
                                dragOverCompleted: function(t) {
                                    var e = t.sortable,
                                        ...
                                        l = this.options;
                                    if (o) {
                                        if (n && i._hideClone(), me = !1, l.animation && ge.length > 1 && (be || !n && !i.options.sort && !a)) {
                                            var s = O(he, !1, !0, !0);
                                            ge.forEach((function(t) {
                                                t !== he && (j(t, s), r.appendChild(t))
                                            })), be = !0
                                        }
                                        if (!n)
                                            if (be || Ee(), ge.length > 1) {
                                                var c = pe;
                                                i._showClone(e), i.options.animation && !pe && c && ve.forEach((function(t) {
                                                    i.addAnimationState({
                                                        target: t,
                                                        rect: fe
                                                    }), t.fromRect = fe, t.thisAnimationDuration = null
                                                }))
                                            } else i._showClone(e)
                                    }
                                },
                                ...
                                drop: function(t) {
                                    ...
                                    if (e) {
                                        var c = this.options,
                                            u = o.children;
                                        if (!ye)
                                            if (c.multiDragKey && !this.multiDragKeyDown && this._deselectMultiDrag(), S(he, c.selectedClass, !~ge.indexOf(he)), ~ge.indexOf(he)) ge.splice(ge.indexOf(he), 1), ue = null, U({
                                                sortable: i,
                                                rootEl: n,
                                                name: "deselect",
                                                targetEl: he,
                                                ...
                                                if (ge.push(he), U({
                                                    ...
                                                    var d, h, f = I(ue),
                                                        p = I(he);
                                                    if (~f && ~p && f !== p)
                                                        for (p > f ? (h = f, d = p) : (h = p, d = f + 1); h < d; h++) ~ge.indexOf(u[h]) || (S(u[h], c.selectedClass, !0), ge.push(u[h]), U({
                                                            sortable: i,
                                                            rootEl: n,
                                                            name: "select",
                                                            targetEl: u[h],
                                        ...
                                        if (ye && this.isMultiDrag) {
                                            if (be = !1, (o[L].options.sort || o !== n) && ge.length > 1) {
                                                var g = O(he),
                                                    v = I(he, ":not(." + this.options.selectedClass + ")");
                                                if (!me && c.animation && (he.thisAnimationDuration = null), s.captureAnimationState(), !me && (c.animation && (he.fromRect = g, ge.forEach((function(t) {
                                ...
                                _deselectMultiDrag: function(t) {
                                    if (!(void 0 !== ye && ye || de !== this.sortable || t && w(t.target, this.options.draggable, this.sortable.el, !1) || t && 0 !== t.button))
                                        for (; ge.length;) {
                                            var e = ge[0];
                                            S(e, this.options.selectedClass, !1), ge.shift(), U({
                                ...
                                utils: {
                                    select: function(t) {
                                        ...
                                        e && e.options.multiDrag && !~ge.indexOf(t) && (de && de !== e && (de.multiDrag._deselectMultiDrag(), de = e), S(t, e.options.selectedClass, !0), ge.push(t))
                                    },
                                    deselect: function(t) {
                                        var e = t.parentNode[L],
                                            n = ge.indexOf(t);
                                        e && e.options.multiDrag && ~n && (S(t, e.options.selectedClass, !1), ge.splice(n, 1))
                                    }
                                },
                                eventProperties: function() {
                                    var t = this,
                                    ...
                                    return ge.forEach((function(o) {
                                        ...
                                        }), i = be && o !== he ? -1 : be ? I(o, ":not(." + t.options.selectedClass + ")") : I(o), n.push({
                                            multiDragElement: o,
                                            index: i
                                        })
                                    })), {
