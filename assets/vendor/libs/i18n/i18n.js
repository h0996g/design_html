! function(t, e) {
    ...
    return function() {
                    ...
                    ! function(t) {
                        ! function(e) {
                            ...
                            function w(t, e) {
                                ...
                                if (this.credentials = e.credentials || this.credentials || "same-origin", !e.headers && this.headers || (this.headers = new f(e.headers)), this.method = (n = (o = e.method || this.method || "GET").toUpperCase(), v.indexOf(n) > -1 ? n : o), this.mode = e.mode || this.mode || null, this.signal = e.signal || this.signal, this.referrer = null, ("GET" === this.method || "HEAD" === this.method) && r) throw new TypeError("Body not allowed for GET or HEAD requests");
                            ...
                            k.polyfill = !0, o.fetch || (o.fetch = k, o.Headers = f, o.Request = w, o.Response = S), e.Headers = f, e.Request = w, e.Response = S, e.fetch = k
                        }({})
        ...
        return function() {
            ...
            function p(t, e, o) {
                for (const n in e) "__proto__" !== n && "constructor" !== n && (n in t ? "string" == typeof t[n] || t[n] instanceof String || "string" == typeof e[n] || e[n] instanceof String ? o && (t[n] = e[n]) : p(t[n], e[n], o) : t[n] = e[n]);
                return t
            }
                ...
                for (let t = 0; t < n.length; ++t) {
                    ...
                    if (void 0 === r[n[t]]) {
                        let i = 2,
                            ...
                            a = r[s];
                        for (; void 0 === a && n.length > t + i;) i++, s = n.slice(t, t + i).join(o), a = r[s];
                        if (void 0 === a) return;
            ...
            class b extends n {
                ...
                getResource(t, e, o) {
                    ...
                    let s = [t, e];
                    o && "string" != typeof o && (s = s.concat(o)), o && "string" == typeof o && (s = s.concat(r ? o.split(r) : o)), t.indexOf(".") > -1 && (s = t.split("."));
                ...
                addResource(t, e, o, n) {
                    ...
                    let s = [t, e];
                    o && (s = s.concat(i ? o.split(i) : o)), t.indexOf(".") > -1 && (s = t.split("."), n = e, e = s[1]), this.addNamespaces(e), u(this.data, s, n), r.silent || this.emit("added", t, e, o, n)
                }
                addResources(t, e, o) {
                    let n = arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : {
                        silent: !1
                ...
                addResourceBundle(t, e, o, n, r) {
                    ...
                    n ? p(a, o, r) : a = { ...a,
                        ...o
                    }, u(this.data, s, a), i.silent || this.emit("added", t, e, o)
                }
            ...
            class x extends n {
                constructor(t) {
                    let e = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {};
                    var n, r;
                    super(), n = t, r = this, ["resourceStore", "languageUtils", "pluralResolver", "interpolator", "backendConnector", "i18nFormat", "utils"].forEach((t => {
                        n[t] && (r[t] = n[t])
                ...
                extractFromKey(t, e) {
                    ...
                    if (i && !s) {
                        ...
                        const i = t.split(o);
                        (o !== n || o === n && this.options.ns.indexOf(i[0]) > -1) && (r = i.shift()), t = i.join(n)
                    }
                ...
                translate(t, e, o) {
                    ...
                    if (y && p && "string" != typeof p && "boolean" != typeof p && "number" != typeof p && ["[object Number]", "[object Function]", "[object RegExp]"].indexOf(d) < 0 && ("string" != typeof g || "[object Array]" !== d)) {
                    ...
                    } else if (y && "string" == typeof g && "[object Array]" === d) p = p.join(g), p && (p = this.extendTranslation(p, t, e, o));
                    else {
                        let n = !1,
                            s = !1;
                        ...
                        !this.isValidLookup(p) && h && (n = !0, p = y), this.isValidLookup(p) || (s = !0, p = i);
                        ...
                        if (s || n || b) {
                            if (this.logger.log(b ? "updateKey" : "missingKey", l, a, i, b ? y : p), r) {
                                const t = this.resolve(i, { ...e,
                                    keySeparator: !1
                                });
                            ...
                            const n = (t, o, n) => {
                                const r = h && n !== p ? n : m;
                                this.options.missingKeyHandler ? this.options.missingKeyHandler(t, a, o, r, b, e) : this.backendConnector && this.backendConnector.saveMissing && this.backendConnector.saveMissing(t, a, o, r, b, e), this.emit("missingKey", t, a, o, p)
                            };
                        ...
                        p = this.extendTranslation(p, t, e, c, o), s && p === i && this.options.appendNamespaceToMissingKey && (p = `${a}:${i}`), (s || n) && this.options.parseMissingKeyHandler && (p = "v1" !== this.options.compatibilityAPI ? this.options.parseMissingKeyHandler(this.options.appendNamespaceToMissingKey ? `${a}:${i}` : i, n ? p : void 0) : this.options.parseMissingKeyHandler(p))
                    }
                    return n ? (c.res = p, c.usedParams = this.getUsedParamsDetails(e), c) : p
                }
                extendTranslation(t, e, o, n, r) {
                    ...
                    if (this.i18nFormat && this.i18nFormat.parse) t = this.i18nFormat.parse(t, { ...this.options.interpolation.defaultVariables,
                        ...
                        if (this.options.interpolation.defaultVariables && (l = { ...this.options.interpolation.defaultVariables,
                            ...
                            return r && r[0] === n[0] && !o.context ? (i.logger.warn(`It seems you are nesting recursively key: ${n[0]} in key: ${e[0]}`), null) : i.translate(...n, e)
                ...
                resolve(t) {
                    ...
                    return "string" == typeof t && (t = [t]), t.forEach((t => {
                        ...
                        u.forEach((t => {
                            this.isValidLookup(e) || (i = t, !w[`${f[0]}-${t}`] && this.utils && this.utils.hasLoadedNamespace && !this.utils.hasLoadedNamespace(i) && (w[`${f[0]}-${t}`] = !0, this.logger.warn(`key "${o}" for languages "${f.join(", ")}" won't get resolved as namespace "${i}" was not yet loaded`, "This means something IS WRONG in your setup. You access the t function before i18next.init / i18next.loadNamespace / i18next.changeLanguage was done. Wait for the callback or Promise to resolve before accessing it!!!")), f.forEach((o => {
                                if (this.isValidLookup(e)) return;
                                r = o;
                                const i = [l];
                                if (this.i18nFormat && this.i18nFormat.addLookupKeys) this.i18nFormat.addLookupKeys(i, l, o, t, s);
                                else {
                                    let t;
                                    ...
                                    if (c && (i.push(l + t), s.ordinal && 0 === t.indexOf(n) && i.push(l + t.replace(n, this.options.pluralSeparator)), p && i.push(l + e)), h) {
                                        const o = `${l}${this.options.contextSeparator}${s.context}`;
                                        i.push(o), c && (i.push(o + t), s.ordinal && 0 === t.indexOf(n) && i.push(o + t.replace(n, this.options.pluralSeparator)), p && i.push(o + e))
                                    }
                                }
                                let a;
                                for (; a = i.pop();) this.isValidLookup(e) || (n = a, e = this.getResource(o, t, a, s))
                            })))
                        }))
                    })), {
                        res: e,
                ...
                getUsedParamsDetails() {
                    ...
                    let n = o ? t.replace : t;
                    if (o && void 0 !== t.count && (n.count = t.count), this.options.interpolation.defaultVariables && (n = { ...this.options.interpolation.defaultVariables,
                            ...n
                        }), !o) {
                        n = { ...n
                        };
            ...
            class O {
                ...
                toResolveHierarchy(t, e) {
                    ...
                    return "string" == typeof t && (t.indexOf("-") > -1 || t.indexOf("_") > -1) ? ("languageOnly" !== this.options.load && r(this.formatLanguageCode(t)), "languageOnly" !== this.options.load && "currentOnly" !== this.options.load && r(this.getScriptPartFromCode(t)), "currentOnly" !== this.options.load && r(this.getLanguagePartFromCode(t))) : "string" == typeof t && r(this.formatLanguageCode(t)), o.forEach((t => {
            ...
            class E {
                constructor(t) {
                    let e = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {};
                    this.languageUtils = t, this.options = e, this.logger = o.create("pluralResolver"), this.options.compatibilityJSON && !j.includes(this.options.compatibilityJSON) || "undefined" != typeof Intl && Intl.PluralRules || (this.options.compatibilityJSON = "v3", this.logger.error("Your environment seems not to be Intl API compatible, use an Intl.PluralRules polyfill. Will fallback to the compatibilityJSON v3 format handling.")), this.rules = function() {
                        const t = {};
                        return k.forEach((e => {
                            e.lngs.forEach((o => {
                                t[o] = {
            ...
            function C(t, e, o) {
                ...
                return !i && r && "string" == typeof o && (i = y(t, o, n), void 0 === i && (i = y(e, o, n))), i
            }
            class N {
                constructor() {
                    let t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {};
                ...
                interpolate(t, e, o, n) {
                    ...
                    const c = t => {
                        if (t.indexOf(this.formatSeparator) < 0) {
                            ...
                            return this.alwaysFormat ? this.format(r, void 0, o, { ...n,
                                ...e,
                                interpolationkey: t
                            }) : r
                        }
                        ...
                        return this.format(C(e, l, i, this.options.keySeparator, this.options.ignoreJSONStructure), s, o, { ...n,
                            ...e,
                            interpolationkey: i
                        })
                    };
                        ...
                        for (s = 0; r = e.regex.exec(t);) {
                            ...
                            if (i = c(o), void 0 === i)
                                if ("function" == typeof p) {
                                    const e = p(t, r, n);
                                    i = "string" == typeof e ? e : ""
                                } else if (n && Object.prototype.hasOwnProperty.call(n, o)) i = "";
                            else {
                                if (h) {
                                    i = r[0];
                                    continue
                                }
                                this.logger.warn(`missed to pass in variable ${o} for interpolating ${t}`), i = ""
                            } else "string" == typeof i || this.useRawValueToEscape || (i = a(i));
                            const l = e.safeValue(i);
                            if (t = t.replace(r[0], l), h ? (e.regex.lastIndex += i.length, e.regex.lastIndex -= r[0].length) : e.regex.lastIndex = 0, s++, s >= this.maxReplaces) break
                        }
                    })), t
                }
                nest(t, e) {
                    ...
                    function s(t, e) {
                        ...
                        try {
                            r = JSON.parse(i), e && (r = { ...e,
                                ...r
                            })
                        } catch (e) {
                            return this.logger.warn(`failed parsing options string in nesting for key ${t}`, e), `${t}${o}${i}`
                        }
                    ...
                    for (; o = this.nestingRegexp.exec(t);) {
                        let l = [];
                        r = { ...i
                        }, r = r.replace && "string" != typeof r.replace ? r.replace : r, r.applyPostProcessor = !1, delete r.defaultValue;
                        let u = !1;
                        if (-1 !== o[0].indexOf(this.formatSeparator) && !/{.*}/.test(o[1])) {
                            const t = o[1].split(this.formatSeparator).map((t => t.trim()));
                            o[1] = t.shift(), l = t, u = !0
                        }
                        if (n = e(s.call(this, o[1].trim(), r), r), n && o[0] === t && "string" != typeof n) return n;
                        "string" != typeof n && (n = a(n)), n || (this.logger.warn(`missed to resolve ${o[1]} for nesting ${t}`), n = ""), u && (n = l.reduce(((t, e) => this.format(t, e, i.lng, { ...i,
                        ...
                        const {
                            ...
                            if (t.indexOf("(") > -1) {
                                ...
                                "currency" === e && r.indexOf(":") < 0 ? o.currency || (o.currency = r.trim()) : "relativetime" === e && r.indexOf(":") < 0 ? o.range || (o.range = r.trim()) : r.split(";").forEach((t => {
                                    if (!t) return;
                                    const [e, ...n] = t.split(":"), r = n.join(":").trim().replace(/^'+|'+$/g, "");
                                    o[e.trim()] || (o[e.trim()] = r), "false" === r && (o[e.trim()] = !1), "true" === r && (o[e.trim()] = !0), isNaN(r) || (o[e.trim()] = parseInt(r, 10))
                                }))
                            }
                            return {
                                formatName: e,
            ...
            class D extends n {
                ...
                queueLoad(t, e, o, n) {
                    ...
                    return t.forEach((t => {
                        ...
                        e.forEach((e => {
                            const s = `${t}|${e}`;
                            !o.reload && this.store.hasResourceBundle(t, e) ? this.state[s] = 2 : this.state[s] < 0 || (1 === this.state[s] ? void 0 === i[s] && (i[s] = !0) : (this.state[s] = 1, n = !1, void 0 === i[s] && (i[s] = !0), void 0 === r[s] && (r[s] = !0), void 0 === a[e] && (a[e] = !0)))
                        })), n || (s[t] = !0)
                ...
                loaded(t, e, o) {
                    const n = t.split("|"),
                        r = n[0],
                        i = n[1];
                    e && this.emit("failedLoading", r, i, e), o && this.store.addResourceBundle(r, i, o), this.state[t] = e ? -1 : 2;
                    const s = {};
                ...
                loadOne(t) {
                    ...
                    this.read(n, r, "read", void 0, void 0, ((o, i) => {
                        o && this.logger.warn(`${e}loading namespace ${r} for language ${n} failed`, o), !o && i && this.logger.log(`${e}loaded namespace ${r} for language ${n}`, i), this.loaded(t, o, i)
                    }))
                }
                saveMissing(t, e, o, n, r) {
                    ...
                    if (this.services.utils && this.services.utils.hasLoadedNamespace && !this.services.utils.hasLoadedNamespace(e)) this.logger.warn(`did not save key "${o}" as the namespace "${e}" was not yet loaded`, "This means something IS WRONG in your setup. You access the t function before i18next.init / i18next.loadNamespace / i18next.changeLanguage was done. Wait for the callback or Promise to resolve before accessing it!!!");
                        ...
                        if (this.backend && this.backend.create) {
                            ...
                            if (l.length < 6) try {
                                let r;
                                r = 5 === l.length ? l(t, e, o, n, a) : l(t, e, o, n), r && "function" == typeof r.then ? r.then((t => s(null, t))).catch(s) : s(null, r)
                            } catch (t) {
                                s(t)
                            } else l(t, e, o, n, s, a)
                        }
            ...
            class F extends n {
                ...
                init() {
                    ...
                    if (this.options = { ...r,
                        ...
                        let e;
                        this.modules.logger ? o.init(i(this.modules.logger), this.options) : o.init(null, this.options), this.modules.formatter ? e = this.modules.formatter : "undefined" != typeof Intl && (e = A);
                        ...
                        }), !e || this.options.interpolation.format && this.options.interpolation.format !== r.interpolation.format || (s.formatter = i(e), s.formatter.init(s, this.options), this.options.interpolation.format = s.formatter.format.bind(s.formatter)), s.interpolator = new N(this.options), s.utils = {
                            hasLoadedNamespace: this.hasLoadedNamespace.bind(this)
                        }, s.backendConnector = new D(i(this.modules.backend), s.resourceStore, s, this.options), s.backendConnector.on("*", (function(e) {
                ...
                changeLanguage(t, e) {
                    ...
                    const r = t => {
                        ...
                        a = e => {
                            ...
                            o && (this.language || r(o), this.translator.language || this.translator.changeLanguage(o), this.services.languageDetector && this.services.languageDetector.cacheUserLanguage && this.services.languageDetector.cacheUserLanguage(o)), this.loadResources(o, (t => {
                                i(t, o)
                            }))
                        };
                ...
                getFixedT(t, e, o) {
                    ...
                    const r = function(t, e) {
                        ...
                        i.lng = i.lng || r.lng, i.lngs = i.lngs || r.lngs, i.ns = i.ns || r.ns, i.keyPrefix = i.keyPrefix || o || r.keyPrefix;
                        const u = n.options.keySeparator || ".";
                        let c;
                        return c = i.keyPrefix && Array.isArray(t) ? t.map((t => `${i.keyPrefix}${u}${t}`)) : i.keyPrefix ? `${i.keyPrefix}${u}${t}` : t, n.t(c, i)
                    };
                    return "string" == typeof t ? r.lng = t : r.lngs = t, r.ns = e, r.keyPrefix = o, r
                }
                t() {
                ...
                loadLanguages(t, e) {
                    ...
                    return r.length ? (this.options.preload = n.concat(r), this.loadResources((t => {
                        o.resolve(), e && e(t)
                    })), o) : (e && e(), Promise.resolve())
                }
                dir(t) {
                ...
                cloneInstance() {
                    ...
                    }, o && (r.store = new b(this.store.data, n), r.services.resourceStore = r.store), r.translator = new x(r.services, n), r.translator.on("*", (function(t) {
                        for (var e = arguments.length, o = new Array(e > 1 ? e - 1 : 0), n = 1; n < e; n++) o[n - 1] = arguments[n];
                        r.emit(t, ...o)
            ...
            var W = function(t, e) {
                ...
                Q = !1,
                Z = function(t, e, o, n) {
                    return "function" == typeof o && (n = o, o = void 0), n = n || function() {}, H && 0 !== e.indexOf("file:") ? function(t, e, o, n) {
                        t.queryStringParams && (e = W(e, t.queryStringParams));
                        var r = X({}, "function" == typeof t.customHeaders ? t.customHeaders() : t.customHeaders);
                        "undefined" == typeof window && "undefined" != typeof global && void 0 !== global.process && global.process.versions && global.process.versions.node && (r["User-Agent"] = "i18next-http-backend (node/".concat(global.process.version, "; ").concat(global.process.platform, " ").concat(global.process.arch, ")")), o && (r["Content-Type"] = "application/json");
                        ...
                        try {
                            ...
                            if (!i || 0 === Object.keys(i).length || !t.message || t.message.indexOf("not implemented") < 0) return n(t);
                            try {
                        ...
                        o && "object" === G(o) && (o = W("", o).slice(1)), t.queryStringParams && (e = W(e, t.queryStringParams));
                        try {
                            var r;
                            (r = V ? new V : new q("MSXML2.XMLHTTP.3.0")).open(o ? "POST" : "GET", e, 1), t.crossDomain || r.setRequestHeader("X-Requested-With", "XMLHttpRequest"), r.withCredentials = !!t.withCredentials, o && r.setRequestHeader("Content-Type", "application/x-www-form-urlencoded"), r.overrideMimeType && r.overrideMimeType("application/json");
                ...
                return e = t, o = [{
                    ...
                    value: function(t) {
                        var e = this,
                            ...
                            n = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : {};
                        this.services = t, this.options = ot(ot(ot({}, {
                        ...
                        }), this.options || {}), o), this.allOptions = n, this.services && this.options.reloadInterval && setInterval((function() {
                            return e.reload()
                    ...
                    value: function(t, e, o, n) {
                        ...
                        this.options.request(this.options, t, a, (function(i, s) {
                            ...
                            if (!s && i && i.message && i.message.indexOf("Failed to fetch") > -1) return e("failed loading " + t + ": " + i.message, !0);
                            if (i) return e(i, !1);
                            var a, l;
                            try {
                        ...
                        if (this.options.addPath) {
                            ...
                            t.forEach((function(o) {
                                ...
                                i.options.request(i.options, c, s, (function(e, o) {
                                    a += 1, l.push(e), u.push(o), a === t.length && "function" == typeof r && r(l, u)
                                }))
                            }))
                        }
                    }
                            ...
                            a(i), this.allOptions.preload && this.allOptions.preload.forEach((function(t) {
                                ...
                                t.allOptions.ns.forEach((function(t) {
                                    o.read(e, t, "read", null, null, (function(n, i) {
                                        n && r.warn("loading namespace ".concat(t, " for language ").concat(e, " failed"), n), !n && i && r.log("loaded namespace ".concat(t, " for language ").concat(e), i), o.loaded("".concat(e, "|").concat(t), n, i)
                                    }))
                                }))
                            }))
                        }
            ...
            var pt = [],
                ...
                gt = {
                    ...
                    cacheUserLanguage: function(t, e) {
                        e.lookupCookie && "undefined" != typeof document && function(t, e, o, n) {
                            ...
                            o && (r.expires = new Date, r.expires.setTime(r.expires.getTime() + 60 * o * 1e3)), n && (r.domain = n), document.cookie = function(t, e, o) {
                                var n = o || {};
                                n.path = n.path || "/";
                                ...
                                if (n.domain) {
                                    if (!dt.test(n.domain)) throw new TypeError("option domain is invalid");
                                    i += "; Domain=".concat(n.domain)
                                }
                                if (n.path) {
                                    if (!dt.test(n.path)) throw new TypeError("option path is invalid");
                ...
                jt = function() {
                    ...
                    return e = t, o = [{
                        ...
                        value: function(t) {
                            ...
                            this.services = t || {
                                ...
                                return t.replace("-", "_")
                            }), this.options.lookupFromUrlIndex && (this.options.lookupFromPathIndex = this.options.lookupFromUrlIndex), this.i18nOptions = o, this.addDetector(gt), this.addDetector(yt), this.addDetector(vt), this.addDetector(St), this.addDetector(Ot), this.addDetector(kt), this.addDetector(Lt), this.addDetector(Pt)
                        }
                    }, {
                        key: "addDetector",
                        value: function(t) {
                    ...
                    }], o && ct(e.prototype, o), Object.defineProperty(e, "prototype", {
                        writable: !1
                    }), t;
                    var e, o
                }();
