        ...
        var l = {
                9634: function(l, n, u) {
                    (function() {
                        ...
                        function M(l) {
                            this.H = RegExp(" "), this.C = "", this.m = new u, this.w = "", this.i = new u, this.u = new u, this.l = !0, this.A = this.o = this.F = !1, this.G = w.b(), this.s = 0, this.b = new u, this.B = !1, this.h = "", this.a = new u, this.f = [], this.D = l, this.J = this.g = B(this, this.D)
                        }
                        ...
                        function C(l) {
                            for (var n = l.f.length, u = 0; u < n; ++u) {
                                ...
                                if (-1 != d.indexOf("|")) e = !1;
                                    ...
                                    0 < (a = f.length < a.a.b.length ? "" : (a = f.replace(new RegExp(d, "g"), o)).replace(RegExp("9", "g"), " ")).length ? (e.m.a(a), e = !0) : e = !1
                                }
