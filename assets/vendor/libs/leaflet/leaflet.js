/*! For license information please see leaflet.js.LICENSE.txt */ ! function(t, e) {
                ...
                5243: function(t, e) {
                    ! function(t) {
                        ...
                        C.extend = function(t) {
                            ...
                            return t.statics && e(n, t.statics), t.includes && (function(t) {
                            ...
                            }(t.includes), e.apply(null, [s].concat(t.includes))), e(s, t), delete s.statics, delete s.includes, s.options && (s.options = o.options ? i(o.options) : {}, e(s.options, t.options)), s._initHooks = [], s.callInitHooks = function() {
                        ...
                        var S = {
                            ...
                            once: function(t, e, i) {
                                if ("object" == typeof t)
                                    ...
                                    for (var o = 0, s = (t = c(t)).length; o < s; o++) this._on(t[o], e, i, !0);
                                return this
                            },
                        ...
                        function O(t, e, i) {
                            return t instanceof E ? t : f(t) ? new E(t[0], t[1]) : null == t ? t : "object" == typeof t && "x" in t && "y" in t ? new E(t.x, t.y) : new E(t, e, i)
                        }
                        ...
                        E.prototype = {
                            ...
                            extend: function(t) {
                                var e, i;
                                if (!t) return this;
                                if (t instanceof E || "number" == typeof t[0] || "x" in t) e = i = O(t);
                                else if (e = (t = B(t)).min, i = t.max, !e || !i) return this;
                            ...
                            contains: function(t) {
                                var e, i;
                                return (t = "number" == typeof t[0] || t instanceof E ? O(t) : B(t)) instanceof A ? (e = t.min, i = t.max) : e = i = t, e.x >= this.min.x && i.x <= this.max.x && e.y >= this.min.y && i.y <= this.max.y
                            },
                            ...
                            extend: function(t) {
                                ...
                                return n || o ? (n.lat = Math.min(e.lat, n.lat), n.lng = Math.min(e.lng, n.lng), o.lat = Math.max(i.lat, o.lat), o.lng = Math.max(i.lng, o.lng)) : (this._southWest = new N(e.lat, e.lng), this._northEast = new N(i.lat, i.lng)), this
                            },
                            pad: function(t) {
                                ...
                                return new I(new N(e.lat - n, e.lng - o), new N(i.lat + n, i.lng + o))
                            },
                            getCenter: function() {
                            ...
                            contains: function(t) {
                                ...
                                var e, i, n = this._southWest,
                                    o = this._northEast;
                                return t instanceof I ? (e = t.getSouthWest(), i = t.getNorthEast()) : e = i = t, e.lat >= n.lat && i.lat <= o.lat && e.lng >= n.lng && i.lng <= o.lng
                            },
                            intersects: function(t) {
                                t = R(t);
                                var e = this._southWest,
                        ...
                        var J, $ = document.documentElement.style,
                            ...
                            Et = !!Zt && ((J = document.createElement("div")).innerHTML = "<svg/>", "http://www.w3.org/2000/svg" === (J.firstChild && J.firstChild.namespaceURI)),
                            kt = !Zt && function() {
                                try {
                        ...
                        var At = {
                            ...
                            jt = {
                                touchstart: function(t, e) {
                                    e.MSPOINTER_TYPE_TOUCH && e.pointerType === e.MSPOINTER_TYPE_TOUCH && Ne(e), Gt(t, e)
                                },
                                touchmove: Gt,
                                touchend: Gt,
                                touchcancel: Gt
                        ...
                        function Wt(t, e, i) {
                            return "touchstart" === e && (Ft || (document.addEventListener(Bt, Ut, !0), document.addEventListener(It, Vt, !0), document.addEventListener(Rt, qt, !0), document.addEventListener(Nt, qt, !0), Ft = !0)), jt[e] ? (i = jt[e].bind(this, i), t.addEventListener(Dt[e], i, !1), i) : (console.warn("wrong event specified:", e), h)
                        }
                        ...
                        var Kt = 200;
                        var Yt, Xt, Jt, $t, Qt, te = fe(["transform", "webkitTransform", "OTransform", "MozTransform", "msTransform"]),
                        ...
                        function de(t, e) {
                            void 0 !== t.classList ? t.classList.remove(e) : _e(t, u((" " + pe(t) + " ").replace(" " + e + " ", " ")))
                        }
                        ...
                        function ge(t, e, i) {
                            var n = e || new E(0, 0);
                            t.style[te] = (At.ie3d ? "translate(" + n.x + "px," + n.y + "px)" : "translate3d(" + n.x + "px," + n.y + "px,0)") + (i ? " scale(" + i + ")" : "")
                        }

                        function ve(t, e) {
                            t._leaflet_pos = e, At.any3d ? ge(t, e) : (t.style.left = e.x + "px", t.style.top = e.y + "px")
                        }
                        ...
                        if ("onselectstart" in document) Yt = function() {
                            ...
                            var xe = fe(["userSelect", "WebkitUserSelect", "OUserSelect", "MozUserSelect", "msUserSelect"]);
                            Yt = function() {
                                if (xe) {
                        ...
                        function Pe(t) {
                            ...
                            t.style && (Le(), $t = t, Qt = t.style.outlineStyle, t.style.outlineStyle = "none", Ce(window, "keydown", Le))
                        }

                        function Le() {
                            $t && ($t.style.outlineStyle = Qt, $t = void 0, Qt = void 0, Ze(window, "keydown", Le))
                        }
                        ...
                        function Ce(t, e, i, n) {
                            if (e && "object" == typeof e)
                                ...
                                for (var s = 0, r = (e = c(e)).length; s < r; s++) Oe(t, e[s], i, n);
                            return this
                        }
                        ...
                        function Ze(t, e, i, n) {
                            ...
                            else if (e = c(e), 2 === arguments.length) Ee(t, (function(t) {
                                return -1 !== g(e, t)
                            }));
                            else
                        ...
                        function Oe(t, e, i, n) {
                            ...
                            var r = function(e) {
                                ...
                                a = r;
                            !At.touchNative && At.pointer && 0 === e.indexOf("touch") ? r = Wt(t, e, r) : At.touch && "dblclick" === e ? r = function(t, e) {
                            ...
                            }(t, r) : "addEventListener" in t ? "touchstart" === e || "touchmove" === e || "wheel" === e || "mousewheel" === e ? t.addEventListener(ke[e] || e, r, !!At.passiveEvents && {
                                passive: !1
                            }) : "mouseenter" === e || "mouseleave" === e ? (r = function(e) {
                                e = e || window.event, Ue(t, e) && a(e)
                            }, t.addEventListener(ke[e], r, !1)) : t.addEventListener(e, a, !1) : t.attachEvent("on" + e, r), t[Se] = t[Se] || {}, t[Se][o] = r
                        }
                        ...
                        function Ae(t, e, i, n, o) {
                            ...
                            }(t, e, r) : At.touch && "dblclick" === e ? function(t, e) {
                                t.removeEventListener("dblclick", e.dblclick), t.removeEventListener("click", e.simDblclick)
                            }(t, r) : "removeEventListener" in t ? t.removeEventListener(ke[e] || e, r, !1) : t.detachEvent("on" + e, r), t[Se][o] = null
                        }
                        ...
                        function Re(t) {
                            return Ce(t, "mousedown touchstart dblclick contextmenu", Be), t._leaflet_disable_click = !0, this
                        }
                            ...
                            Ge = Z.extend({
                                ...
                                initialize: function(t, e) {
                                    e = d(this, e), this._handlers = [], this._layers = {}, this._zoomBoundLayers = {}, this._sizeChanged = !0, this._initContainer(t), this._initLayout(), this._onResize = n(this._onResize, this), this._initEvents(), e.maxBounds && this.setMaxBounds(e.maxBounds), void 0 !== e.zoom && (this._zoom = this._limitZoom(e.zoom)), e.center && void 0 !== e.zoom && this.setView(D(e.center), e.zoom, {
                                        reset: !0
                                    }), this.callInitHooks(), this._zoomAnimated = ee && At.any3d && !At.mobileOpera && this.options.zoomAnimation, this._zoomAnimated && (this._createAnimProxy(), Ce(this._proxy, ie, this._catchTransitionEnd, this)), this._addLayers(this.options.layers)
                                },
                                setView: function(t, i, n) {
                                    return i = void 0 === i ? this._zoom : this._limitZoom(i), t = this._limitCenter(D(t), i, this.options.maxBounds), n = n || {}, this._stop(), this._loaded && !n.reset && !0 !== n && (void 0 !== n.animate && (n.zoom = e({
                                        animate: n.animate
                                    }, n.zoom), n.pan = e({
                                        animate: n.animate,
                                        duration: n.duration
                                ...
                                zoomIn: function(t, e) {
                                    return t = t || (At.any3d ? this.options.zoomDelta : 1), this.setZoom(this._zoom + t, e)
                                },
                                ...
                                flyTo: function(t, e, i) {
                                    if (!1 === (i = i || {}).animate || !At.any3d) return this.setView(t, e, i);
                                    this._stop();
                                    ...
                                    function f(t) {
                                        return a * (p(m) * (_(e = m + u * t) / p(e)) - _(m)) / c;
                                        var e
                                    }
                                    var g = Date.now(),
                                        v = (d(1) - m) / u,
                                    ...
                                    return this._moveStart(!0, i.noMoveStart),
                                        function i() {
                                            ...
                                            s <= 1 ? (this._flyToFrame = T(i, this), this._move(this.unproject(n.add(o.subtract(n).multiplyBy(f(h) / l)), r), this.getScaleZoom(a / function(t) {
                                ...
                                panInside: function(t, e) {
                                    var i = O((e = e || {}).paddingTopLeft || e.padding || [0, 0]),
                                        ...
                                        a = B([r.min.add(i), r.max.subtract(n)]),
                                        h = a.getSize();
                                    if (!a.contains(s)) {
                                        this._enforcingBounds = !0;
                                        var l = s.subtract(a.getCenter()),
                                            u = a.extend(s).getSize().subtract(h);
                                        o.x += l.x < 0 ? -u.x : u.x, o.y += l.y < 0 ? -u.y : u.y, this.panTo(this.unproject(o), e), this._enforcingBounds = !1
                                    }
                                    return this
                                },
                                ...
                                remove: function() {
                                    ...
                                    var t;
                                    for (t in void 0 !== this._locationWatchId && this.stopLocate(), this._stop(), re(this._mapPane), this._clearControlPos && this._clearControlPos(), this._resizeRequest && (M(this._resizeRequest), this._resizeRequest = null), this._clearHandlers(), this._loaded && this.fire("unload"), this._layers) this._layers[t].remove();
                                ...
                                _initLayout: function() {
                                    ...
                                    this._fadeAnimated = this.options.fadeAnimation && At.any3d, ce(t, "leaflet-container" + (At.touch ? " leaflet-touch" : "") + (At.retina ? " leaflet-retina" : "") + (At.ielt9 ? " leaflet-oldie" : "") + (At.safari ? " leaflet-safari" : "") + (this._fadeAnimated ? " leaflet-fade-anim" : ""));
                                    var e = oe(t, "position");
                                ...
                                _initEvents: function(t) {
                                    ...
                                    var e = t ? Ze : Ce;
                                    e(this._container, "click dblclick mousedown mouseup mouseover mouseout mousemove contextmenu keypress keydown keyup", this._handleDOMEvent, this), this.options.trackResize && e(window, "resize", this._onResize, this), At.any3d && this.options.transform3DLimit && (t ? this.off : this.on).call(this, "moveend", this._onMoveEnd)
                                },
                                _onResize: function() {
                                ...
                                _findEventTargets: function(t, e) {
                                    for (var i, n = [], o = "mouseout" === e || "mouseover" === e, r = t.target || t.srcElement, a = !1; r;) {
                                        if ((i = this._targets[s(r)]) && ("click" === e || "preclick" === e) && this._draggableMoved(i)) {
                                            a = !0;
                                            break
                                        }
                                        if (i && i.listens(e, !0)) {
                                ...
                                _handleDOMEvent: function(t) {
                                    ...
                                    if (!(!this._loaded || e._leaflet_disable_events || "click" === t.type && this._isClickDisabled(e))) {
                                        var i = t.type;
                                        "mousedown" === i && Pe(e), this._fireDOMEvent(t, i)
                                    }
                                },
                                ...
                                _fireDOMEvent: function(t, i, n) {
                                    ...
                                    if (n) {
                                        for (var r = [], a = 0; a < n.length; a++) n[a].listens(i, !0) && r.push(n[a]);
                                        s = r.concat(s)
                                    }
                                    if (s.length) {
                                        "contextmenu" === i && Ne(t);
                                        ...
                                        for (a = 0; a < s.length; a++)
                                            if (s[a].fire(i, l, !0), l.originalEvent._stopped || !1 === s[a].options.bubblingMouseEvents && -1 !== g(this._mouseEvents, i)) return
                                    }
                                },
                                ...
                                _onZoomTransitionEnd: function() {
                                    this._animatingZoom && (this._mapPane && de(this._mapPane, "leaflet-zoom-anim"), this._animatingZoom = !1, this._move(this._animateToCenter, this._animateToZoom, void 0, !0), this._tempFireZoomEvent && this.fire("zoom"), delete this._tempFireZoomEvent, this.fire("move"), this._moveEnd(!0))
                                }
                            });
                        var Ke = C.extend({
                                options: {
                        ...
                        var Xe = Ke.extend({
                                ...
                                initialize: function(t, e, i) {
                                    for (var n in d(this, i), this._layerControlInputs = [], this._layers = [], this._lastZIndex = 0, this._handlingClick = !1, this._preventClick = !1, t) this._addLayer(t[n], n);
                                ...
                                _initLayout: function() {
                                    ...
                                    e.setAttribute("aria-haspopup", !0), Re(e), Ie(e);
                                    var n = this._section = se("section", t + "-list");
                                    i && (this._map.on("click", this.collapse, this), Ce(e, {
                                    ...
                                    }, this), i || this.expand(), this._baseLayersList = se("div", t + "-base", n), this._separator = se("div", t + "-separator", n), this._overlaysList = se("div", t + "-overlays", n), e.appendChild(n)
                                },
                                ...
                                _addItem: function(t) {
                                    ...
                                    t.overlay ? ((e = document.createElement("input")).type = "checkbox", e.className = "leaflet-control-layers-selector", e.defaultChecked = n) : e = this._createRadioElement("leaflet-base-layers_" + s(this), n), this._layerControlInputs.push(e), e.layerId = s(t.layer), Ce(e, "click", this._onInputClick, this);
                                ...
                                _expandSafely: function() {
                                    ...
                                    var e = this;
                                    setTimeout((function() {
                                        Ze(t, "click", Ne), e._preventClick = !1
                                    }))
                                }
                            }),
                            Je = Ke.extend({
                                ...
                                _createButton: function(t, e, i, n, o) {
                                    var s = se("a", i, n);
                                    return s.innerHTML = t, s.href = "#", s.title = e, s.setAttribute("role", "button"), s.setAttribute("aria-label", e), Re(s), Ce(s, "click", De), Ce(s, "click", o, this), Ce(s, "click", this._refocusOnMap, this), s
                                },
                                _updateDisabled: function() {
                                    var t = this._map,
                                        e = "leaflet-disabled";
                                    de(this._zoomInButton, e), de(this._zoomOutButton, e), this._zoomInButton.setAttribute("aria-disabled", "false"), this._zoomOutButton.setAttribute("aria-disabled", "false"), (this._disabled || t._zoom === t.getMinZoom()) && (ce(this._zoomOutButton, e), this._zoomOutButton.setAttribute("aria-disabled", "true")), (this._disabled || t._zoom === t.getMaxZoom()) && (ce(this._zoomInButton, e), this._zoomInButton.setAttribute("aria-disabled", "true"))
                                }
                            });
                        Ge.mergeOptions({
                            zoomControl: !0
                        ...
                        var $e = Ke.extend({
                            ...
                            Qe = Ke.extend({
                                ...
                                onAdd: function(t) {
                                    for (var e in t.attributionControl = this, this._container = se("div", "leaflet-control-attribution"), Re(this._container), t._layers) t._layers[e].getAttribution && this.addAttribution(t._layers[e].getAttribution());
                        ...
                        Ke.Layers = Xe, Ke.Zoom = Je, Ke.Scale = $e, Ke.Attribution = Qe, Ye.layers = function(t, e, i) {
                            return new Xe(t, e, i)
                        }, Ye.zoom = function(t) {
                            return new Je(t)
                        }, Ye.scale = function(t) {
                        ...
                        var ei = {
                            ...
                            ni = Z.extend({
                                ...
                                enable: function() {
                                    this._enabled || (Ce(this._dragStartTarget, ii, this._onDown, this), this._enabled = !0)
                                },
                                disable: function() {
                                    this._enabled && (ni._dragging === this && this.finishDrag(!0), Ze(this._dragStartTarget, ii, this._onDown, this), this._enabled = !1, this._moved = !1)
                                },
                                _onDown: function(t) {
                                    if (this._enabled && (this._moved = !1, !ue(this._element, "leaflet-zoom-anim")))
                                        ...
                                        else if (!(ni._dragging || t.shiftKey || 1 !== t.which && 1 !== t.button && !t.touches || (ni._dragging = this, this._preventOutline && Pe(this._element), we(), Yt(), this._moving))) {
                                        this.fire("down");
                                        var e = t.touches ? t.touches[0] : t,
                                            i = Te(this._element);
                                        this._startPoint = new E(e.clientX, e.clientY), this._startPos = ye(this._element), this._parentScale = Me(i);
                                        var n = "mousedown" === t.type;
                                        Ce(document, n ? "mousemove" : "touchmove", this._onMove, this), Ce(document, n ? "mouseup" : "touchend touchcancel", this._onUp, this)
                                    }
                                },
                                _onMove: function(t) {
                                    if (this._enabled)
                                ...
                                finishDrag: function(t) {
                                    de(document.body, "leaflet-dragging"), this._lastTarget && (de(this._lastTarget, "leaflet-drag-target"), this._lastTarget = null), Ze(document, "mousemove touchmove", this._onMove, this), Ze(document, "mouseup touchend touchcancel", this._onUp, this), be(), Xt();
                                    var e = this._moved && this._moving;
                                    this._moving = !1, ni._dragging = !1, e && this.fire("dragend", {
                                        noInertia: t,
                        ...
                        function oi(t, e, i) {
                            ...
                            for (r = 0; r < 4; r++) {
                                for (u = d[r], n = [], o = 0, s = (l = t.length) - 1; o < l; s = o++) a = t[o], h = t[s], a._code & u ? h._code & u || ((c = _i(h, a, u, e, i))._code = pi(c, e), n.push(c)) : (h._code & u && ((c = _i(h, a, u, e, i))._code = pi(c, e), n.push(c)), n.push(a));
                                t = n
                            }
                            return t
                        }
                        ...
                        function si(t, e) {
                            ...
                            gi(t) || (console.warn("latlngs are not flat! Only the first ring will be used"), t = t[0]);
                            var c = D([0, 0]),
                                d = R(t);
                            d.getNorthWest().distanceTo(d.getSouthWest()) * d.getNorthEast().distanceTo(d.getNorthWest()) < 1700 && (c = ri(t));
                            var _ = t.length,
                                p = [];
                            for (i = 0; i < _; i++) {
                                var m = D(t[i]);
                                p.push(e.project(D([m.lat - c.lat, m.lng - c.lng])))
                            }
                            for (a = h = l = 0, i = 0, n = _ - 1; i < _; n = i++) o = p[i], s = p[n], r = o.y * s.x - s.y * o.x, h += (o.x + s.x) * r, l += (o.y + s.y) * r, a += 3 * r;
                            u = 0 === a ? p[0] : [h / a, l / a];
                        ...
                        function li(t, e) {
                            ...
                            return function(t, e) {
                                ...
                                for (var i = [t[0]], n = 1, o = 0, s = t.length; n < s; n++) mi(t[n], t[o]) > e && (i.push(t[n]), o = n);
                        ...
                        function ci(t, e, i, n, o) {
                            var s, r, a, h = 0;
                            for (r = n + 1; r <= o - 1; r++)(a = fi(t[r], t[n], t[o], !0)) > h && (s = r, h = a);
                            h > i && (e[s] = 1, ci(t, e, i, n, s), ci(t, e, i, s, o))
                        }

                        function di(t, e, i, n, o) {
                            var s, r, a, h = n ? ai : pi(t, i),
                                l = pi(e, i);
                            for (ai = l;;) {
                                if (!(h | l)) return [t, e];
                                if (h & l) return !1;
                                a = pi(r = _i(t, e, s = h || l, i, o), i), s === h ? (t = r, h = a) : (e = r, l = a)
                            }
                        }
                        ...
                        function _i(t, e, i, n, o) {
                            var s, r, a = e.x - t.x,
                                ...
                                l = n.min,
                                u = n.max;
                            return 8 & i ? (s = t.x + a * (u.y - t.y) / h, r = u.y) : 4 & i ? (s = t.x + a * (l.y - t.y) / h, r = l.y) : 2 & i ? (s = u.x, r = t.y + h * (u.x - t.x) / a) : 1 & i && (s = l.x, r = t.y + h * (l.x - t.x) / a), new E(s, r, o)
                        }
                        ...
                        function fi(t, e, i, n) {
                            var o, s = e.x,
                                ...
                                h = i.y - r,
                                l = a * a + h * h;
                            return l > 0 && ((o = ((t.x - s) * a + (t.y - r) * h) / l) > 1 ? (s = i.x, r = i.y) : o > 0 && (s += a * o, r += h * o)), a = t.x - s, h = t.y - r, n ? a * a + h * h : new E(s, r)
                        }
                        ...
                        function vi(t) {
                            return console.warn("Deprecated use of _flat, please use L.LineUtil.isFlat instead."), gi(t)
                        }
                        ...
                        function yi(t, e) {
                            ...
                            var u = D([0, 0]),
                                c = R(t);
                            c.getNorthWest().distanceTo(c.getSouthWest()) * c.getNorthEast().distanceTo(c.getNorthWest()) < 1700 && (u = ri(t));
                            var d = t.length,
                                _ = [];
                            for (i = 0; i < d; i++) {
                                var p = D(t[i]);
                                _.push(e.project(D([p.lat - u.lat, p.lng - u.lng])))
                            }
                            for (i = 0, n = 0; i < d - 1; i++) n += _[i].distanceTo(_[i + 1]) / 2;
                            if (0 === n) l = _[0];
                            else
                                for (i = 0, s = 0; i < d - 1; i++)
                                    if (r = _[i], a = _[i + 1], (s += o = r.distanceTo(a)) > n) {
                        ...
                        var xi = {
                            ...
                            bi = {
                                ...
                                project: function(t) {
                                    ...
                                    return n = -i * Math.log(Math.max(a, 1e-10)), new E(t.lng * e * i, n)
                                },
                                unproject: function(t) {
                        ...
                        H.Earth = F, H.EPSG3395 = Li, H.EPSG3857 = G, H.EPSG900913 = K, H.EPSG4326 = Ti, H.Simple = Mi;
                        var zi = Z.extend({
                            options: {
                                pane: "overlayPane",
                                attribution: null,
                        ...
                        Ge.include({
                            ...
                            _addLayers: function(t) {
                                for (var e = 0, i = (t = t ? f(t) ? t : [t] : []).length; e < i; e++) this.addLayer(t[e])
                            },
                        ...
                        var Ci = zi.extend({
                            ...
                            Zi = C.extend({
                                ...
                                _setIconStyles: function(t, e) {
                                    ...
                                    var o = O(n),
                                        s = O("shadow" === e && i.shadowAnchor || i.iconAnchor || o && o.divideBy(2, !0));
                        ...
                        var Ei = Zi.extend({
                                ...
                                _getIconUrl: function(t) {
                                    return "string" != typeof Ei.imagePath && (Ei.imagePath = this._detectIconPath()), (this.options.imagePath || Ei.imagePath) + Zi.prototype._getIconUrl.call(this, t)
                                },
                            ...
                            ki = ti.extend({
                                ...
                                addHooks: function() {
                                    ...
                                    this._draggable || (this._draggable = new ni(t, t, !0)), this._draggable.on({
                                ...
                                _adjustPan: function(t) {
                                    ...
                                    if (!h.contains(s)) {
                                        ...
                                        i.panBy(l, {
                                            animate: !1
                                        }), this._draggable._newPos._add(l), this._draggable._startPos._add(l), ve(e._icon, this._draggable._newPos), this._onDrag(t), this._panRequest = T(this._adjustPan.bind(this, t))
                                    }
                                },
                            ...
                            Oi = zi.extend({
                                ...
                                _initIcon: function() {
                                    var t = this.options,
                                        ...
                                        n = !1;
                                    i !== this._icon && (this._icon && this._removeIcon(), n = !0, t.title && (i.title = t.title), "IMG" === i.tagName && (i.alt = t.alt || "")), ce(i, e), t.keyboard && (i.tabIndex = "0", i.setAttribute("role", "button")), this._icon = i, t.riseOnHover && this.on({
                                        mouseover: this._bringToFront,
                                        mouseout: this._resetZIndex
                                    }), this.options.autoPanOnFocus && Ce(i, "focus", this._panOnFocus, this);
                                ...
                                _removeIcon: function() {
                                    this.options.riseOnHover && this.off({
                                        mouseover: this._bringToFront,
                                        mouseout: this._resetZIndex
                                    }), this.options.autoPanOnFocus && Ze(this._icon, "focus", this._panOnFocus, this), re(this._icon), this.removeInteractiveTarget(this._icon), this._icon = null
                                },
                                ...
                                _initInteraction: function() {
                                    if (this.options.interactive && (ce(this._icon, "leaflet-interactive"), this.addInteractiveTarget(this._icon), ki)) {
                        ...
                        var Ai = zi.extend({
                            ...
                            Bi = Ai.extend({
                                ...
                                setStyle: function(t) {
                                    ...
                                    return Ai.prototype.setStyle.call(this, t), this.setRadius(e), this
                                },
                                _project: function() {
                        ...
                        var Ii = Bi.extend({
                            initialize: function(t, i, n) {
                                if ("number" == typeof i && (i = e({}, n, {
                                        radius: i
                                    })), d(this, i), this._latlng = D(t), isNaN(this.options.radius)) throw new Error("Circle radius cannot be NaN");
                        ...
                        var Ri = Ai.extend({
                            ...
                            closestLayerPoint: function(t) {
                                for (var e, i, n = 1 / 0, o = null, s = fi, r = 0, a = this._parts.length; r < a; r++)
                            ...
                            _convertLatLngs: function(t) {
                                for (var e = [], i = gi(t), n = 0, o = t.length; n < o; n++) i ? (e[n] = D(t[n]), this._bounds.extend(e[n])) : e[n] = this._convertLatLngs(t[n]);
                                return e
                            },
                            _project: function() {
                                var t = new A;
                                ...
                                if (this._parts = [], this._pxBounds && this._pxBounds.intersects(t))
                                    if (this.options.noClip) this._parts = this._rings;
                                        ...
                                        for (e = 0, n = 0, o = this._rings.length; e < o; e++)
                                            for (i = 0, s = (a = this._rings[e]).length; i < s - 1; i++)(r = di(a[i], a[i + 1], t, i, !0)) && (h[n] = h[n] || [], h[n].push(r[0]), r[1] === a[i + 1] && i !== s - 2 || (h[n].push(r[1]), n++))
                                    }
                            },
                            _simplifyPoints: function() {
                                for (var t = this._parts, e = this.options.smoothFactor, i = 0, n = t.length; i < n; i++) t[i] = li(t[i], e)
                            },
                            _update: function() {
                        ...
                        var Ni = Ri.extend({
                            ...
                            _setLatLngs: function(t) {
                                Ri.prototype._setLatLngs.call(this, t), gi(this._latlngs) && (this._latlngs = [this._latlngs])
                            },
                            _defaultShape: function() {
                            ...
                            _clipPoints: function() {
                                ...
                                if (t = new A(t.min.subtract(i), t.max.add(i)), this._parts = [], this._pxBounds && this._pxBounds.intersects(t))
                                    if (this.options.noClip) this._parts = this._rings;
                                        ...
                                        for (var n, o = 0, s = this._rings.length; o < s; o++)(n = oi(this._rings[o], t, !0)).length && this._parts.push(n)
                            },
                            _updatePath: function() {
                            ...
                            _containsPoint: function(t) {
                                ...
                                return l || Ri.prototype._containsPoint.call(this, t, !0)
                            }
                        });
                        var Di = Si.extend({
                            initialize: function(t, e) {
                            ...
                            addData: function(t) {
                                ...
                                var r = ji(t, s);
                                return r ? (r.feature = Gi(t), r.defaultOptions = r.options, this.resetStyle(r), s.onEachFeature && s.onEachFeature(t, r), this.addLayer(r)) : this
                            },
                        ...
                        function ji(t, e) {
                            ...
                            switch (r.type) {
                                ...
                                case "MultiPoint":
                                    for (o = 0, s = a.length; o < s; o++) i = u(a[o]), h.push(Hi(l, t, i, e));
                                    return new Si(h);
                                case "LineString":
                                case "MultiLineString":
                                    return n = Wi(a, "LineString" === r.type ? 0 : 1, u), new Ri(n, e);
                                case "Polygon":
                                case "MultiPolygon":
                                    return n = Wi(a, "Polygon" === r.type ? 1 : 2, u), new Ni(n, e);
                        ...
                        function Wi(t, e, i) {
                            for (var n, o = [], s = 0, r = t.length; s < r; s++) n = e ? Wi(t[s], e - 1, i) : (i || Fi)(t[s]), o.push(n);
                            return o
                        }
                        ...
                        function Vi(t, e, i, n) {
                            for (var o = [], s = 0, r = t.length; s < r; s++) o.push(e ? Vi(t[s], gi(t[s]) ? 0 : e - 1, i, n) : Ui(t[s], n));
                        ...
                        Oi.include(Ki), Ii.include(Ki), Bi.include(Ki), Ri.include({
                            toGeoJSON: function(t) {
                        ...
                        var Qi = Ji.extend({
                            _initImage: function() {
                                ...
                                ce(t, "leaflet-image-layer"), this._zoomAnimated && ce(t, "leaflet-zoom-animated"), this.options.className && ce(t, this.options.className), t.onselectstart = h, t.onmousemove = h
                            }
                        });
                        var tn = zi.extend({
                            options: {
                            ...
                            initialize: function(t, e) {
                                t && (t instanceof N || f(t)) ? (this._latlng = D(t), d(this, e)) : (d(this, t), this._source = e), this.options.content && (this._content = this.options.content)
                            },
                            openOn: function(t) {
                            ...
                            onAdd: function(t) {
                                this._zoomAnimated = t._zoomAnimated, this._container || this._initLayout(), t._fadeAnimated && me(this._container, 0), clearTimeout(this._removeTimeout), this.getPane().appendChild(this._container), this.update(), t._fadeAnimated && me(this._container, 1), this.bringToFront(), this.options.interactive && (ce(this._container, "leaflet-interactive"), this.addInteractiveTarget(this._container))
                            },
                            onRemove: function(t) {
                                t._fadeAnimated ? (me(this._container, 0), this._removeTimeout = setTimeout(n(re, void 0, this._container), 200)) : re(this._container), this.options.interactive && (de(this._container, "leaflet-interactive"), this.removeInteractiveTarget(this._container))
                            },
                            getLatLng: function() {
                                return this._latlng
                            },
                        ...
                        Ge.include({
                            ...
                            _initOverlay: function(t, e, i, n) {
                                var o = i;
                                return o instanceof t ? (d(o, n), o._source = this) : (o = e && !n ? e : new t(n, this)).setContent(i), o
                            }
                        });
                        var en = tn.extend({
                            options: {
                            ...
                            openOn: function(t) {
                                return !(t = arguments.length ? t : this._source._map).hasLayer(this) && t._popup && t._popup.options.autoClose && t.removeLayer(t._popup), t._popup = this, tn.prototype.openOn.call(this, t)
                            },
                            onAdd: function(t) {
                                tn.prototype.onAdd.call(this, t), t.fire("popupopen", {
                                    ...
                                    popup: this
                                }, !0), this._source instanceof Ai || this._source.on("preclick", Be))
                            },
                            onRemove: function(t) {
                                tn.prototype.onRemove.call(this, t), t.fire("popupclose", {
                                    ...
                                    popup: this
                                }, !0), this._source instanceof Ai || this._source.off("preclick", Be))
                            },
                            getEvents: function() {
                            ...
                            _initLayout: function() {
                                ...
                                if (this._contentNode = se("div", t + "-content", i), Re(e), Ie(this._contentNode), Ce(e, "contextmenu", Be), this._tipContainer = se("div", t + "-tip-container", e), this._tip = se("div", t + "-tip", this._tipContainer), this.options.closeButton) {
                                    var n = this._closeButton = se("a", t + "-close-button", e);
                                    n.setAttribute("role", "button"), n.setAttribute("aria-label", "Close popup"), n.href = "#close", n.innerHTML = '<span aria-hidden="true">&#215;</span>', Ce(n, "click", (function(t) {
                                        Ne(t), this.close()
                                    }), this)
                                }
                            },
                            _updateLayout: function() {
                                ...
                                o && n > o ? (e.height = o + "px", ce(t, s)) : de(t, s), this._containerWidth = this._container.offsetWidth
                            },
                            _animateZoom: function(t) {
                                ...
                                if (this.options.autoPan)
                                    if (this._map._panAnim && this._map._panAnim.stop(), this._autopanning) this._autopanning = !1;
                                        ...
                                        var s = t.layerPointToContainerPoint(o),
                                            ...
                                            u = 0,
                                            c = 0;
                                        s.x + n + h.x > l.x && (u = s.x + n - l.x + h.x), s.x - u - a.x < 0 && (u = s.x - a.x), s.y + i + h.y > l.y && (c = s.y + i - l.y + h.y), s.y - c - a.y < 0 && (c = s.y - a.y), (u || c) && (this.options.keepInView && (this._autopanning = !0), t.fire("autopanstart").panBy([u, c]))
                                    }
                            },
                            _getAnchor: function() {
                        ...
                        Ge.mergeOptions({
                            ...
                            openPopup: function(t) {
                                return this._popup && (this instanceof Si || (this._popup._source = this), this._popup._prepareOpen(t || this._latlng) && this._popup.openOn(this._map)), this
                            },
                            closePopup: function() {
                            ...
                            _openPopup: function(t) {
                                if (this._popup && this._map) {
                                    ...
                                    this._popup._source !== e || e instanceof Ai ? (this._popup._source = e, this.openPopup(t.latlng)) : this._map.hasLayer(this._popup) ? this.closePopup() : this.openPopup(t.latlng)
                                }
                            },
                        ...
                        var nn = tn.extend({
                            ...
                            _initLayout: function() {
                                ...
                                this._contentNode = this._container = se("div", t), this._container.setAttribute("role", "tooltip"), this._container.setAttribute("id", "leaflet-tooltip-" + s(this))
                            },
                            _updateLayout: function() {},
                            _adjustPan: function() {},
                            _setPosition: function(t) {
                                var e, i, n = this._map,
                                    ...
                                    c = this._getAnchor();
                                "top" === a ? (e = h / 2, i = l) : "bottom" === a ? (e = h / 2, i = 0) : "center" === a ? (e = h / 2, i = l / 2) : "right" === a ? (e = 0, i = l / 2) : "left" === a ? (e = h, i = l / 2) : r.x < s.x ? (a = "right", e = 0, i = l / 2) : (a = "left", e = h + 2 * (u.x + c.x), i = l / 2), t = t.subtract(O(e, i, !0)).add(u).add(c), de(o, "leaflet-tooltip-right"), de(o, "leaflet-tooltip-left"), de(o, "leaflet-tooltip-top"), de(o, "leaflet-tooltip-bottom"), ce(o, "leaflet-tooltip-" + a), ve(o, t)
                            },
                            _updatePosition: function() {
                                var t = this._map.latLngToLayerPoint(this._latlng);
                                this._setPosition(t)
                        ...
                        Ge.include({
                            ...
                            openTooltip: function(t) {
                                return this._tooltip && (this instanceof Si || (this._tooltip._source = this), this._tooltip._prepareOpen(t) && (this._tooltip.openOn(this._map), this.getElement ? this._setAriaDescribedByOnLayer(this) : this.eachLayer && this.eachLayer(this._setAriaDescribedByOnLayer, this))), this
                            },
                            ...
                            _addFocusListenersOnLayer: function(t) {
                                ...
                                e && (Ce(e, "focus", (function() {
                                    this._tooltip._source = t, this.openTooltip()
                                }), this), Ce(e, "blur", this.closeTooltip, this))
                            },
                        ...
                        var on = Zi.extend({
                            ...
                            createIcon: function(t) {
                                var e = t && "DIV" === t.tagName ? t : document.createElement("div"),
                                    i = this.options;
                                if (i.html instanceof Element ? (ae(e), e.appendChild(i.html)) : e.innerHTML = !1 !== i.html ? i.html : "", i.bgPos) {
                                    var n = O(i.bgPos);
                        ...
                        var sn = zi.extend({
                            ...
                            _updateOpacity: function() {
                                if (this._map && !At.ielt9) {
                                    ...
                                    i && !this._noPrune && this._pruneTiles(), e && (M(this._fadeFrame), this._fadeFrame = T(this._updateOpacity, this))
                                }
                            },
                            _onOpaqueTile: h,
                            ...
                            _updateLevels: function() {
                                ...
                                if (void 0 !== t) {
                                    ...
                                    var n = this._levels[t],
                                        o = this._map;
                                    return n || ((n = this._levels[t] = {}).el = se("div", "leaflet-tile-container leaflet-zoom-animated", this._container), n.el.style.zIndex = e, n.origin = o.project(o.unproject(o.getPixelOrigin()), t).round(), n.zoom = t, this._setZoomTransform(n, o.getCenter(), o.getZoom()), n.el.offsetWidth, this._onCreateLevel(n)), this._level = n, n
                                }
                            },
                            _onUpdateLevel: h,
                            _onRemoveLevel: h,
                            ...
                            _initTile: function(t) {
                                ...
                                t.style.width = e.x + "px", t.style.height = e.y + "px", t.onselectstart = h, t.onmousemove = h, At.ielt9 && this.options.opacity < 1 && me(t, this.options.opacity)
                            },
                            _addTile: function(t, e) {
                                var i = this._getTilePos(t),
                                    o = this._tileCoordsToKey(t),
                                    s = this.createTile(this._wrapCoords(t), n(this._tileReady, this, t));
                                this._initTile(s), this.createTile.length < 2 && T(n(this._tileReady, this, t, null, s)), ve(s, i), this._tiles[o] = {
                                    el: s,
                                    coords: t,
                                    current: !0
                            ...
                            _tileReady: function(t, e, i) {
                                ...
                                (i = this._tiles[o]) && (i.loaded = +new Date, this._map._fadeAnimated ? (me(i.el, 0), M(this._fadeFrame), this._fadeFrame = T(this._updateOpacity, this)) : (i.active = !0, this._pruneTiles()), e || (ce(i.el, "leaflet-tile-loaded"), this.fire("tileload", {
                                    tile: i.el,
                                    coords: t
                        ...
                        var rn = sn.extend({
                            ...
                            initialize: function(t, e) {
                                this._url = t, (e = d(this, e)).detectRetina && At.retina && e.maxZoom > 0 ? (e.tileSize = Math.floor(e.tileSize / 2), e.zoomReverse ? (e.zoomOffset--, e.minZoom = Math.min(e.maxZoom, e.minZoom + 1)) : (e.zoomOffset++, e.maxZoom = Math.max(e.minZoom, e.maxZoom - 1)), e.minZoom = Math.max(0, e.minZoom)) : e.zoomReverse ? e.minZoom = Math.min(e.maxZoom, e.minZoom) : e.maxZoom = Math.max(e.minZoom, e.maxZoom), "string" == typeof e.subdomains && (e.subdomains = e.subdomains.split("")), this.on("tileunload", this._onTileRemove)
                            },
                            setUrl: function(t, e) {
                            ...
                            createTile: function(t, e) {
                                ...
                                return Ce(i, "load", n(this._tileOnLoad, this, e, i)), Ce(i, "error", n(this._tileOnError, this, e, i)), (this.options.crossOrigin || "" === this.options.crossOrigin) && (i.crossOrigin = !0 === this.options.crossOrigin ? "" : this.options.crossOrigin), "string" == typeof this.options.referrerPolicy && (i.referrerPolicy = this.options.referrerPolicy), i.alt = "", i.src = this.getTileUrl(t), i
                            },
                            ...
                            _removeTile: function(t) {
                                var e = this._tiles[t];
                                if (e) return e.el.setAttribute("src", v), sn.prototype._removeTile.call(this, t)
                            },
                            _tileReady: function(t, e, i) {
                                if (this._map && (!i || i.getAttribute("src") !== v)) return sn.prototype._tileReady.call(this, t, e, i)
                            }
                        });
                        ...
                        var hn = rn.extend({
                            ...
                            getTileUrl: function(t) {
                                var e = this._tileCoordsToNwSe(t),
                                    ...
                                    o = n.min,
                                    s = n.max,
                                    r = (this._wmsVersion >= 1.3 && this._crs === Ti ? [o.y, o.x, s.y, s.x] : [o.x, o.y, s.x, s.y]).join(","),
                        ...
                        var ln = zi.extend({
                                ...
                                onAdd: function() {
                                    this._container || (this._initContainer(), ce(this._container, "leaflet-zoom-animated")), this.getPane().appendChild(this._container), this._update(), this.on("update", this._updatePaths, this)
                                },
                                onRemove: function() {
                                ...
                                _updateTransform: function(t, e) {
                                    ...
                                    At.any3d ? ge(this._container, s, i) : ve(this._container, s)
                                },
                                _reset: function() {
                                ...
                                _update: function() {
                                    ...
                                    this._bounds = new A(i, i.add(e.multiplyBy(1 + 2 * t)).round()), this._center = this._map.getCenter(), this._zoom = this._map.getZoom()
                                }
                            }),
                            un = ln.extend({
                                options: {
                                ...
                                _initContainer: function() {
                                    ...
                                    Ce(t, "mousemove", this._onMouseMove, this), Ce(t, "click dblclick mousedown mouseup contextmenu", this._onClick, this), Ce(t, "mouseout", this._handleMouseOut, this), t._leaflet_disable_events = !0, this._ctx = t.getContext("2d")
                                },
                                _destroyContainer: function() {
                                    M(this._redrawRequest), delete this._ctx, re(this._container), Ze(this._container), delete this._container
                                },
                                _updatePaths: function() {
                                ...
                                _update: function() {
                                    if (!this._map._animatingZoom || !this._bounds) {
                                        ...
                                        var t = this._bounds,
                                            ...
                                            i = t.getSize(),
                                            n = At.retina ? 2 : 1;
                                        ve(e, t.min), e.width = n * i.x, e.height = n * i.y, e.style.width = i.x + "px", e.style.height = i.y + "px", At.retina && this._ctx.scale(2, 2), this._ctx.translate(-t.min.x, -t.min.y), this.fire("update")
                                    }
                                },
                                _reset: function() {
                                ...
                                _removePath: function(t) {
                                    var e = t._order,
                                        i = e.next,
                                        n = e.prev;
                                    i ? i.prev = n : this._drawLast = n, n ? n.next = i : this._drawFirst = i, delete t._order, delete this._layers[s(t)], this._requestRedraw(t)
                                },
                                ...
                                _handleMouseHover: function(t, e) {
                                    if (!this._mouseHoverThrottled) {
                                        for (var i, o, s = this._drawFirst; s; s = s.next)(i = s.layer).options.interactive && i._containsPoint(e) && (o = i);
                                        o !== this._hoveredLayer && (this._handleMouseOut(t), o && (ce(this._container, "leaflet-interactive"), this._fireEvent([o], t, "mouseover"), this._hoveredLayer = o)), this._fireEvent(!!this._hoveredLayer && [this._hoveredLayer], t), this._mouseHoverThrottled = !0, setTimeout(n((function() {
                        ...
                        var dn = function() {
                            ...
                            _n = {
                                ...
                                _initPath: function(t) {
                                    ...
                                    ce(e, "leaflet-vml-shape " + (this.options.className || "")), e.coordsize = "1 1", t._path = dn("path"), e.appendChild(t._path), this._updateStyle(t), this._layers[s(t)] = t
                                },
                                _addPath: function(t) {
                                    var e = t._container;
                                ...
                                _updateStyle: function(t) {
                                    var e = t._stroke,
                                        ...
                                        n = t.options,
                                        o = t._container;
                                    o.stroked = !!n.stroke, o.filled = !!n.fill, n.stroke ? (e || (e = t._stroke = dn("stroke")), o.appendChild(e), e.weight = n.weight + "px", e.color = n.color, e.opacity = n.opacity, n.dashArray ? e.dashStyle = f(n.dashArray) ? n.dashArray.join(" ") : n.dashArray.replace(/( *, *)/g, " ") : e.dashStyle = "", e.endcap = n.lineCap.replace("butt", "flat"), e.joinstyle = n.lineJoin) : e && (o.removeChild(e), t._stroke = null), n.fill ? (i || (i = t._fill = dn("fill")), o.appendChild(i), i.color = n.fillColor || n.color, i.opacity = n.fillOpacity) : i && (o.removeChild(i), t._fill = null)
                                },
                                _updateCircle: function(t) {
                            ...
                            mn = ln.extend({
                                ...
                                _destroyContainer: function() {
                                    re(this._container), Ze(this._container), delete this._container, delete this._rootGroup, delete this._svgSize
                                },
                                _update: function() {
                                    if (!this._map._animatingZoom || !this._bounds) {
                                        ln.prototype._update.call(this);
                                        var t = this._bounds,
                                            e = t.getSize(),
                                            i = this._container;
                                        this._svgSize && this._svgSize.equals(e) || (this._svgSize = e, i.setAttribute("width", e.x), i.setAttribute("height", e.y)), ve(i, t.min), i.setAttribute("viewBox", [t.min.x, t.min.y, e.x, e.y].join(" ")), this.fire("update")
                                    }
                                },
                                _initPath: function(t) {
                                    var e = t._path = pn("path");
                                    t.options.className && ce(e, t.options.className), t.options.interactive && ce(e, "leaflet-interactive"), this._updateStyle(t), this._layers[s(t)] = t
                                },
                                _addPath: function(t) {
                        ...
                        At.vml && mn.include(_n), Ge.include({
                        ...
                        mn.create = pn, mn.pointsToPath = X, Di.geometryToLayer = ji, Di.coordsToLatLng = Fi, Di.coordsToLatLngs = Wi, Di.latLngToCoords = Ui, Di.latLngsToCoords = Vi, Di.getFeature = qi, Di.asFeature = Gi, Ge.mergeOptions({
                            boxZoom: !0
                        });
                        var vn = ti.extend({
                            initialize: function(t) {
                            ...
                            _onMouseDown: function(t) {
                                ...
                                this._clearDeferredResetState(), this._resetState(), Yt(), we(), this._startPoint = this._map.mouseEventToContainerPoint(t), Ce(document, {
                                    contextmenu: De,
                            ...
                            _finish: function() {
                                this._moved && (re(this._box), de(this._container, "leaflet-crosshair")), Xt(), be(), Ze(document, {
                                    contextmenu: De,
                                    mousemove: this._onMouseMove,
                                    mouseup: this._onMouseUp,
                                    keydown: this._onKeyDown
                            ...
                            _onMouseUp: function(t) {
                                if ((1 === t.which || 1 === t.button) && (this._finish(), this._moved)) {
                                    ...
                                    var e = new I(this._map.containerPointToLatLng(this._startPoint), this._map.containerPointToLatLng(this._point));
                        ...
                        Ge.addInitHook("addHandler", "boxZoom", vn), Ge.mergeOptions({
                            doubleClickZoom: !0
                        });
                        var yn = ti.extend({
                            addHooks: function() {
                        ...
                        var xn = ti.extend({
                            addHooks: function() {
                                if (!this._draggable) {
                                    var t = this._map;
                                    this._draggable = new ni(t._mapPane, t._container), this._draggable.on({
                                        dragstart: this._onDragStart,
                                        drag: this._onDrag,
                                        dragend: this._onDragEnd
                        ...
                        Ge.addInitHook("addHandler", "dragging", xn), Ge.mergeOptions({
                            keyboard: !0,
                            keyboardPanDelta: 80
                        });
                        var wn = ti.extend({
                            ...
                            removeHooks: function() {
                                this._removeHooks(), Ze(this._map._container, {
                                    focus: this._onFocus,
                                    blur: this._onBlur,
                                    mousedown: this._onMouseDown
                                }, this), this._map.off({
                        ...
                        var bn = ti.extend({
                            ...
                            removeHooks: function() {
                                Ze(this._map._container, "wheel", this._onWheelScroll, this)
                            },
                            _onWheelScroll: function(t) {
                                ...
                                clearTimeout(this._timer), this._timer = setTimeout(n(this._performZoom, this), o), De(t)
                            },
                        ...
                        var Pn = ti.extend({
                            ...
                            _onDown: function(t) {
                                if (clearTimeout(this._holdTimeout), 1 === t.touches.length) {
                                    var e = t.touches[0];
                                    this._startPos = this._newPos = new E(e.clientX, e.clientY), this._holdTimeout = setTimeout(n((function() {
                                        this._cancel(), this._isTapValid() && (Ce(document, "touchend", Ne), Ce(document, "touchend touchcancel", this._cancelClickPrevent), this._simulateEvent("contextmenu", e))
                                    }), this), 600), Ce(document, "touchend touchcancel contextmenu", this._cancel, this), Ce(document, "touchmove", this._onMove, this)
                                }
                            },
                            _cancelClickPrevent: function t() {
                                Ze(document, "touchend", Ne), Ze(document, "touchend touchcancel", t)
                            },
                            _cancel: function() {
                                clearTimeout(this._holdTimeout), Ze(document, "touchend touchcancel contextmenu", this._cancel, this), Ze(document, "touchmove", this._onMove, this)
                            },
                            _onMove: function(t) {
                                var e = t.touches[0];
                        ...
                        Ge.addInitHook("addHandler", "tapHold", Pn), Ge.mergeOptions({
                            touchZoom: At.touch,
                        ...
                        var Ln = ti.extend({
                            ...
                            removeHooks: function() {
                                de(this._map._container, "leaflet-touch-zoom"), Ze(this._map._container, "touchstart", this._onTouchStart, this)
                            },
                            ...
                            _onTouchEnd: function() {
                                this._moved && this._zooming ? (this._zooming = !1, M(this._animRequest), Ze(document, "touchmove", this._onTouchMove, this), Ze(document, "touchend touchcancel", this._onTouchEnd, this), this._map.options.zoomAnimation ? this._map._animateZoom(this._center, this._map._limitZoom(this._zoom), !0, this._map.options.zoomSnap) : this._map._resetView(this._center, this._map._limitZoom(this._zoom))) : this._zooming = !1
                            }
                        });
                        Ge.addInitHook("addHandler", "touchZoom", Ln), Ge.BoxZoom = vn, Ge.DoubleClickZoom = yn, Ge.Drag = xn, Ge.Keyboard = wn, Ge.ScrollWheelZoom = bn, Ge.TapHold = Pn, Ge.TouchZoom = Ln, t.Bounds = A, t.Browser = At, t.CRS = H, t.Canvas = un, t.Circle = Ii, t.CircleMarker = Bi, t.Class = C, t.Control = Ke, t.DivIcon = on, t.DivOverlay = tn, t.DomEvent = Ve, t.DomUtil = ze, t.Draggable = ni, t.Evented = Z, t.FeatureGroup = Si, t.GeoJSON = Di, t.GridLayer = sn, t.Handler = ti, t.Icon = Zi, t.ImageOverlay = Ji, t.LatLng = N, t.LatLngBounds = I, t.Layer = zi, t.LayerGroup = Ci, t.LineUtil = xi, t.Map = Ge, t.Marker = Oi, t.Mixin = ei, t.Path = Ai, t.Point = E, t.PolyUtil = hi, t.Polygon = Ni, t.Polyline = Ri, t.Popup = en, t.PosAnimation = qe, t.Projection = Pi, t.Rectangle = gn, t.Renderer = ln, t.SVG = mn, t.SVGOverlay = Qi, t.TileLayer = rn, t.Tooltip = nn, t.Transformation = V, t.Util = z, t.VideoOverlay = $i, t.bind = n, t.bounds = B, t.canvas = cn, t.circle = function(t, e, i) {
                            return new Ii(t, e, i)
                            ...
                            return new Si(t, e)
                        }, t.geoJSON = Yi, t.geoJson = Xi, t.gridLayer = function(t) {
                            return new sn(t)
                        }, t.icon = function(t) {
                            return new Zi(t)
                        }, t.imageOverlay = function(t, e, i) {
                            return new Ji(t, e, i)
                        }, t.latLng = D, t.latLngBounds = R, t.layerGroup = function(t, e) {
                            return new Ci(t, e)
                        }, t.map = function(t, e) {
                            return new Ge(t, e)
                        }, t.marker = function(t, e) {
                            return new Oi(t, e)
                        }, t.point = O, t.polygon = function(t, e) {
                            return new Ni(t, e)
                            ...
                            return new gn(t, e)
                        }, t.setOptions = d, t.stamp = s, t.svg = fn, t.svgOverlay = function(t, e, i) {
                            return new Qi(t, e, i)
                        }, t.tileLayer = an, t.tooltip = function(t, e) {
                            return new nn(t, e)
