/*! For license information please see numeral.js.LICENSE.txt */ ! function(e, r) {
    ...
    return function() {
        var e = {
                8731: function(e, r, n) {
                    var i, t, l;
                    t = [n(2077)], void 0 === (l = "function" == typeof(i = function(e) {
                        var r;
                        e.register("locale", "bg", {
                            ...
                            ordinal: function(e) {
                                if (0 === e) return "'ıncı";
                                var n = e % 10;
                                return r[n] || r[e % 100 - n] || r[e >= 100 ? 100 : null]
                            },
                            currency: {
                                symbol: "₺"
                            }
                    ...
                    i = function() {
                        ...
                        return (e = function(n) {
                            ...
                            if (e.isNumeral(n)) i = n.value();
                                ...
                                if (s.zeroFormat && n === s.zeroFormat) i = 0;
                                else if (s.nullFormat && n === s.nullFormat || !n.replace(/[^0-9]+/g, "").length) i = null;
                            else {
                                for (t in l)
                                    if ((a = "function" == typeof l[t].regexps.unformat ? l[t].regexps.unformat() : l[t].regexps.unformat) && n.match(a)) {
                                        o = l[t].unformat;
                                        break
                                    }
                                i = (o = o || e._.stringToNumber)(n)
                            } else i = Number(n) || null;
                            return new u(n, i)
                        }).version = "2.0.6", e.isNumeral = function(e) {
                            return e instanceof u
                        }, e._ = r = {
                            numberToFormat: function(r, n, i) {
                                var t, l, a, s, u, c, m, d, b = o[e.options.currentLocale],
                                    f = !1,
                                    h = !1,
                                    y = "",
                                    p = 1e12,
                                    ...
                                    _ = "",
                                    x = !1;
                                if (r = r || 0, l = Math.abs(r), e._.includes(n, "(") ? (f = !0, n = n.replace(/[\(|\)]/g, "")) : (e._.includes(n, "+") || e._.includes(n, "-")) && (u = e._.includes(n, "+") ? n.indexOf("+") : r < 0 ? n.indexOf("-") : -1, n = n.replace(/[\+|\-]/g, "")), e._.includes(n, "a") && (t = !!(t = n.match(/a(k|m|b|t)?/)) && t[1], e._.includes(n, " a") && (y = " "), n = n.replace(new RegExp(y + "a[kmbt]?"), ""), l >= p && !t || "t" === t ? (y += b.abbreviations.trillion, r /= p) : l < p && l >= v && !t || "b" === t ? (y += b.abbreviations.billion, r /= v) : l < v && l >= g && !t || "m" === t ? (y += b.abbreviations.million, r /= g) : (l < g && l >= 1e3 && !t || "k" === t) && (y += b.abbreviations.thousand, r /= 1e3)), e._.includes(n, "[.]") && (h = !0, n = n.replace("[.]", ".")), a = r.toString().split(".")[0], s = n.split(".")[1], c = n.indexOf(","), d = (n.split(".")[0].split(",")[0].match(/0/g) || []).length, s ? (e._.includes(s, "[") ? (s = (s = s.replace("]", "")).split("["), _ = e._.toFixed(r, s[0].length + s[1].length, i, s[1].length)) : _ = e._.toFixed(r, s.length, i), a = _.split(".")[0], _ = e._.includes(_, ".") ? b.delimiters.decimal + _.split(".")[1] : "", h && 0 === Number(_.slice(1)) && (_ = "")) : a = e._.toFixed(r, 0, i), y && !t && Number(a) >= 1e3 && y !== b.abbreviations.trillion) switch (a = String(Number(a) / 1e3), y) {
                                    case b.abbreviations.thousand:
                                        y = b.abbreviations.million;
                                        break;
                                    case b.abbreviations.million:
                                        y = b.abbreviations.billion;
                                        break;
                                    case b.abbreviations.billion:
                                        y = b.abbreviations.trillion
                                }
                                if (e._.includes(a, "-") && (a = a.slice(1), x = !0), a.length < d)
                                    for (var F = d - a.length; F > 0; F--) a = "0" + a;
                                return c > -1 && (a = a.toString().replace(/(\d)(?=(\d{3})+(?!\d))/g, "$1" + b.delimiters.thousands)), 0 === n.indexOf(".") && (a = ""), m = a + _ + (y || ""), f ? m = (f && x ? "(" : "") + m + (f && x ? ")" : "") : u >= 0 ? m = 0 === u ? (x ? "-" : "+") + m : m + (x ? "-" : "+") : x && (m = "-" + m), m
                            },
                            stringToNumber: function(e) {
                                var r, n, i, t = o[s.currentLocale],
                                    l = e,
                                    a = {
                                        thousand: 3,
                                        million: 6,
                                ...
                                if (s.zeroFormat && e === s.zeroFormat) n = 0;
                                    ...
                                    for (r in n = 1, "." !== t.delimiters.decimal && (e = e.replace(/\./g, "").replace(t.delimiters.decimal, ".")), a)
                                        if (i = new RegExp("[^a-zA-Z]" + t.abbreviations[r] + "(?:\\)|(\\" + t.currency.symbol + ")?(?:\\))?)?$"), l.match(i)) {
                                            n *= Math.pow(10, a[r]);
                                            break
                                        }
                            ...
                            reduce: function(e, r) {
                                ...
                                for (; l < t; l++) l in i && (n = r(n, i[l], l, i));
                                return n
                            },
                            ...
                            correctionFactor: function() {
                                return Array.prototype.slice.call(arguments).reduce((function(e, n) {
                                    var i = r.multiplier(n);
                                    return e > i ? e : i
                                }), 1)
                            },
                            toFixed: function(e, r, n, i) {
                                var t, l, o, a, s = e.toString().split("."),
                                    u = r - (i || 0);
                                return t = 2 === s.length ? Math.min(Math.max(s[1].length, u), r) : u, o = Math.pow(10, t), a = (n(e + "e+" + t) / o).toFixed(t), i > r - t && (l = new RegExp("\\.?0{1," + (i - (r - t)) + "}$"), a = a.replace(l, "")), a
                            }
                            ...
                            format: function(r, n) {
                                var i, t, o, a = this._value,
                                    u = r || s.defaultFormat;
                                if (n = n || Math.round, 0 === a && null !== s.zeroFormat) t = s.zeroFormat;
                                else if (null === a && null !== s.nullFormat) t = s.nullFormat;
                                else {
                                    for (i in l)
                                        if (u.match(l[i].regexps.format)) {
                                            o = l[i].format;
                                            break
                                        }
                                    t = (o = o || e._.numberToFormat)(a, u, n)
                                }
                                return t
                            },
                            value: function() {
                            ...
                            add: function(e) {
                                var n = r.correctionFactor.call(null, this._value, e);
                                return this._value = r.reduce([this._value, e], (function(e, r, i, t) {
                                    return e + Math.round(n * r)
                                }), 0) / n, this
                            },
                            subtract: function(e) {
                                var n = r.correctionFactor.call(null, this._value, e);
                                return this._value = r.reduce([e], (function(e, r, i, t) {
                                    return e - Math.round(n * r)
                                }), Math.round(this._value * n)) / n, this
                            },
                            multiply: function(e) {
                                return this._value = r.reduce([this._value, e], (function(e, n, i, t) {
                                    var l = r.correctionFactor(e, n);
                                    return Math.round(e * l) * Math.round(n * l) / Math.round(l * l)
                                }), 1), this
                            },
                            divide: function(e) {
                                return this._value = r.reduce([this._value, e], (function(e, n, i, t) {
                                    var l = r.correctionFactor(e, n);
                                    return Math.round(e * l) / Math.round(n * l)
                                })), this
                            },
                            ...
                            format: function(r, n, i) {
                                var t, l = e._.includes(n, " BPS") ? " " : "";
                                return r *= 1e4, n = n.replace(/\s?BPS/, ""), t = e._.numberToFormat(r, n, i), e._.includes(t, ")") ? ((t = t.split("")).splice(-1, 0, l + "BPS"), t = t.join("")) : t = t + l + "BPS", t
                            },
                            unformat: function(r) {
                            ...
                            format: function(r, t, l) {
                                var o, a, s, u = e._.includes(t, "ib") ? i : n,
                                    c = e._.includes(t, " b") || e._.includes(t, " ib") ? " " : "";
                                for (t = t.replace(/\s?i?b/, ""), o = 0; o <= u.suffixes.length; o++)
                                    if (a = Math.pow(u.base, o), s = Math.pow(u.base, o + 1), null === r || 0 === r || r >= a && r < s) {
                            ...
                            unformat: function(r) {
                                ...
                                if (o) {
                                    for (t = n.suffixes.length - 1; t >= 0; t--) {
                            ...
                            format: function(r, n, i) {
                                var t, l, o = e.locales[e.options.currentLocale],
                                    a = {
                                        before: n.match(/^([\+|\-|\(|\s|\$]*)/)[0],
                                        after: n.match(/([\+|\-|\)|\s|\$]*)$/)[0]
                                    };
                                for (n = n.replace(/\s?\$\s?/, ""), t = e._.numberToFormat(r, n, i), r >= 0 ? (a.before = a.before.replace(/[\-\(]/, ""), a.after = a.after.replace(/[\-\)]/, "")) : r < 0 && !e._.includes(a.before, "-") && !e._.includes(a.before, "(") && (a.before = "-" + a.before), l = 0; l < a.before.length; l++) switch (a.before[l]) {
                                    case "$":
                            ...
                            format: function(r, n, i) {
                                ...
                                return n = n.replace(/e[\+|\-]{1}0/, ""), e._.numberToFormat(Number(t[0]), n, i) + "e" + t[1]
                            },
                            unformat: function(r) {
                                var n = e._.includes(r, "e+") ? r.split("e+") : r.split("e-"),
                                    i = Number(n[0]),
                                    t = Number(n[1]);
                                return t = e._.includes(r, "e-") ? t *= -1 : t, e._.reduce([i, Math.pow(10, t)], (function(r, n, i, t) {
                                    var l = e._.correctionFactor(r, n);
                                    return r * l * (n * l) / (l * l)
                                }), 1)
                            }
                            ...
                            format: function(r, n, i) {
                                var t = e.locales[e.options.currentLocale],
                                    l = e._.includes(n, " o") ? " " : "";
                                return n = n.replace(/\s?o/, ""), l += t.ordinal(r), e._.numberToFormat(r, n, i) + l
                            }
                            ...
                            format: function(r, n, i) {
                                var t, l = e._.includes(n, " %") ? " " : "";
                                return e.options.scalePercentBy100 && (r *= 100), n = n.replace(/\s?\%/, ""), t = e._.numberToFormat(r, n, i), e._.includes(t, ")") ? ((t = t.split("")).splice(-1, 0, l + "%"), t = t.join("")) : t = t + l + "%", t
                            },
                            unformat: function(r) {
                                var n = e._.stringToNumber(r);
                            ...
                            format: function(e, r, n) {
                                var i = Math.floor(e / 60 / 60),
                                    ...
                                    l = Math.round(e - 60 * i * 60 - 60 * t);
                                return i + ":" + (t < 10 ? "0" + t : t) + ":" + (l < 10 ? "0" + l : l)
                            },
                            unformat: function(e) {
                                var r = e.split(":"),
                                    n = 0;
                                return 3 === r.length ? (n += 60 * Number(r[0]) * 60, n += 60 * Number(r[1]), n += Number(r[2])) : 2 === r.length && (n += 60 * Number(r[0]), n += Number(r[1])), Number(n)
                            }
                        }), e
                    }, void 0 === (t = i.call(r, n, r, e)) || (e.exports = t)
                }
            },
            r = {};
