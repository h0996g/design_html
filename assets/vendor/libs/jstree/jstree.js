/*! For license information please see jstree.js.LICENSE.txt */ ! function(e, t) {
                            ...
                            if (!e.jstree) {
                                ...
                                !c && l && (c = function(e, t) {
                                    ...
                                    var s = new e.jstree.core(++i),
                                        a = r;
                                    return r = e.extend(!0, {}, e.jstree.defaults, r), a && a.plugins && (r.plugins = a.plugins), e.each(r.plugins, (function(e, t) {
                                    ...
                                    return !(!0 === i && !this.length) && (this.each((function() {
                                        var n = e.jstree.reference(this),
                                            o = r && n ? n[i] : null;
                                        if (a = r && o ? o.apply(n, s) : null, n || r || i !== t && !e.isPlainObject(i) || e.jstree.create(this, i), (n && !r || !0 === i) && (a = n || !1), null !== a && a !== t) return !1
                                    })), null !== a && a !== t ? a : this)
                                    ...
                                    _kbevent_to_func: function(e) {
                                        var t = {
                                            ...
                                            i = [];
                                        if (e.ctrlKey && i.push("ctrl"), e.altKey && i.push("alt"), e.shiftKey && i.push("shift"), i.push(t[e.which] ? t[e.which].toLowerCase() : e.which), "shift-shift" === (i = i.sort().join("-").toLowerCase()) || "ctrl-ctrl" === i || "alt-alt" === i) return null;
                                        var r, s, a = this.settings.core.keyboard;
                                        for (r in a)
                                            if (a.hasOwnProperty(r) && ("-" !== (s = r) && "+" !== s && (s = (s = s.replace("--", "-MINUS").replace("+-", "-MINUS").replace("++", "-PLUS").replace("-+", "-PLUS")).split(/-|\+/).sort().join("-").replace("MINUS", "-").replace("PLUS", "+").toLowerCase()), s === i)) return a[r];
                                        return null
                                    },
                                    teardown: function() {
                                    ...
                                    bind: function() {
                                        ...
                                        this.element.on("dblclick.jstree", (function(e) {
                                            ...
                                            t.preventDefault(), t.currentTarget !== d.activeElement && e(t.currentTarget).trigger("focus"), this.activate_node(t.currentTarget, t)
                                            ...
                                            i.status && (i.node.id !== e.jstree.root || this._data.core.loaded || (this._data.core.loaded = !0, this._firstChild(this.get_container_ul()[0]) && this.element.attr("aria-activedescendant", this._firstChild(this.get_container_ul()[0]).id), this.trigger("loaded")), this._data.core.ready || setTimeout(function() {
                                            ...
                                            if ((t += s).length > 1) {
                                                if (a.slice(n).each(function(i, r) {
                                                        if (0 === e(r).text().toLowerCase().indexOf(t)) return e(r).trigger("focus"), o = !0, !1
                                                    }.bind(this)), o) return;
                                            ...
                                            if (new RegExp("^" + s.replace(/[-\/\\^$*+?.()|[\]{}]/g, "\\$&") + "+$").test(t)) {
                                                if (a.slice(n + 1).each(function(t, i) {
                                                        if (e(i).text().toLowerCase().charAt(0) === s) return e(i).trigger("focus"), o = !0, !1
                                                    }.bind(this)), o) return;
                                            ...
                                            this._data.core.focused = null, e(t.currentTarget).filter(".jstree-hovered").trigger("mouseleave"), this.element.attr("tabindex", "0"), e(t.currentTarget).attr("tabindex", "-1")
                                        }.bind(this)).on("focus.jstree", ".jstree-anchor", function(t) {
                                            var i = this.get_node(t.currentTarget);
                                            i && (i.id || 0 === i.id) && (this._data.core.focused = i.id), this.element.find(".jstree-hovered").not(t.currentTarget).trigger("mouseleave"), e(t.currentTarget).trigger("mouseenter"), this.element.attr("tabindex", "-1"), e(t.currentTarget).attr("tabindex", "0")
                                    ...
                                    get_node: function(t, i) {
                                        var r;
                                        t && (t.id || 0 === t.id) && (t = t.id), t instanceof e && t.length && t[0].id && (t = t[0].id);
                                        try {
                                    ...
                                    load_node: function(t, i) {
                                        ...
                                        if (e.vakata.is_array(t)) return this._load_nodes(t.slice(), i), !0;
                                        ...
                                        return t.state.failed = !1, t.state.loading = !0, t.id !== e.jstree.root ? d.children(".jstree-anchor").attr("aria-busy", !0) : d.attr("aria-busy", !0), d.addClass("jstree-loading"), this._load_node(t, function(r) {
                                            (t = this._model.data[t.id]).state.loading = !1, t.state.loaded = r, t.state.failed = !t.state.loaded;
                                            var s, a = this.get_node(t, !0),
                                                n = 0,
                                                o = this._model.data,
                                                d = !1;
                                            ...
                                            t.state.loaded && a && a.length && (a.removeClass("jstree-closed jstree-open jstree-leaf"), d ? "#" !== t.id && a.addClass(t.state.opened ? "jstree-open" : "jstree-closed") : a.addClass("jstree-leaf")), t.id !== e.jstree.root ? a.children(".jstree-anchor").attr("aria-busy", !1) : a.attr("aria-busy", !1), a.removeClass("jstree-loading"), this.trigger("load_node", {
                                                node: t,
                                                status: r
                                            }), i && i.call(this, t, r)
                                        }.bind(this)), !0
                                    ...
                                    load_all: function(t, i) {
                                        ...
                                        var r, s, a = [],
                                            n = this._model.data,
                                            o = n[t.id].children_d;
                                        for (t.state && !t.state.loaded && a.push(t.id), r = 0, s = o.length; r < s; r++) n[o[r]] && n[o[r]].state && !n[o[r]].state.loaded && a.push(o[r]);
                                    ...
                                    _load_node: function(t, i) {
                                        ...
                                        }.bind(this)) : "object" == typeof s ? s.url ? (s = e.extend(!0, {}, s), e.vakata.is_function(s.url) && (s.url = s.url.call(this, t)), e.vakata.is_function(s.data) && (s.data = s.data.call(this, t)), e.ajax(s).done(function(r, s, n) {
                                        ...
                                        }.bind(this))) : (r = e.vakata.is_array(s) ? e.extend(!0, [], s) : e.isPlainObject(s) ? e.extend(!0, {}, s) : s, t.id === e.jstree.root ? this._append_json_data(t, r, (function(e) {
                                            i.call(this, e)
                                        })) : (this._data.core.last_error = {
                                            error: "nodata",
                                            plugin: "core",
                                        ...
                                        }, this.settings.core.error.call(this, this._data.core.last_error), i.call(this, !1))) : "string" == typeof s ? t.id === e.jstree.root ? this._append_html_data(t, e(e.parseHTML(s)).filter(a), (function(e) {
                                            i.call(this, e)
                                        })) : (this._data.core.last_error = {
                                            error: "nodata",
                                            plugin: "core",
                                    ...
                                    _append_html_data: function(t, i, r) {
                                        ...
                                        var s, a, n, o = i.is("ul") ? i.children() : i,
                                            d = t.id,
                                            c = [],
                                            l = [],
                                            h = this._model.data,
                                        ...
                                        for (o.each(function(t, i) {
                                            ...
                                            }.bind(this)), _.children = c, _.children_d = l, a = 0, n = _.parents.length; a < n; a++) h[_.parents[a]].children_d = h[_.parents[a]].children_d.concat(l);
                                        this.trigger("model", {
                                            nodes: l,
                                            parent: d
                                    ...
                                    _append_json_data: function(t, i, r, s) {
                                        if (null !== this.element) {
                                            (t = this.get_node(t)).children = [], t.children_d = [], i.d && "string" == typeof(i = i.d) && (i = JSON.parse(i)), e.vakata.is_array(i) || (i = [i]);
                                            var a = null,
                                                n = {
                                                ...
                                                d = function(e, t) {
                                                    ...
                                                    var i, r, s, a, n = e.dat,
                                                        ...
                                                        v = function(e, i, r) {
                                                            ...
                                                            for (e && e.children && !0 === e.children && (c.state.loaded = !1, c.children = [], c.children_d = []), f[c.id] = c, s = 0, a = c.children.length; s < a; s++) n = v(f[c.children[s]], c.id, r), o = f[n], c.children_d.push(n), o.children_d.length && (c.children_d = c.children_d.concat(o.children_d));
                                                        ...
                                                        j = function(e, i, r) {
                                                            ...
                                                            if (e && (e.id || 0 === e.id) && (d.id = e.id.toString()), e && e.text && (d.text = e.text), e && e.data && e.data.jstree && e.data.jstree.icon && (d.icon = e.data.jstree.icon), d.icon !== t && null !== d.icon && "" !== d.icon || (d.icon = !0), e && e.data && (d.data = e.data, e.data.jstree))
                                                            ...
                                                            if (d.li_attr.id && !d.id && 0 !== d.id && (d.id = d.li_attr.id.toString()), d.id || 0 === d.id || (d.id = c), d.li_attr.id || (d.li_attr.id = d.id), e && "object" == typeof e.a_attr)
                                                                for (s in e.a_attr) e.a_attr.hasOwnProperty(s) && (d.a_attr[s] = e.a_attr[s]);
                                                            if (e && e.children && e.children.length) {
                                                                for (s = 0, a = e.children.length; s < a; s++) n = j(e.children[s], d.id, r), o = f[n], d.children.push(n), o.children_d.length && (d.children_d = d.children_d.concat(o.children_d));
                                                                d.children_d = d.children_d.concat(d.children)
                                                            }
                                                            return e && e.children && !0 === e.children && (d.state.loaded = !1, d.children = [], d.children_d = []), delete e.data, delete e.children, d.original = e, f[d.id] = d, d.state.selected && h.push(d.id), d.id
                                                        };
                                                    if (n.length && n[0].id !== t && n[0].parent !== t) {
                                                        for (r = 0, s = n.length; r < s; r++) n[r].children || (n[r].children = []), n[r].state || (n[r].state = {}), f[n[r].id.toString()] = n[r];
                                                        for (r = 0, s = n.length; r < s; r++) f[n[r].parent.toString()] ? (f[n[r].parent.toString()].children.push(n[r].id.toString()), p.children_d.push(n[r].id.toString())) : void 0 !== o && (o._data.core.last_error = {
                                                            error: "parse",
                                                            plugin: "core",
                                                            id: "core_07",
                                                        ...
                                                        for (r = 0, s = p.children.length; r < s; r++) i = v(f[p.children[r]], d, p.parents.concat()), l.push(i), f[i].children_d.length && (l = l.concat(f[i].children_d));
                                                        for (r = 0, s = p.parents.length; r < s; r++) f[p.parents[r]].children_d = f[p.parents[r]].children_d.concat(l);
                                                        a = {
                                                            cnt: g,
                                                            mod: f,
                                                            sel: m,
                                                        ...
                                                        for (r = 0, s = n.length; r < s; r++)(i = j(n[r], d, p.parents.concat())) && (c.push(i), l.push(i), f[i].children_d.length && (l = l.concat(f[i].children_d)));
                                                        for (p.children = c, p.children_d = l, r = 0, s = p.parents.length; r < s; r++) f[p.parents[r]].children_d = f[p.parents[r]].children_d.concat(l);
                                                        a = {
                                                            cnt: g,
                                                            mod: f,
                                                            sel: m,
                                                    ...
                                                    if ("undefined" != typeof window && void 0 !== window.document) return a;
                                                    postMessage(a)
                                                },
                                                l = function(t, i) {
                                                    if (null !== this.element) {
                                                        ...
                                                        if (this._model.data = t.mod, i) {
                                                            ...
                                                            if (a = this._model.data, l.length !== h.length || e.vakata.array_unique(l.concat(h)).length !== l.length) {
                                                                for (s = 0, n = l.length; s < n; s++) - 1 === e.inArray(l[s], d) && -1 === e.inArray(l[s], h) && (a[l[s]].state.selected = !1);
                                                                for (s = 0, n = h.length; s < n; s++) - 1 === e.inArray(h[s], l) && (a[h[s]].state.selected = !0)
                                                            }
                                                        }
                                            ...
                                            if (this.settings.core.worker && window.Blob && window.URL && window.Worker) try {
                                                null === this._wrk && (this._wrk = window.URL.createObjectURL(new window.Blob(["self.onmessage = " + d.toString()], {
                                                ...
                                                }))), !this._data.core.working || s ? (this._data.core.working = !0, (a = new window.Worker(this._wrk)).onmessage = function(e) {
                                                    ...
                                                    l.call(this, d(n), !1), this._data.core.worker_queue.length ? this._append_json_data.apply(this, this._data.core.worker_queue.shift()) : this._data.core.working = !1
                                                }.bind(this), n.par ? a.postMessage(n) : this._data.core.worker_queue.length ? this._append_json_data.apply(this, this._data.core.worker_queue.shift()) : this._data.core.working = !1) : this._data.core.worker_queue.push([t, i, r, !0])
                                            } catch (e) {
                                                l.call(this, d(n), !1), this._data.core.worker_queue.length ? this._append_json_data.apply(this, this._data.core.worker_queue.shift()) : this._data.core.working = !1
                                    ...
                                    _parse_model_from_html: function(i, r, s) {
                                        ...
                                        return h.id = h.li_attr.id ? h.li_attr.id.toString() : c, d.length ? (d.each(function(t, i) {
                                            a = this._parse_model_from_html(e(i), h.id, s), n = this._model.data[a], h.children.push(a), n.children_d.length && (h.children_d = h.children_d.concat(n.children_d))
                                        }.bind(this)), h.children_d = h.children_d.concat(h.children)) : i.hasClass("jstree-closed") && (h.state.loaded = !1), h.li_attr.class && (h.li_attr.class = h.li_attr.class.replace("jstree-closed", "").replace("jstree-open", "")), h.a_attr.class && (h.a_attr.class = h.a_attr.class.replace("jstree-clicked", "").replace("jstree-disabled", "")), l[h.id] = h, h.state.selected && this._data.core.selected.push(h.id), h.id
                                    },
                                    _parse_model_from_flat_json: function(e, i, r) {
                                        ...
                                        for (e && e.children && !0 === e.children && (h.state.loaded = !1, h.children = [], h.children_d = []), c[h.id] = h, s = 0, a = h.children.length; s < a; s++) o = c[n = this._parse_model_from_flat_json(c[h.children[s]], h.id, r)], h.children_d.push(n), o.children_d.length && (h.children_d = h.children_d.concat(o.children_d));
                                    ...
                                    _parse_model_from_json: function(e, i, r) {
                                        ...
                                        if (d.li_attr.id && !d.id && 0 !== d.id && (d.id = d.li_attr.id.toString()), d.id || 0 === d.id || (d.id = c), d.li_attr.id || (d.li_attr.id = d.id), e && "object" == typeof e.a_attr)
                                            for (s in e.a_attr) e.a_attr.hasOwnProperty(s) && (d.a_attr[s] = e.a_attr[s]);
                                        if (e && e.children && e.children.length) {
                                            for (s = 0, a = e.children.length; s < a; s++) o = l[n = this._parse_model_from_json(e.children[s], d.id, r)], d.children.push(n), o.children_d.length && (d.children_d = d.children_d.concat(o.children_d));
                                    ...
                                    _redraw: function() {
                                        ...
                                        for (i = 0, r = s.length; i < r; i++)(t = this.redraw_node(s[i], !0, this._model.force_full_redraw)) && this._model.force_full_redraw && a.appendChild(t);
                                        this._model.force_full_redraw && (a.className = this.get_container_ul()[0].className, a.setAttribute("role", "presentation"), this.element.empty().append(a)), null !== n && this.settings.core.restore_focus && ((t = this.get_node(n, !0)) && t.length && t.children(".jstree-anchor")[0] !== d.activeElement ? t.children(".jstree-anchor").trigger("focus") : this._data.core.focused = null), this._model.force_full_redraw = !1, this._model.changed = [], this.trigger("redraw", {
                                            nodes: s
                                        })
                                    },
                                    redraw: function(e) {
                                    ...
                                    draw_children: function(t) {
                                        ...
                                        if (t.children(".jstree-children").remove(), t = t[0], i.children.length && i.state.loaded) {
                                            for ((a = n.createElement("UL")).setAttribute("role", "group"), a.className = "jstree-children", r = 0, s = i.children.length; r < s; r++) a.appendChild(this.redraw_node(i.children[r], !0, !0));
                                            t.appendChild(a)
                                        }
                                    },
                                    redraw_node: function(t, i, r, s) {
                                        ...
                                        for (a.a_attr.id || (a.a_attr.id = a.id + "_anchor"), t.childNodes[1].setAttribute("aria-selected", !!a.state.selected), t.childNodes[1].setAttribute("aria-level", a.parents.length), this.settings.core.compute_elements_positions && (t.childNodes[1].setAttribute("aria-setsize", f[a.parent].children.length), t.childNodes[1].setAttribute("aria-posinset", f[a.parent].children.indexOf(a.id) + 1)), a.state.disabled && t.childNodes[1].setAttribute("aria-disabled", !0), l = 0, h = a.children.length; l < h; l++)
                                            if (!f[a.children[l]].state.hidden) {
                                                k = !0;
                                                break
                                            }
                                        if (null !== a.parent && f[a.parent] && !a.state.hidden && (l = e.inArray(a.id, f[a.parent].children), b = a.id, -1 !== l))
                                            for (l++, h = f[a.parent].children.length; l < h && (f[f[a.parent].children[l]].state.hidden || (b = f[a.parent].children[l]), b === a.id); l++);
                                        for (h in a.state.hidden && (u += " jstree-hidden"), a.state.loading && (u += " jstree-loading"), a.state.loaded && !k ? u += " jstree-leaf" : (u += a.state.opened && a.state.loaded ? " jstree-open" : " jstree-closed", t.childNodes[1].setAttribute("aria-expanded", a.state.opened && a.state.loaded)), b === a.id && (u += " jstree-last"), t.id = a.id, t.className = u, u = (a.state.selected ? " jstree-clicked" : "") + (a.state.disabled ? " jstree-disabled" : ""), a.a_attr)
                                        ...
                                        if (u.length && (t.childNodes[1].className = "jstree-anchor " + u), (a.icon && !0 !== a.icon || !1 === a.icon) && (!1 === a.icon ? t.childNodes[1].childNodes[0].className += " jstree-themeicon-hidden" : -1 === a.icon.indexOf("/") && -1 === a.icon.indexOf(".") ? t.childNodes[1].childNodes[0].className += " " + a.icon + " jstree-themeicon-custom" : (t.childNodes[1].childNodes[0].style.backgroundImage = 'url("' + a.icon + '")', t.childNodes[1].childNodes[0].style.backgroundPosition = "center center", t.childNodes[1].childNodes[0].style.backgroundSize = "auto", t.childNodes[1].childNodes[0].className += " jstree-themeicon-custom")), this.settings.core.force_text ? t.childNodes[1].appendChild(g.createTextNode(a.text)) : t.childNodes[1].innerHTML += a.text, i && a.children.length && (a.state.opened || s) && a.state.loaded) {
                                            for ((_ = g.createElement("UL")).setAttribute("role", "group"), _.className = "jstree-children", l = 0, h = a.children.length; l < h; l++) _.appendChild(this.redraw_node(a.children[l], i, !0));
                                            t.appendChild(_)
                                        }
                                        if (c && t.appendChild(c), !r) {
                                            for (n || (n = this.element[0]), l = 0, h = n.childNodes.length; l < h; l++)
                                                if (n.childNodes[l] && n.childNodes[l].className && -1 !== n.childNodes[l].className.indexOf("jstree-children")) {
                                                    m = n.childNodes[l];
                                                    break
                                                }
                                            m || ((m = g.createElement("UL")).setAttribute("role", "group"), m.className = "jstree-children", n.appendChild(m)), o < (n = m).childNodes.length ? n.insertBefore(t, n.childNodes[o]) : n.appendChild(t), p && (v = this.element[0].scrollTop, j = this.element[0].scrollLeft, t.childNodes[1].focus(), this.element[0].scrollTop = v, this.element[0].scrollLeft = j)
                                        }
                                        return a.state.opened && !a.state.loaded && (a.state.opened = !1, setTimeout(function() {
                                    ...
                                    open_node: function(i, r, s) {
                                        ...
                                        return !(!(i = this.get_node(i)) || i.id === e.jstree.root) && (s = s === t ? this.settings.core.animation : s, this.is_closed(i) ? this.is_loaded(i) ? (o = this.get_node(i, !0), d = this, o.length && (s && o.children(".jstree-children").length && o.children(".jstree-children").stop(!0, !0), i.children.length && !this._firstChild(o.children(".jstree-children")[0]) && this.draw_children(i), s ? (this.trigger("before_open", {
                                            ...
                                            node: i
                                        }), o[0].className = o[0].className.replace("jstree-closed", "jstree-open"), o[0].childNodes[1].setAttribute("aria-expanded", !0))), i.state.opened = !0, r && r.call(this, i, !0), o.length || this.trigger("before_open", {
                                            node: i
                                    ...
                                    close_node: function(i, r) {
                                        ...
                                        return !(!(i = this.get_node(i)) || i.id === e.jstree.root) && !this.is_closed(i) && (r = r === t ? this.settings.core.animation : r, n = this, o = this.get_node(i, !0), i.state.opened = !1, this.trigger("close_node", {
                                            node: i
                                        ...
                                        })) : (o[0].className = o[0].className.replace("jstree-open", "jstree-closed"), o.children(".jstree-anchor").attr("aria-expanded", !1), o.children(".jstree-children").remove(), this.trigger("after_close", {
                                            node: i
                                    ...
                                    open_all: function(t, i, r) {
                                        ...
                                        if (!o.length) {
                                            for (s = 0, a = t.children_d.length; s < a; s++) this.is_closed(this._model.data[t.children_d[s]]) && (this._model.data[t.children_d[s]].state.opened = !0);
                                            return this.trigger("open_all", {
                                                node: t
                                            })
                                        }
                                        r = r || o, n = this, (o = this.is_closed(t) ? o.find(".jstree-closed").addBack() : o.find(".jstree-closed")).each((function() {
                                    ...
                                    close_all: function(t, i) {
                                        if (t || (t = e.jstree.root), !(t = this.get_node(t))) return !1;
                                        var r, s, a = t.id === e.jstree.root ? this.get_container_ul() : this.get_node(t, !0),
                                            n = this;
                                        for (a.length && (a = this.is_open(t) ? a.find(".jstree-open").addBack() : a.find(".jstree-open"), e(a.get().reverse()).each((function() {
                                    ...
                                    activate_node: function(e, i) {
                                        ...
                                        if (i && "object" == typeof i || (i = {}), this._data.core.last_clicked = this._data.core.last_clicked && this._data.core.last_clicked.id !== t ? this.get_node(this._data.core.last_clicked.id) : null, this._data.core.last_clicked && !this._data.core.last_clicked.state.selected && (this._data.core.last_clicked = null), !this._data.core.last_clicked && this._data.core.selected.length && (this._data.core.last_clicked = this.get_node(this._data.core.selected[this._data.core.selected.length - 1])), this.settings.core.multiple && (i.metaKey || i.ctrlKey || i.shiftKey) && (!i.shiftKey || this._data.core.last_clicked && this.get_parent(e) && this.get_parent(e) === this._data.core.last_clicked.parent))
                                            if (i.shiftKey) {
                                                var r, s, a = this.get_node(e).id,
                                                    n = this._data.core.last_clicked.id,
                                                    o = this.get_node(this._data.core.last_clicked.parent).children,
                                                    d = !1;
                                                for (r = 0, s = o.length; r < s; r += 1) o[r] === a && (d = !d), o[r] === n && (d = !d), this.is_disabled(o[r]) || !d && o[r] !== a && o[r] !== n ? i.ctrlKey || this.deselect_node(o[r], !0, i) : this.is_hidden(o[r]) || this.select_node(o[r], !0, !1, i);
                                                this.trigger("changed", {
                                                    action: "select_node",
                                            ...
                                            } else this.is_selected(e) ? this.deselect_node(e, !1, i) : (i.ctrlKey && (this._data.core.last_clicked = this.get_node(e)), this.select_node(e, !1, !1, i));
                                        else !this.settings.core.multiple && (i.metaKey || i.ctrlKey || i.shiftKey) && this.is_selected(e) ? this.deselect_node(e, !1, i) : (!this.settings.core.allow_reselect && this.is_selected(e) && 1 === this._data.core.selected.length || (this.deselect_all(!0), this.select_node(e, !1, !1, i)), this._data.core.last_clicked = this.get_node(e));
                                    ...
                                    select_node: function(t, i, r, s) {
                                        ...
                                        if (!(t = this.get_node(t)) || t.id === e.jstree.root) return !1;
                                        a = this.get_node(t, !0), t.state.selected || (t.state.selected = !0, this._data.core.selected.push(t.id), r || (a = this._open_to(t)), a && a.length && a.children(".jstree-anchor").addClass("jstree-clicked").attr("aria-selected", !0), this.trigger("select_node", {
                                            node: t,
                                            selected: this._data.core.selected,
                                            event: s
                                    ...
                                    deselect_node: function(t, i, r) {
                                        ...
                                        if (!(t = this.get_node(t)) || t.id === e.jstree.root) return !1;
                                        n = this.get_node(t, !0), t.state.selected && (t.state.selected = !1, this._data.core.selected = e.vakata.array_remove_item(this._data.core.selected, t.id), n.length && n.children(".jstree-anchor").removeClass("jstree-clicked").attr("aria-selected", !1), this.trigger("deselect_node", {
                                            node: t,
                                            selected: this._data.core.selected,
                                            event: r
                                        }), i || this.trigger("changed", {
                                    ...
                                    get_top_selected: function(t) {
                                        var i, r, s, a, n = this.get_selected(!0),
                                            o = {};
                                        for (i = 0, r = n.length; i < r; i++) o[n[i].id] = n[i];
                                        for (i = 0, r = n.length; i < r; i++)
                                            for (s = 0, a = n[i].children_d.length; s < a; s++) o[n[i].children_d[s]] && delete o[n[i].children_d[s]];
                                    ...
                                    get_bottom_selected: function(t) {
                                        var i, r, s = this.get_selected(!0),
                                            a = [];
                                        for (i = 0, r = s.length; i < r; i++) s[i].children.length || a.push(s[i].id);
                                    ...
                                    set_state: function(i, r) {
                                        if (i) {
                                            if (i.core && i.core.selected && i.core.initial_selection === t && (i.core.initial_selection = this._data.core.selected.concat([]).sort().join(",")), i.core) {
                                                var s, a;
                                                if (i.core.loaded) return this.settings.core.loaded_state && e.vakata.is_array(i.core.loaded) && i.core.loaded.length ? this._load_nodes(i.core.loaded, (function(e) {
                                                    delete i.core.loaded, this.set_state(i, r)
                                                })) : (delete i.core.loaded, this.set_state(i, r)), !1;
                                                if (i.core.open) return e.vakata.is_array(i.core.open) && i.core.open.length ? this._load_nodes(i.core.open, (function(e) {
                                    ...
                                    refresh: function(t, i) {
                                        this._data.core.state = !0 === i ? {} : this.get_state(), i && e.vakata.is_function(i) && (this._data.core.state = i.call(this, this._data.core.state)), this._cnt = 0, this._model.data = {}, this._model.data[e.jstree.root] = {
                                            id: e.jstree.root,
                                            parent: null,
                                            parents: [],
                                            children: [],
                                        ...
                                        t || (this.element.html("<ul class='" + r + "' role='group'><li class='jstree-initial-node jstree-loading jstree-leaf jstree-last' role='none' id='j" + this._id + "_loading'><i class='jstree-icon jstree-ocl'></i><a class='jstree-anchor' role='treeitem' href='#'><i class='jstree-icon jstree-themeicon-hidden'></i>" + this.get_string("Loading ...") + "</a></li></ul>"), this.element.attr("aria-activedescendant", "j" + this._id + "_loading")), this.load_node(e.jstree.root, (function(t, i) {
                                    ...
                                    set_id: function(t, i) {
                                        ...
                                        var r, s, a = this._model.data,
                                            n = t.id;
                                        for (i = i.toString(), a[t.parent].children[e.inArray(t.id, a[t.parent].children)] = i, r = 0, s = t.parents.length; r < s; r++) a[t.parents[r]].children_d[e.inArray(t.id, a[t.parents[r]].children_d)] = i;
                                        ...
                                        return -1 !== (r = e.inArray(t.id, this._data.core.selected)) && (this._data.core.selected[r] = i), (r = this.get_node(t.id, !0)) && (r.attr("id", i), this.element.attr("aria-activedescendant") === t.id && this.element.attr("aria-activedescendant", i)), delete a[t.id], t.id = i, t.li_attr.id = i, a[i] = t, this.trigger("set_id", {
                                            node: t,
                                            new: t.id,
                                            old: n
                                        }), !0
                                    ...
                                    get_json: function(t, i, r) {
                                        ...
                                        if (i && i.flat ? n.parent = t.parent : n.children = [], i && i.no_state) delete n.state;
                                            ...
                                            for (s in t.state) t.state.hasOwnProperty(s) && (n.state[s] = t.state[s]);
                                        if (i && i.no_li_attr && delete n.li_attr, i && i.no_a_attr && delete n.a_attr, i && i.no_id && (delete n.id, n.li_attr && n.li_attr.id && delete n.li_attr.id, n.a_attr && n.a_attr.id && delete n.a_attr.id), i && i.flat && t.id !== e.jstree.root && r.push(n), !i || !i.no_children)
                                            for (s = 0, a = t.children.length; s < a; s++) i && i.flat ? this.get_json(t.children[s], i, r) : n.children.push(this.get_json(t.children[s], i));
                                    ...
                                    create_node: function(i, r, s, a, n) {
                                        ...
                                        if (s > i.children.length && (s = i.children.length), r.id === t && (r.id = !0), !this.check("create_node", r, i, s)) return this.settings.core.error.call(this, this._data.core.last_error), !1;
                                    ...
                                    rename_node: function(t, i) {
                                        ...
                                        return !(!(t = this.get_node(t)) || t.id === e.jstree.root || (a = t.text, this.check("rename_node", t, this.get_parent(t), i) ? (this.set_text(t, i), this.trigger("rename_node", {
                                            node: t,
                                            text: i,
                                            old: a
                                    ...
                                    delete_node: function(t) {
                                        ...
                                        for (-1 !== a && (s.children = e.vakata.array_remove(s.children, a)), (n = t.children_d.concat([])).push(t.id), o = 0, d = t.parents.length; o < d; o++) this._model.data[t.parents[o]].children_d = e.vakata.array_filter(this._model.data[t.parents[o]].children_d, (function(t) {
                                    ...
                                    check: function(t, i, r, s, a) {
                                        ...
                                        if ("move_node" === t || "copy_node" === t) {
                                            if (!(a && a.is_multi || "move_node" !== t || e.inArray(i.id, r.children) !== s)) return this._data.core.last_error = {
                                                error: "check",
                                                plugin: "core",
                                                id: "core_08",
                                            ...
                                            if (!(a && a.is_multi || i.id !== r.id && ("move_node" !== t || e.inArray(i.id, r.children) !== s) && -1 === e.inArray(r.id, i.children_d))) return this._data.core.last_error = {
                                                error: "check",
                                                plugin: "core",
                                                id: "core_01",
                                        ...
                                        return n && n.data && (n = n.data), n && n.functions && (!1 === n.functions[t] || !0 === n.functions[t]) ? (!1 === n.functions[t] && (this._data.core.last_error = {
                                            error: "check",
                                            plugin: "core",
                                            id: "core_02",
                                    ...
                                    move_node: function(i, r, s, a, n, o, d) {
                                        ...
                                        if (i.parent === u.id) {
                                            ...
                                            for ((m = i.children_d.concat()).push(i.id), v = 0, j = i.parents.length; v < j; v++) {
                                                for (p = [], k = 0, b = (y = g._model.data[i.parents[v]].children_d).length; k < b; k++) - 1 === e.inArray(y[k], m) && p.push(y[k]);
                                                g._model.data[i.parents[v]].children_d = p
                                            }
                                            for (g._model.data[h].children = e.vakata.array_remove_item(g._model.data[h].children, i.id), v = 0, j = u.parents.length; v < j; v++) this._model.data[u.parents[v]].children_d = this._model.data[u.parents[v]].children_d.concat(m);
                                        ...
                                        return a && a.call(this, i, u, s), this.trigger("move_node", {
                                            node: i,
                                            parent: u.id,
                                            position: s,
                                            old_parent: h,
                                    ...
                                    copy_node: function(i, r, s, a, n, o, d) {
                                        ...
                                        if (e.vakata.is_array(i)) {
                                            if (1 !== i.length) {
                                                for (c = 0, l = i.length; c < l; c++)(_ = this.copy_node(i[c], r, s, a, n, !0, d)) && (r = _, s = "after");
                                                return this.redraw(), !0
                                            }
                                            i = i[0]
                                        }
                                        ...
                                        for (_ = this.get_node(f), i && i.state && !1 === i.state.loaded && (_.state.loaded = !1), (h = []).push(f), h = h.concat(_.children_d), this.trigger("model", {
                                                nodes: h,
                                                parent: m.id
                                            }), u = 0, g = m.parents.length; u < g; u++) this._model.data[m.parents[u]].children_d = this._model.data[m.parents[u]].children_d.concat(h);
                                        for (h = [], u = 0, g = m.children.length; u < g; u++) h[u >= s ? u + 1 : u] = m.children[u];
                                        return h[s] = _.id, m.children = h, m.children_d.push(_.id), m.children_d = m.children_d.concat(_.children_d), m.id === e.jstree.root && (this._model.force_full_redraw = !0), this._model.force_full_redraw || this._node_changed(m.id), o || this.redraw(m.id === e.jstree.root), a && a.call(this, _, m, s), this.trigger("copy_node", {
                                            node: _,
                                            original: i,
                                            parent: m.id,
                                            position: s,
                                    ...
                                    cut: function(t) {
                                        if (t || (t = this._data.core.selected.concat()), e.vakata.is_array(t) || (t = [t]), !t.length) return !1;
                                        var i, n, o, d = [];
                                        for (n = 0, o = t.length; n < o; n++)(i = this.get_node(t[n])) && (i.id || 0 === i.id) && i.id !== e.jstree.root && d.push(i);
                                        if (!d.length) return !1;
                                        r = d, a = this, s = "move_node", this.trigger("cut", {
                                            node: t
                                        })
                                    },
                                    copy: function(i) {
                                        if (i || (i = this._data.core.selected.concat()), e.vakata.is_array(i) || (i = [i]), !i.length) return !1;
                                        var n, o, d, c = [];
                                        for (o = 0, d = i.length; o < d; o++)(n = this.get_node(i[o])) && n.id !== t && n.id !== e.jstree.root && c.push(n);
                                        if (!c.length) return !1;
                                        r = c, a = this, s = "copy_node", this.trigger("copy", {
                                            node: i
                                        })
                                    },
                                    get_buffer: function() {
                                    ...
                                    edit: function(t, i, r) {
                                        ...
                                        return !!(t = this.get_node(t)) && (this.check("edit", t, this.get_parent(t)) ? (u = t, i = "string" == typeof i ? i : t.text, this.set_text(t, ""), t = this._open_to(t), u.text = i, s = this._data.core.rtl, a = this.element.width(), this._data.core.focused = u.id, n = t.children(".jstree-anchor").trigger("focus"), o = e("<span></span>"), c = i, l = e("<div></div>", {
                                            css: {
                                                position: "absolute",
                                                top: "-200px",
                                                left: s ? "0px" : "-1000px",
                                            ...
                                            blur: function(i) {
                                                ...
                                                var s, a = o.children(".jstree-rename-input").val(),
                                                    d = this.settings.core.force_text;
                                                "" === a && (a = c), l.remove(), o.replaceWith(n), o.remove(), c = d ? c : e("<div></div>").append(e.parseHTML(c)).html(), t = this.get_node(t), this.set_text(t, c), (s = !!this.rename_node(t, d ? e("<div></div>").text(a).text() : e("<div></div>").append(e.parseHTML(a)).html())) || this.set_text(t, c), this._data.core.focused = u.id, setTimeout(function() {
                                                    var e = this.get_node(u.id, !0);
                                                    e.length && (this._data.core.focused = u.id, e.children(".jstree-anchor").trigger("focus"))
                                                }.bind(this), 0), r && r.call(this, u, s, g, a), h = null
                                            }.bind(this),
                                            keydown: function(e) {
                                                var t = e.which;
                                                27 === t && (g = !0, this.value = c), 27 !== t && 13 !== t && 37 !== t && 38 !== t && 39 !== t && 40 !== t && 32 !== t || e.stopImmediatePropagation(), 27 !== t && 13 !== t || (e.preventDefault(), this.blur())
                                            },
                                            click: function(e) {
                                        ...
                                        }, o.attr("class", n.attr("class")).append(n.contents().clone()).append(h), n.replaceWith(o), l.css(_), h.css(_).width(Math.min(l.text("pW" + h[0].value).width(), a))[0].select(), void e(d).one("mousedown.jstree touchstart.jstree dnd_start.vakata", (function(t) {
                                    ...
                                    set_theme: function(t, i) {
                                        ...
                                        i && -1 === e.inArray(i, n) && (e("head").append('<link rel="stylesheet" href="' + i + '" type="text/css" />'), n.push(i)), this._data.core.themes.name && this.element.removeClass("jstree-" + this._data.core.themes.name), this._data.core.themes.name = t, this.element.addClass("jstree-" + t), this.element[this.settings.core.themes.responsive ? "addClass" : "removeClass"]("jstree-" + t + "-responsive"), this.trigger("set_theme", {
                                            theme: t
                                        })
                                    },
                                    get_theme: function() {
                                    ...
                                    var i, r, s = [],
                                        a = {};
                                    for (i = 0, r = e.length; i < r; i++) a[e[i]] === t && (s.push(e[i]), a[e[i]] = !0);
                                    return s
                                    ...
                                    if ("function" != typeof e) throw new TypeError("Function.prototype.bind - what is trying to be bound is not callable");
                                    return function() {
                                ...
                                u.className = "jstree-icon jstree-checkbox", u.setAttribute("role", "presentation"), e.jstree.defaults.checkbox = {
                                        ...
                                        this.bind = function() {
                                            r.bind.call(this), this._data.checkbox.uto = !1, this._data.checkbox.selected = [], this.settings.checkbox.three_state && (this.settings.checkbox.cascade = "up+down+undetermined"), this.element.on("init.jstree", function() {
                                            ...
                                            }.bind(this)), -1 === this.settings.checkbox.cascade.indexOf("up") && -1 === this.settings.checkbox.cascade.indexOf("down") || this.element.on("model.jstree", function(t, i) {
                                                var r, s, a, n, o, d, c = this._model.data,
                                                    l = c[i.parent],
                                                    h = i.nodes,
                                                    _ = [],
                                                ...
                                                if (-1 !== u.indexOf("down"))
                                                    if (l.state[g ? "selected" : "checked"]) {
                                                        for (s = 0, a = h.length; s < a; s++) c[h[s]].state[g ? "selected" : "checked"] = !0;
                                                        ...
                                                        for (s = 0, a = h.length; s < a; s++)
                                                            if (c[h[s]].state[g ? "selected" : "checked"]) {
                                                                for (n = 0, o = c[h[s]].children_d.length; n < o; n++) c[c[h[s]].children_d[n]].state[g ? "selected" : "checked"] = !0;
                                                                this._data[g ? "core" : "checkbox"].selected = this._data[g ? "core" : "checkbox"].selected.concat(c[h[s]].children_d)
                                                            }
                                                if (-1 !== u.indexOf("up")) {
                                                    for (s = 0, a = l.children_d.length; s < a; s++) c[l.children_d[s]].children.length || _.push(c[l.children_d[s]].parent);
                                                    for (n = 0, o = (_ = e.vakata.array_unique(_)).length; n < o; n++)
                                                        for (l = c[_[n]]; l && l.id !== e.jstree.root;) {
                                                            for (r = 0, s = 0, a = l.children.length; s < a; s++) r += c[l.children[s]].state[g ? "selected" : "checked"];
                                                            if (r !== a) break;
                                                            l.state[g ? "selected" : "checked"] = !0, this._data[g ? "core" : "checkbox"].selected.push(l.id), (d = this.get_node(l, !0)) && d.length && d.children(".jstree-anchor").attr("aria-selected", !0).addClass(g ? "jstree-clicked" : "jstree-checked"), l = this.get_node(l.parent)
                                                        }
                                                }
                                                ...
                                                if (-1 !== l.indexOf("down")) {
                                                    ...
                                                    for (r = 0, s = f.length; r < s; r++) g.indexOf(f[r]) > -1 ? _[f[r]] = !0 : delete _[f[r]]
                                                }
                                                if (-1 !== l.indexOf("up"))
                                                    for (; c && c.id !== e.jstree.root;) {
                                                        for (a = 0, r = 0, s = c.children.length; r < s; r++) a += d[c.children[r]].state[h ? "selected" : "checked"];
                                                        if (a !== s) break;
                                                        c.state[h ? "selected" : "checked"] = !0, _[c.id] = !0, (n = this.get_node(c, !0)) && n.length && n.children(".jstree-anchor").attr("aria-selected", !0).addClass(h ? "jstree-clicked" : "jstree-checked"), c = this.get_node(c.parent)
                                                    }
                                                ...
                                                var r, s, a, n = this.get_node(e.jstree.root),
                                                    o = this._model.data;
                                                for (r = 0, s = n.children_d.length; r < s; r++)(a = o[n.children_d[r]]) && a.original && a.original.state && a.original.state.undetermined && (a.original.state.undetermined = !1)
                                                ...
                                                if (-1 !== o.indexOf("up") && -1 === c.indexOf(n.id)) {
                                                    for (r = 0, s = n.parents.length; r < s; r++)(a = this._model.data[n.parents[r]]).state[d ? "selected" : "checked"] = !1, a && a.original && a.original.state && a.original.state.undetermined && (a.original.state.undetermined = !1), (a = this.get_node(n.parents[r], !0)) && a.length && a.children(".jstree-anchor").attr("aria-selected", !1).removeClass(d ? "jstree-clicked" : "jstree-checked");
                                                    c = e.vakata.array_filter(c, (function(e) {
                                                        return -1 === n.parents.indexOf(e)
                                                    }))
                                                }
                                                this._data[d ? "core" : "checkbox"].selected = c
                                            }.bind(this)), -1 !== this.settings.checkbox.cascade.indexOf("up") && this.element.on("delete_node.jstree", function(t, i) {
                                                for (var r, s, a, n, o = this.get_node(i.parent), d = this._model.data, c = this.settings.checkbox.tie_selection; o && o.id !== e.jstree.root && !o.state[c ? "selected" : "checked"];) {
                                                    for (a = 0, r = 0, s = o.children.length; r < s; r++) a += d[o.children[r]].state[c ? "selected" : "checked"];
                                                    if (!(s > 0 && a === s)) break;
                                                    o.state[c ? "selected" : "checked"] = !0, this._data[c ? "core" : "checkbox"].selected.push(o.id), (n = this.get_node(o, !0)) && n.length && n.children(".jstree-anchor").attr("aria-selected", !0).addClass(c ? "jstree-clicked" : "jstree-checked"), o = this.get_node(o.parent)
                                                }
                                            }.bind(this)).on("move_node.jstree", function(t, i) {
                                                var r, s, a, n, o, d = i.is_multi,
                                                    c = i.old_parent,
                                                ...
                                                if (!d)
                                                    for (r = this.get_node(c); r && r.id !== e.jstree.root && !r.state[_ ? "selected" : "checked"];) {
                                                        for (s = 0, a = 0, n = r.children.length; a < n; a++) s += h[r.children[a]].state[_ ? "selected" : "checked"];
                                                        if (!(n > 0 && s === n)) break;
                                                        r.state[_ ? "selected" : "checked"] = !0, this._data[_ ? "core" : "checkbox"].selected.push(r.id), (o = this.get_node(r, !0)) && o.length && o.children(".jstree-anchor").attr("aria-selected", !0).addClass(_ ? "jstree-clicked" : "jstree-checked"), r = this.get_node(r.parent)
                                                    }
                                                for (r = l; r && r.id !== e.jstree.root;) {
                                                    for (s = 0, a = 0, n = r.children.length; a < n; a++) s += h[r.children[a]].state[_ ? "selected" : "checked"];
                                                    if (s === n) r.state[_ ? "selected" : "checked"] || (r.state[_ ? "selected" : "checked"] = !0, this._data[_ ? "core" : "checkbox"].selected.push(r.id), (o = this.get_node(r, !0)) && o.length && o.children(".jstree-anchor").attr("aria-selected", !0).addClass(_ ? "jstree-clicked" : "jstree-checked"));
                                                    else {
                                                        if (!r.state[_ ? "selected" : "checked"]) break;
                                                        r.state[_ ? "selected" : "checked"] = !1, this._data[_ ? "core" : "checkbox"].selected = e.vakata.array_remove_item(this._data[_ ? "core" : "checkbox"].selected, r.id), (o = this.get_node(r, !0)) && o.length && o.children(".jstree-anchor").attr("aria-selected", !1).removeClass(_ ? "jstree-clicked" : "jstree-checked")
                                                    }
                                            ...
                                            for (r = 0, s = l.length; r < s; r++)
                                                if (d[l[r]] && d[l[r]].parents)
                                                    for (a = 0, n = d[l[r]].parents.length; a < n && o[d[l[r]].parents[a]] === t; a++) d[l[r]].parents[a] !== e.jstree.root && (o[d[l[r]].parents[a]] = !0, h.push(d[l[r]].parents[a]));
                                                        ...
                                                        if (c.state.loaded) {
                                                            for (r = 0, s = c.children_d.length; r < s; r++)
                                                                if (!(i = d[c.children_d[r]]).state.loaded && i.original && i.original.state && i.original.state.undetermined && !0 === i.original.state.undetermined)
                                                                    for (o[i.id] === t && i.id !== e.jstree.root && (o[i.id] = !0, h.push(i.id)), a = 0, n = i.parents.length; a < n; a++) o[i.parents[a]] === t && i.parents[a] !== e.jstree.root && (o[i.parents[a]] = !0, h.push(i.parents[a]))
                                                        } else if (c.original && c.original.state && c.original.state.undetermined && !0 === c.original.state.undetermined)
                                                        for (o[c.id] === t && c.id !== e.jstree.root && (o[c.id] = !0, h.push(c.id)), a = 0, n = c.parents.length; a < n; a++) o[c.parents[a]] === t && c.parents[a] !== e.jstree.root && (o[c.parents[a]] = !0, h.push(c.parents[a]))
                                            ...
                                            if (e = r.redraw_node.apply(this, arguments)) {
                                                ...
                                                o && (!this.settings.checkbox.tie_selection && this._model.data[e.id].state.checked && (o.className += " jstree-checked"), d = u.cloneNode(!1), this._model.data[e.id].state.checkbox_disabled && (d.className += " jstree-checkbox-disabled"), o.insertBefore(d, o.childNodes[0]))
                                            }
                                            ...
                                            var i, r, s = this.settings.checkbox.cascade,
                                                ...
                                                o = this._model.data;
                                            if (!t || !0 === t.state[a ? "selected" : "checked"] || -1 === s.indexOf("undetermined") || -1 === s.indexOf("down") && -1 === s.indexOf("up")) return !1;
                                            if (!t.state.loaded && !0 === t.original.state.undetermined) return !0;
                                            for (i = 0, r = t.children_d.length; i < r; i++)
                                                if (-1 !== e.inArray(t.children_d[i], n) || !o[t.children_d[i]].state.loaded && o[t.children_d[i]].original.state.undetermined) return !0;
                                            return !1
                                            ...
                                            if (this.settings.checkbox.tie_selection || e.vakata.is_array(t)) return r.delete_node.call(this, t);
                                            var i, s, a, n = !1;
                                            if (!(t = this.get_node(t)) || t.id === e.jstree.root) return !1;
                                            for ((i = t.children_d.concat([])).push(t.id), s = 0, a = i.length; s < a; s++)
                                            ...
                                            if (!(t = this.get_node(t)) || t.id === e.jstree.root) return !1;
                                            a = this.get_node(t, !0), t.state.checked && (t.state.checked = !1, this._data.checkbox.selected = e.vakata.array_remove_item(this._data.checkbox.selected, t.id), a.length && a.children(".jstree-anchor").removeClass("jstree-checked"), this.trigger("uncheck_node", {
                                                node: t,
                                                selected: this._data.checkbox.selected,
                                                event: i
                                            }))
                                            ...
                                            var t, i;
                                            for (this._data.checkbox.selected.concat([]), this._data.checkbox.selected = this._model.data[e.jstree.root].children_d.concat(), t = 0, i = this._data.checkbox.selected.length; t < i; t++) this._model.data[this._data.checkbox.selected[t]] && (this._model.data[this._data.checkbox.selected[t]].state.checked = !0);
                                            ...
                                            var i, r, s, a, n = this.get_checked(!0),
                                                o = {};
                                            for (i = 0, r = n.length; i < r; i++) o[n[i].id] = n[i];
                                            for (i = 0, r = n.length; i < r; i++)
                                                for (s = 0, a = n[i].children_d.length; s < a; s++) o[n[i].children_d[s]] && delete o[n[i].children_d[s]];
                                            ...
                                            if (!e.vakata.is_array(t) && !this.settings.checkbox.tie_selection && (n = this.get_node(t)) && n.state.loaded)
                                                for (s = 0, a = n.children_d.length; s < a; s++) this._model.data[n.children_d[s]].state.checked && (this._data.checkbox.selected = e.vakata.array_remove_item(this._data.checkbox.selected, n.children_d[s]));
                                        ...
                                        this.bind = function() {
                                            ...
                                            this.element.on("init.jstree loading.jstree ready.jstree", function() {
                                                ...
                                                "input" !== e.target.tagName.toLowerCase() && (e.preventDefault(), s = e.ctrlKey ? +new Date : 0, (t || a) && (s = +new Date + 1e4), a && clearTimeout(a), this.is_loading(e.currentTarget) || this.show_contextmenu(e.currentTarget, e.pageX, e.pageY, e))
                                            }.bind(this)).on("click.jstree", ".jstree-anchor", function(t) {
                                                ...
                                                r.originalEvent && r.originalEvent.changedTouches && r.originalEvent.changedTouches[0] && (t = r.originalEvent.changedTouches[0].clientX, i = r.originalEvent.changedTouches[0].clientY, a = setTimeout((function() {
                                                    e(r.currentTarget).trigger("contextmenu", !0)
                                                }), 750))
                                            })).on("touchmove.vakata.jstree", (function(r) {
                                                a && r.originalEvent && r.originalEvent.changedTouches && r.originalEvent.changedTouches[0] && (Math.abs(t - r.originalEvent.changedTouches[0].clientX) > 10 || Math.abs(i - r.originalEvent.changedTouches[0].clientY) > 10) && (clearTimeout(a), e.vakata.context.hide())
                                            ...
                                            this._data.contextmenu.visible && e.vakata.context.hide(), e(d).off("context_hide.vakata.jstree"), r.teardown.call(this)
                                            ...
                                            var n = this.settings.contextmenu,
                                                ...
                                                d = !1,
                                                c = !1;
                                            (n.show_at_node || r === t || s === t) && (d = o.offset(), r = d.left, s = d.top + this._data.core.li_height), this.settings.contextmenu.select_node && !this.is_selected(i) && this.activate_node(i, a), c = n.items, e.vakata.is_function(c) && (c = c.call(this, i, function(e) {
                                                this._show_contextmenu(i, r, s, e)
                                            }.bind(this))), e.isPlainObject(c) && this._show_contextmenu(i, r, s, c)
                                            ...
                                            e(d).one("context_show.vakata.jstree", function(t, i) {
                                                ...
                                                e(i.element).addClass(r), a.addClass("jstree-context")
                                    ...
                                    function(e) {
                                        ...
                                        e.vakata.context = {
                                            ...
                                            _parse: function(t, r) {
                                                ...
                                                var s, a = "",
                                                    n = !1;
                                                return r && (a += "<ul>"), e.each(t, (function(t, r) {
                                                    if (!r) return !0;
                                                    i.items.push(r), !n && r.separator_before && (a += "<li class='vakata-context-separator'><a href='#' " + (e.vakata.context.settings.icons ? "" : 'class="vakata-context-no-icons"') + ">&#160;</a></li>"), n = !1, a += "<li class='" + (r._class || "") + (!0 === r._disabled || e.vakata.is_function(r._disabled) && r._disabled({
                                                        item: r,
                                                        reference: i.reference,
                                                        element: i.element
                                                    }) ? " vakata-contextmenu-disabled " : "") + "' " + (r.shortcut ? " data-shortcut='" + r.shortcut + "' " : "") + ">", a += "<a href='#' rel='" + (i.items.length - 1) + "' " + (r.title ? "title='" + r.title + "'" : "") + ">", e.vakata.context.settings.icons && (a += "<i ", r.icon && (-1 !== r.icon.indexOf("/") || -1 !== r.icon.indexOf(".") ? a += " style='background:url(\"" + r.icon + "\") center center no-repeat' " : a += " class='" + r.icon + "' "), a += "></i><span class='vakata-contextmenu-sep'>&#160;</span>"), a += (e.vakata.is_function(r.label) ? r.label({
                                                        item: t,
                                                        reference: i.reference,
                                                        element: i.element
                                                    }) : r.label) + (r.shortcut ? ' <span class="vakata-contextmenu-shortcut vakata-contextmenu-shortcut-' + r.shortcut + '">' + (r.shortcut_label || "") + "</span>" : "") + "</a>", r.submenu && (s = e.vakata.context._parse(r.submenu, !0)) && (a += s), a += "</li>", r.separator_after && (a += "<li class='vakata-context-separator'><a href='#' " + (e.vakata.context.settings.icons ? "" : 'class="vakata-context-no-icons"') + ">&#160;</a></li>", n = !0)
                                                })), a = a.replace(/<li class\='vakata-context-separator'\><\/li\>$/, ""), r && (a += "</ul>"), r || (i.html = a, e.vakata.context._trigger("parse")), a.length > 10 && a
                                            },
                                            _show_submenu: function(i) {
                                                if ((i = e(i)).length && i.children("ul").length) {
                                                    ...
                                                    t ? i[a - (o + 10 + i.outerWidth()) < 0 ? "addClass" : "removeClass"]("vakata-context-left") : i[a + o > c && s > c - a ? "addClass" : "removeClass"]("vakata-context-right"), n + d + 10 > l && r.css("bottom", "-1px"), i.hasClass("vakata-context-right") ? s < o && r.css("margin-right", s - o) : c - a < o && r.css("margin-left", c - a - o), r.show()
                                                }
                                            },
                                            show: function(r, s, a) {
                                                var n, o, c, l, h, _, u, g;
                                                ...
                                                r && !a && e(r).data("vakata_contextmenu") && (a = e(r).data("vakata_contextmenu")), e.vakata.context._parse(a) && i.element.html(i.html), i.items.length && (i.element.appendTo(d.body), o = i.element, c = i.position_x, l = i.position_y, h = o.width(), _ = o.height(), u = e(window).width() + e(window).scrollLeft(), g = e(window).height() + e(window).scrollTop(), t && (c -= o.outerWidth() - e(r).outerWidth()) < e(window).scrollLeft() + 20 && (c = e(window).scrollLeft() + 20), c + h + 20 > u && (c = u - (h + 20)), l + _ + 20 > g && (l = g - (_ + 20)), i.element.css({
                                                    left: c,
                                                    top: l
                                                }).show().find("a").first().trigger("focus").parent().addClass("vakata-context-hover"), i.is_visible = !0, e.vakata.context._trigger("show"))
                                            },
                                            hide: function() {
                                                i.is_visible && (i.element.hide().find("ul").hide().end().find(":focus").trigger("blur").end().detach(), i.is_visible = !1, e.vakata.context._trigger("hide"))
                                            }
                                        }, e((function() {
                                            ...
                                            i.element = e("<ul class='vakata-context'></ul>"), i.element.on("mouseenter", "li", (function(t) {
                                                ...
                                                t.preventDefault(), e(this).trigger("blur").parent().hasClass("vakata-context-disabled") || !1 === e.vakata.context._execute(e(this).attr("rel")) || e.vakata.context.hide()
                                                ...
                                                switch (t.which) {
                                                    ...
                                                    case 32:
                                                        ...
                                                        break;
                                                    case 37:
                                                        i.is_visible && (i.element.find(".vakata-context-hover").last().closest("li").first().find("ul").hide().find(".vakata-context-hover").removeClass("vakata-context-hover").end().end().children("a").trigger("focus"), t.stopImmediatePropagation(), t.preventDefault());
                                                        break;
                                                    case 38:
                                                        i.is_visible && ((r = i.element.find("ul:visible").addBack().last().children(".vakata-context-hover").removeClass("vakata-context-hover").prevAll("li:not(.vakata-context-separator)").first()).length || (r = i.element.find("ul:visible").addBack().last().children("li:not(.vakata-context-separator)").last()), r.addClass("vakata-context-hover").children("a").trigger("focus"), t.stopImmediatePropagation(), t.preventDefault());
                                                        break;
                                                    case 39:
                                                        i.is_visible && (i.element.find(".vakata-context-hover").last().children("ul").show().children("li:not(.vakata-context-separator)").removeClass("vakata-context-hover").first().addClass("vakata-context-hover").children("a").trigger("focus"), t.stopImmediatePropagation(), t.preventDefault());
                                                        break;
                                                    case 40:
                                        ...
                                        this.init = function(e, t) {
                                            ...
                                            i.bind.call(this), this.element.on(this.settings.dnd.use_html5 ? "dragstart.jstree" : "mousedown.jstree touchstart.jstree", this.settings.dnd.large_drag_target ? ".jstree-node" : ".jstree-anchor", function(t) {
                                                ...
                                                if (this.settings.core.force_text && (s = e.vakata.html.escape(s)), i && (i.id || 0 === i.id) && i.id !== e.jstree.root && (1 === t.which || "touchstart" === t.type || "dragstart" === t.type) && (!0 === this.settings.dnd.is_draggable || e.vakata.is_function(this.settings.dnd.is_draggable) && this.settings.dnd.is_draggable.call(this, r > 1 ? this.get_top_selected(!0) : [i], t))) {
                                                    if (h = {
                                                            jstree: !0,
                                                            origin: this,
                                                            obj: this.get_node(i, !0),
                                                            nodes: r > 1 ? this.get_top_selected() : [i.id]
                                                        }, _ = t.currentTarget, !this.settings.dnd.use_html5) return this.element.trigger("mousedown.jstree"), e.vakata.dnd.start(t, h, '<div id="jstree-dnd" class="jstree-' + this.get_theme() + " jstree-" + this.get_theme() + "-" + this.get_theme_variant() + " " + (this.settings.core.themes.responsive ? " jstree-dnd-responsive" : "") + '"><i class="jstree-icon jstree-er"></i>' + s + '<ins class="jstree-copy">+</ins></div>');
                                        ...
                                        e(d).on("dragover.vakata.jstree", (function(t) {
                                            ...
                                            if (a && (d.event && "dragover" === d.event.type && !c || clearTimeout(a)), d && d.data && d.data.jstree && (!d.event.target.id || "jstree-marker" !== d.event.target.id)) {
                                                s = d.event;
                                                var l, h, _, u, g, f, p, m, v, j, k, b, y, x, w, C, T, N = e.jstree.reference(d.event.target),
                                                    O = !1,
                                                    A = !1,
                                                    S = !1;
                                                if (N && N._data && N._data.dnd)
                                                    if (n.attr("class", "jstree-" + N.get_theme() + (N.settings.core.themes.responsive ? " jstree-dnd-responsive" : "")), w = d.data.origin && (d.data.origin.settings.dnd.always_copy || d.data.origin.settings.dnd.copy && (d.event.metaKey || d.event.ctrlKey)), d.helper.children().attr("class", "jstree-" + N.get_theme() + " jstree-" + N.get_theme() + "-" + N.get_theme_variant() + " " + (N.settings.core.themes.responsive ? " jstree-dnd-responsive" : "")).find(".jstree-copy").first()[w ? "show" : "hide"](), d.event.target !== N.element[0] && d.event.target !== N.get_container_ul()[0] || 0 !== N.get_container_ul().children().length && !N.settings.dnd.blank_space_drop) {
                                                        if ((O = N.settings.dnd.large_drop_target ? e(d.event.target).closest(".jstree-node").children(".jstree-anchor") : e(d.event.target).closest(".jstree-anchor")) && O.length && O.parent().is(".jstree-closed, .jstree-open, .jstree-leaf") && (A = O.offset(), S = (d.event.pageY !== t ? d.event.pageY : d.event.originalEvent.pageY) - A.top, _ = O.outerHeight(), f = S < _ / 3 ? ["b", "i", "a"] : S > _ - _ / 3 ? ["a", "i", "b"] : S > _ / 2 ? ["i", "a", "b"] : ["i", "b", "a"], e.each(f, (function(t, s) {
                                                                switch (s) {
                                                                    case "b":
                                                                        l = A.left - 6, h = A.top, u = N.get_parent(O), g = O.parent().index(), T = "jstree-below";
                                                                        break;
                                                                    case "i":
                                                                        y = N.settings.dnd.inside_pos, x = N.get_node(O.parent()), l = A.left - 2, h = A.top + _ / 2 + 1, u = x.id, g = "first" === y ? 0 : "last" === y ? x.children.length : Math.min(y, x.children.length), T = "jstree-inside";
                                                                        break;
                                                                    case "a":
                                                                        l = A.left - 6, h = A.top + _, u = N.get_parent(O), g = O.parent().index() + 1, T = "jstree-above"
                                                                }
                                                                for (p = !0, m = 0, v = d.data.nodes.length; m < v; m++)
                                                                    if (j = d.data.origin && (d.data.origin.settings.dnd.always_copy || d.data.origin.settings.dnd.copy && (d.event.metaKey || d.event.ctrlKey)) ? "copy_node" : "move_node", k = g, "move_node" === j && "a" === s && d.data.origin && d.data.origin === N && u === N.get_parent(d.data.nodes[m]) && (b = N.get_node(u), k > e.inArray(d.data.nodes[m], b.children) && (k -= 1)), !(p = p && (N && N.settings && N.settings.dnd && !1 === N.settings.dnd.check_while_dragging || N.check(j, d.data.origin && d.data.origin !== N ? d.data.origin.get_node(d.data.nodes[m]) : d.data.nodes[m], u, k, {
                                                                            dnd: !0,
                                                                ...
                                                                var o, S;
                                                                if ("i" === s && O.parent().is(".jstree-closed") && N.settings.dnd.open_timeout && (d.event && "dragover" === d.event.type && !c || (a && clearTimeout(a), a = setTimeout((o = N, S = O, function() {
                                                                        o.open_node(S)
                                                                    }), N.settings.dnd.open_timeout))), p) return (C = N.get_node(u, !0)).hasClass(".jstree-dnd-parent") || (e(".jstree-dnd-parent").removeClass("jstree-dnd-parent"), C.addClass("jstree-dnd-parent")), i = {
                                                                    ins: N,
                                                                    par: u,
                                                                    ...
                                                                    left: l + "px",
                                                                    top: h + "px"
                                                                }).show(), n.removeClass("jstree-above jstree-inside jstree-below").addClass(T), d.helper.find(".jstree-icon").first().removeClass("jstree-er").addClass("jstree-ok"), d.event.originalEvent && d.event.originalEvent.dataTransfer && (d.event.originalEvent.dataTransfer.dropEffect = w ? "copy" : "move"), r = {}, f = !0, !1
                                                            })), !0 === f)) return
                                                    } else {
                                                        for (p = !0, m = 0, v = d.data.nodes.length; m < v && (p = p && N.check(d.data.origin && (d.data.origin.settings.dnd.always_copy || d.data.origin.settings.dnd.copy && (d.event.metaKey || d.event.ctrlKey)) ? "copy_node" : "move_node", d.data.origin && d.data.origin !== N ? d.data.origin.get_node(d.data.nodes[m]) : d.data.nodes[m], e.jstree.root, "last", {
                                                                dnd: !0,
                                                        ...
                                                        if (p) return i = {
                                                            ...
                                                            par: e.jstree.root,
                                                            pos: "last"
                                                        }, n.hide(), d.helper.find(".jstree-icon").first().removeClass("jstree-er").addClass("jstree-ok"), void(d.event.originalEvent && d.event.originalEvent.dataTransfer && (d.event.originalEvent.dataTransfer.dropEffect = w ? "copy" : "move"))
                                                    }
                                                e(".jstree-dnd-parent").removeClass("jstree-dnd-parent"), i = !1, d.helper.find(".jstree-icon").removeClass("jstree-ok").addClass("jstree-er"), d.event.originalEvent && d.event.originalEvent.dataTransfer, n.hide()
                                            }
                                            ...
                                            (o = e.vakata.dnd._get()) && o.data && o.data.jstree && ("keyup" === t.type && 27 === t.which ? (a && clearTimeout(a), i = !1, r = !1, s = !1, a = !1, n.hide().detach(), e.vakata.dnd._clean()) : (o.helper.find(".jstree-copy").first()[o.data.origin && (o.data.origin.settings.dnd.always_copy || o.data.origin.settings.dnd.copy && (t.metaKey || t.ctrlKey)) ? "show" : "hide"](), s && (s.metaKey = t.metaKey, s.ctrlKey = t.ctrlKey, e.vakata.dnd._trigger("move", s))))
                                        }))
                                    })),
                                    function(e) {
                                        e.vakata.html = {
                                        ...
                                        this.init = function(e, t) {
                                            ...
                                            var n, o, d, c = this.settings.massload,
                                                l = [],
                                                h = this._model.data;
                                            if (!s) {
                                                for (n = 0, o = t.length; n < o; n++) h[t[n]] && (h[t[n]].state.loaded || h[t[n]].state.failed) && !a || (l.push(t[n]), (d = this.get_node(t[n], !0)) && d.length && d.addClass("jstree-loading").attr("aria-busy", !0));
                                                if (this._data.massload = {}, l.length) {
                                                    if (e.vakata.is_function(c)) return c.call(this, l, function(e) {
                                                        var n, o;
                                                        if (e)
                                                            for (n in e) e.hasOwnProperty(n) && (this._data.massload[n] = e[n]);
                                                        for (n = 0, o = t.length; n < o; n++)(d = this.get_node(t[n], !0)) && d.length && d.removeClass("jstree-loading").attr("aria-busy", !1);
                                                        i._load_nodes.call(this, t, r, s, a)
                                                    }.bind(this));
                                                    if ("object" == typeof c && c && c.url) return c = e.extend(!0, {}, c), e.vakata.is_function(c.url) && (c.url = c.url.call(this, l)), e.vakata.is_function(c.data) && (c.data = c.data.call(this, l)), e.ajax(c).done(function(e, n, o) {
                                                        var c, l;
                                                        if (e)
                                            ...
                                            var s, a = this._data.massload[t.id],
                                                n = null;
                                            return a ? (n = this["string" == typeof a ? "_append_html_data" : "_append_json_data"](t, "string" == typeof a ? e(e.parseHTML(a)).filter((function() {
                                                ...
                                                r.call(this, e)
                                            })), (s = this.get_node(t.id, !0)) && s.length && s.removeClass("jstree-loading").attr("aria-busy", !1), delete this._data.massload[t.id], n) : i._load_node.call(this, t, r)
                                        }
                                        ...
                                        this.bind = function() {
                                            r.bind.call(this), this._data.search.str = "", this._data.search.dom = e(), this._data.search.res = [], this._data.search.opn = [], this._data.search.som = !1, this._data.search.smc = !1, this._data.search.hdn = [], this.element.on("search.jstree", function(t, i) {
                                                if (this._data.search.som && i.res.length) {
                                                    var r, s, a, n, o = this._model.data,
                                                        d = [];
                                                    for (r = 0, s = i.res.length; r < s; r++)
                                                        if (o[i.res[r]] && !o[i.res[r]].state.hidden && (d.push(i.res[r]), d = d.concat(o[i.res[r]].parents), this._data.search.smc))
                                                            for (a = 0, n = o[i.res[r]].children_d.length; a < n; a++) o[o[i.res[r]].children_d[a]] && !o[o[i.res[r]].children_d[a]].state.hidden && d.push(o[i.res[r]].children_d[a]);
                                            ...
                                            a = (a = this.get_node(a)) && (a.id || 0 === a.id) ? a.id : null, i = i.toString();
                                            var d, c, l = this.settings.search,
                                                ...
                                                g = [],
                                                f = [];
                                            if (this._data.search.res.length && !n && this.clear_search(), s === t && (s = l.show_only_matches), o === t && (o = l.show_only_matches_children), !r && !1 !== h) return e.vakata.is_function(h) ? h.call(this, i, function(t) {
                                                t && t.d && (t = t.d), this._load_nodes(e.vakata.is_array(t) ? e.vakata.array_unique(t) : [], (function() {
                                                    this.search(i, !0, s, a, n, o)
                                                }))
                                            }.bind(this), a) : ((h = e.extend({}, h)).data || (h.data = {}), h.data.str = i, a && (h.data.inside = a), this._data.search.lastRequest && this._data.search.lastRequest.abort(), this._data.search.lastRequest = e.ajax(h).fail(function() {
                                                this._data.core.last_error = {
                                                    error: "ajax",
                                                    plugin: "search",
                                                    id: "search_01",
                                            ...
                                            if (n || (this._data.search.str = i, this._data.search.dom = e(), this._data.search.res = [], this._data.search.opn = [], this._data.search.som = s, this._data.search.smc = o), u = new e.vakata.search(i, !0, {
                                                    caseSensitive: l.case_sensitive,
                                                    fuzzy: l.fuzzy
                                                }), e.each(_[a || e.jstree.root].children_d, (function(e, t) {
                                                    var r = _[t];
                                                    r.text && !r.state.hidden && (!l.search_leaves_only || r.state.loaded && 0 === r.children.length) && (l.search_callback && l.search_callback.call(this, i, r) || !l.search_callback && u.search(r.text).isMatch) && (g.push(t), f = f.concat(r.parents))
                                                })), g.length) {
                                                for (d = 0, c = (f = e.vakata.array_unique(f)).length; d < c; d++) f[d] !== e.jstree.root && _[f[d]] && !0 === this.open_node(f[d], null, 0) && this._data.search.opn.push(f[d]);
                                    ...
                                    function(e) {
                                        e.vakata.search = function(t, i, r) {
                                            ...
                                            var s, a, n, o, d = r.location,
                                                c = r.distance,
                                                l = r.threshold,
                                                h = t.length;
                                            return h > 32 && (r.fuzzy = !1), r.fuzzy && (s = 1 << h - 1, a = function() {
                                                var e = {},
                                                    i = 0;
                                                ...
                                                if (e = r.caseSensitive ? e.toString() : e.toString().toLowerCase(), t === e || -1 !== e.indexOf(t)) return {
                                                    isMatch: !0,
                                                    score: 0
                                                };
                                                if (!r.fuzzy) return {
                                                ...
                                                var i, o, c, _, u, g, f, p, m, v = e.length,
                                                    j = l,
                                                    k = e.indexOf(t, d),
                                                    b = h + v,
                                                    y = 1,
                                                    x = [];
                                                for (-1 !== k && (j = Math.min(n(0, k), j), -1 !== (k = e.lastIndexOf(t, d + h)) && (j = Math.min(n(0, k), j))), k = -1, i = 0; i < h; i++) {
                                                    for (c = 0, _ = b; c < _;) n(i, d + _) <= j ? c = _ : b = _, _ = Math.floor((b - c) / 2 + c);
                                                    for (b = _, g = Math.max(1, d - _ + 1), f = Math.min(d + _, v) + h, (p = new Array(f + 2))[f + 1] = (1 << i) - 1, o = f; o >= g; o--)
                                                        if (m = a[e.charAt(o - 1)], p[o] = 0 === i ? (p[o + 1] << 1 | 1) & m : (p[o + 1] << 1 | 1) & m | (u[o + 1] | u[o]) << 1 | 1 | u[o + 1], p[o] & s && (y = n(i, o - 1)) <= j) {
                                                            if (j = y, k = o - 1, x.push(k), !(k > d)) break;
                                                            g = Math.max(1, 2 * d - k)
                                                        }
                                                    if (n(i + 1, d) > j) break;
                                                    u = p
                                ...
                                e.jstree.defaults.state = {
                                        ...
                                        this.bind = function() {
                                            ...
                                            this.element.on("ready.jstree", function(t, i) {
                                                this.element.one("restore_state.jstree", e), this.restore_state() || e()
                                            }.bind(this))
                                            ...
                                            return !(t && t.ttl && t.sec && +new Date - t.sec > t.ttl || (t && t.state && (t = t.state), t && e.vakata.is_function(this.settings.state.filter) && (t = this.settings.state.filter.call(this, t)), !t || (this.settings.state.preserve_loaded || delete t.core.loaded, this.element.one("set_state.jstree", (function(i, r) {
                                    ...
                                    function(e, t) {
                                        ...
                                        this.init = function(i, s) {
                                            ...
                                            }.bind(this)), r.bind.call(this)
                                        }, this.get_json = function(t, i, s) {
                                            var a, n, o = this._model.data,
                                                d = i ? e.extend(!0, {}, i, {
                                                    no_id: !1
                                                }) : {},
                                            ...
                                            if (e.vakata.is_array(c))
                                                for (a = 0, n = c.length; a < n; a++) c[a].type = (c[a].id || 0 === c[a].id) && o[c[a].id] && o[c[a].id].type ? o[c[a].id].type : "default", i && i.no_id && (delete c[a].id, c[a].li_attr && c[a].li_attr.id && delete c[a].li_attr.id, c[a].a_attr && c[a].a_attr.id && delete c[a].a_attr.id);
                                            else c.type = (c.id || 0 === c.id) && o[c.id] && o[c.id].type ? o[c.id].type : "default", i && i.no_id && (c = this._delete_ids(c));
                                            return c
                                            ...
                                            return delete t.id, t.li_attr && t.li_attr.id && delete t.li_attr.id, t.a_attr && t.a_attr.id && delete t.a_attr.id, t.children && e.vakata.is_array(t.children) && (t.children = this._delete_ids(t.children)), t
                                        }, this.check = function(i, s, a, n, o) {
                                            if (!1 === r.check.call(this, i, s, a, n, o)) return !1;
                                            s = s && (s.id || 0 === s.id) ? s : this.get_node(s), a = a && (a.id || 0 === a.id) ? a : this.get_node(a);
                                            ...
                                            switch (_ = _ && _._model && _._model.data ? _._model.data : null, i) {
                                                ...
                                                case "copy_node":
                                                    if ("move_node" !== i || -1 === e.inArray(s.id, a.children)) {
                                                        if ((d = this.get_rules(a)).max_children !== t && -1 !== d.max_children && d.max_children === a.children.length) return this._data.core.last_error = {
                                                            error: "check",
                                                            plugin: "types",
                                                            id: "types_01",
                                            ...
                                            if (e.vakata.is_array(i)) {
                                                for (a = 0, n = (i = i.slice()).length; a < n; a++) this.set_type(i[a], r);
                                                return !0
                                            }
                                        ...
                                        this.check = function(t, i, s, a, n) {
                                            ...
                                            if (i = i && (i.id || 0 === i.id) ? i : this.get_node(i), !(s = s && (s.id || 0 === s.id) ? s : this.get_node(s)) || !s.children) return !0;
                                            var o, d, c, l = "rename_node" === t ? a : i.text,
                                                h = [],
                                                _ = this.settings.unique.case_sensitive,
                                                u = this.settings.unique.trim_whitespace,
                                                g = this._model.data;
                                            for (o = 0, d = s.children.length; o < d; o++) c = g[s.children[o]].text, _ || (c = c.toLowerCase()), u && (c = c.replace(/^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g, "")), h.push(c);
                                            ...
                                            if (!s || "object" == typeof s && s.text === t) {
                                                ...
                                                s || (s = {});
                                                var d, c, l, h, _, u, g = this._model.data,
                                                    f = this.settings.unique.case_sensitive,
                                                    p = this.settings.unique.trim_whitespace,
                                                    m = this.settings.unique.duplicate;
                                                for (c = d = this.get_string("New node"), l = [], h = 0, _ = i.children.length; h < _; h++) u = g[i.children[h]].text, f || (u = u.toLowerCase()), p && (u = u.replace(/^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g, "")), l.push(u);
                                                for (h = 1, u = c, f || (u = u.toLowerCase()), p && (u = u.replace(/^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g, "")); - 1 !== e.inArray(u, l);) u = c = m.call(this, d, ++h).toString(), f || (u = u.toLowerCase()), p && (u = u.replace(/^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g, ""));
                                                s.text = c
                                            }
                                ...
                                if (f.setAttribute("unselectable", "on"), f.setAttribute("role", "presentation"), f.className = "jstree-wholerow", f.innerHTML = "&#160;", e.jstree.plugins.wholerow = function(t, i) {
                                        this.bind = function() {
                                            i.bind.call(this), this.element.on("ready.jstree set_state.jstree", function() {
                                                this.hide_dots()
                                            ...
                                            if (t = i.redraw_node.apply(this, arguments)) {
                                                var n = f.cloneNode(!0); - 1 !== e.inArray(t.id, this._data.core.selected) && (n.className += " jstree-wholerow-clicked"), this._data.core.focused && this._data.core.focused === t.id && (n.className += " jstree-wholerow-hovered"), t.insertBefore(n, t.childNodes[0])
                                            }
                                            return t
                                        }
