                    ...
                    "object" == typeof navigator && (e.exports = function() {
                        ...
                        var g = function() {
                            function e(t, i) {
                                ...
                                })(this, e), p.element(t) ? this.element = t : p.string(t) && (this.element = document.querySelector(t)), p.element(this.element) && p.empty(this.element.rangeTouch) && (this.config = a({}, l, {}, i), this.init())
                            }
                            return function(e, i, s) {
                                ...
                                value: function(t) {
                                    ...
                                    return 0 > (i = 100 / o.width * (n.clientX - o.left)) ? i = 0 : 100 < i && (i = 100), 50 > i ? i -= (100 - 2 * i) * c : 50 < i && (i += 2 * (i - 50) * c), a + function(e, t) {
                                        if (1 > t) {
                                            var i = function(e) {
                        ...
                        function _(e) {
                            S.nodeList(e) || S.array(e) ? Array.from(e).forEach(_) : S.element(e) && S.element(e.parentNode) && e.parentNode.removeChild(e)
                        }
                        ...
                        const de = {
                            ...
                            cancelRequests() {
                                this.isHTML5 && (_(de.getSources.call(this)), this.media.setAttribute("src", this.config.blankVideo), this.media.load(), this.debug.log("Cancelled network requests"))
                            }
                        };
                        ...
                        const ye = {
                            ...
                            be = {
                                get(e = "", t = {}) {
                                    ...
                                    let i = x(t.i18n, e);
                                    if (S.empty(i)) return Object.keys(ye).includes(e) ? ye[e] : "";
                                    const s = {
                                        "{seektime}": t.seekTime,
                                        "{title}": t.title
                                    };
                        ...
                        const ke = e => Math.trunc(e / 60 / 60 % 60, 10);

                        function Ce(e = 0, t = !1, i = !1) {
                            if (!S.number(e)) return Ce(void 0, t, i);
                        ...
                        const Ae = {
                            ...
                            createButton(e, t) {
                                ...
                                const a = $(n.element);
                                return n.toggle ? (a.appendChild(Ae.createIcon.call(this, n.iconPressed, {
                                    class: "icon--pressed"
                                })), a.appendChild(Ae.createIcon.call(this, n.icon, {
                                    class: "icon--not-pressed"
                                })), a.appendChild(Ae.createLabel.call(this, n.labelPressed, {
                                    class: "label--pressed"
                                })), a.appendChild(Ae.createLabel.call(this, n.label, {
                                    class: "label--not-pressed"
                                }))) : (a.appendChild(Ae.createIcon.call(this, n.icon)), a.appendChild(Ae.createLabel.call(this, n.label))), N(i, D(this.config.selectors.buttons[s], i)), I(a, i), "play" === s ? (S.array(this.elements.buttons[s]) || (this.elements.buttons[s] = []), this.elements.buttons[s].push(a)) : this.elements.buttons[s] = a, a
                            },
                            createRange(e, t) {
                                const i = $("input", N(D(this.config.selectors.inputs[e]), {
                                    type: "range",
                                    min: 0,
                                    max: 100,
                                    step: .01,
                                    ...
                                    autocomplete: "off",
                                    role: "slider",
                                    "aria-label": be.get(e, this.config),
                                    "aria-valuemin": 0,
                                    "aria-valuemax": 100,
                                    "aria-valuenow": 0
                                }, t));
                                return this.elements.inputs[e] = i, Ae.updateRangeFill.call(this, i), g.setup(i), i
                            },
                            createProgress(e, t) {
                                const i = $("progress", N(D(this.config.selectors.display[e]), {
                                    min: 0,
                                    max: 100,
                                    value: 0,
                                    role: "progressbar",
                            ...
                            bindMenuItemShortcuts(e, t) {
                                X.call(this, e, "keydown keyup", (i => {
                                    ...
                                    if (!s && [" ", "ArrowRight"].includes(i.key)) Ae.showMenuPanel.call(this, t, !0);
                                    else {
                                        let t;
                                    ...
                                    "Return" === e.key && Ae.focusFirstMenuItem.call(this, null, !0)
                                }))
                            },
                            createMenuItem({
                                value: e,
                                ...
                                o.innerHTML = s, S.element(n) && o.appendChild(n), r.appendChild(o), Object.defineProperty(r, "checked", {
                                    ...
                                    if (!S.keyboardEvent(t) || " " === t.key) {
                                        ...
                                        Ae.showMenuPanel.call(this, "home", S.keyboardEvent(t))
                                    }
                                }), i, !1), Ae.bindMenuItemShortcuts.call(this, r, i), t.appendChild(r)
                            },
                            formatTime(e = 0, t = !1) {
                                return S.number(e) ? Ce(e, ke(this.duration) > 0, t) : e
                            },
                            updateTimeDisplay(e = null, t = 0, i = !1) {
                                S.element(e) && S.number(t) && (e.innerText = Ae.formatTime(t, i))
                            },
                            updateVolume() {
                                this.supported.ui && (S.element(this.elements.inputs.volume) && Ae.setRange.call(this, this.elements.inputs.volume, this.muted ? 0 : this.volume), S.element(this.elements.buttons.mute) && (this.elements.buttons.mute.pressed = this.muted || 0 === this.volume))
                            },
                            setRange(e, t = 0) {
                                S.element(e) && (e.value = t, Ae.updateRangeFill.call(this, e))
                            },
                            updateProgress(e) {
                                ...
                                if (e) switch (e.type) {
                                    ...
                                    case "seeking":
                                    case "seeked":
                                        s = this.currentTime, n = this.duration, t = 0 === s || 0 === n || Number.isNaN(s) || Number.isNaN(n) ? 0 : (s / n * 100).toFixed(2), "timeupdate" === e.type && Ae.setRange.call(this, this.elements.inputs.seek, t);
                                        break;
                                    case "playing":
                                    case "progress":
                                ...
                                if (S.element(t) && "range" === t.getAttribute("type")) {
                                    if (V(t, this.config.selectors.inputs.seek)) {
                                        ...
                                        const e = Ae.formatTime(this.currentTime),
                                            ...
                                            s = be.get("seekLabel", this.config);
                            ...
                            durationUpdate() {
                                ...
                                !e && this.config.displayDuration && this.paused && Ae.updateTimeDisplay.call(this, this.elements.display.currentTime, this.duration), e && Ae.updateTimeDisplay.call(this, this.elements.display.duration, this.duration), this.config.markers.enabled && Ae.setMarkers.call(this), Ae.updateSeekTooltip.call(this)
                            },
                            ...
                            updateSetting(e, t, i) {
                                ...
                                this.elements.settings.buttons[e].querySelector(`.${this.config.classNames.menu.value}`).innerHTML = Ae.getLabel.call(this, e, n);
                            ...
                            getLabel(e, t) {
                                switch (e) {
                                    case "speed":
                                        return 1 === t ? be.get("normal", this.config) : `${t}&times;`;
                                    case "quality":
                                        if (S.number(t)) {
                                            const e = be.get(`qualityLabel.${t}`, this.config);
                            ...
                            setQualityMenu(e) {
                                ...
                                if (Ae.toggleMenuButton.call(this, t, s), j(i), Ae.checkMenu.call(this), !s) return;
                                const n = e => {
                                    const t = be.get(`qualityBadge.${e}`, this.config);
                                ...
                                })), Ae.updateSetting.call(this, t, i)
                            },
                            setCaptionsMenu() {
                                if (!S.element(this.elements.settings.panels.captions)) return;
                                const e = "captions",
                                    t = this.elements.settings.panels.captions.querySelector('[role="menu"]'),
                                    i = Pe.getTracks.call(this),
                                    s = Boolean(i.length);
                                if (Ae.toggleMenuButton.call(this, e, s), j(t), Ae.checkMenu.call(this), !s) return;
                                const n = i.map(((e, i) => ({
                                    value: i,
                                    checked: this.captions.toggled && this.currentTrack === i,
                                    title: Pe.getLabel.call(this, e),
                                    badge: e.language && Ae.createBadge.call(this, e.language.toUpperCase()),
                                    list: t,
                                    type: "language"
                                })));
                                n.unshift({
                                    ...
                                    title: be.get("disabled", this.config),
                                    list: t,
                                    type: "language"
                                }), n.forEach(Ae.createMenuItem.bind(this)), Ae.updateSetting.call(this, e, t)
                            },
                            setSpeedMenu() {
                                ...
                                Ae.toggleMenuButton.call(this, e, i), j(t), Ae.checkMenu.call(this), i && (this.options.speed.forEach((i => {
                                    Ae.createMenuItem.call(this, {
                                        value: i,
                                        list: t,
                                        type: e,
                                        title: Ae.getLabel.call(this, "speed", i)
                                    })
                            ...
                            toggleMenu(e) {
                                ...
                                i.setAttribute("aria-expanded", n), H(t, !n), R(this.elements.container, this.config.classNames.menu.open, n), n && S.keyboardEvent(e) ? Ae.focusFirstMenuItem.call(this, null, !0) : n || s || W.call(this, i, S.keyboardEvent(e))
                            },
                            getMenuSize(e) {
                            ...
                            showMenuPanel(e = "", t = !1) {
                                ...
                                if (K.transitions && !K.reducedMotion) {
                                    ...
                                    const e = Ae.getMenuSize.call(this, i),
                                        t = e => {
                                ...
                                H(n, !0), H(i, !1), Ae.focusFirstMenuItem.call(this, i, t)
                            },
                            setDownloadUrl() {
                            ...
                            create(e) {
                                ...
                                return se(S.array(this.config.controls) ? this.config.controls : []).forEach((l => {
                                    ...
                                    if ("current-time" === l && c.appendChild(a.call(this, "currentTime", u)), "duration" === l && c.appendChild(a.call(this, "duration", u)), "mute" === l || "volume" === l) {
                                        ...
                                        if (S.element(t) && c.contains(t) || (t = $("div", N({}, u, {
                                    ...
                                    if ("captions" === l && c.appendChild(i.call(this, "captions", u)), "settings" === l && !S.empty(this.config.settings)) {
                                        ...
                                        l.appendChild(r), a.appendChild(l), this.elements.settings.panels.home = l, this.config.settings.forEach((i => {
                                            const s = $("button", N(D(this.config.selectors.buttons.settings), {
                                                type: "button",
                                            ...
                                            const n = $("span", null, be.get(i, this.config)),
                                                l = $("span", {
                                                    class: this.config.classNames.menu.value
                                                });
                                            ...
                                            u.appendChild($("span", {
                                                "aria-hidden": !0
                                            }, be.get(i, this.config))), u.appendChild($("span", {
                                                class: this.config.classNames.hidden
                                            }, be.get("menuBack", this.config))), X.call(this, c, "keydown", (e => {
                            ...
                            inject() {
                                ...
                                let i, s = !0;
                                if (S.function(this.config.controls) && (this.config.controls = this.config.controls.call(this, t)), this.config.controls || (this.config.controls = []), S.element(this.config.controls) || S.string(this.config.controls) ? e = this.config.controls : (e = Ae.create.call(this, {
                                        id: this.id,
                                        seektime: this.config.seekTime,
                                        speed: this.speed,
                                        quality: this.quality,
                                        captions: Pe.getLabel.call(this)
                                    }), s = !1), s && S.string(this.config.controls) && (e = (e => {
                                        let i = e;
                                        return Object.entries(t).forEach((([e, t]) => {
                                            i = pe(i, `{${e}}`, t)
                                        })), i
                                    })(e)), S.string(this.config.selectors.controls.container) && (i = document.querySelector(this.config.selectors.controls.container)), S.element(i) || (i = this.elements.container), i[S.element(e) ? "insertAdjacentElement" : "insertAdjacentHTML"]("afterbegin", e), S.element(this.elements.controls) || Ae.findElements.call(this), !S.empty(this.elements.buttons)) {
                                    const e = e => {
                                ...
                                if (M.isEdge && P(i), this.config.tooltips.controls) {
                                    const {
                                        classNames: e,
                                        selectors: t
                        ...
                        const Pe = {
                                setup() {
                                    ...
                                    if (!this.isVideo || this.isYouTube || this.isHTML5 && !K.textTracks) return void(S.array(this.config.controls) && this.config.controls.includes("settings") && this.config.settings.includes("captions") && Ae.setCaptionsMenu.call(this));
                                    var e, t;
                                    if (S.element(this.elements.captions) || (this.elements.captions = $("div", D(this.config.selectors.captions)), this.elements.captions.setAttribute("dir", "auto"), e = this.elements.captions, t = this.elements.wrapper, S.element(e) && S.element(t) && t.parentNode.insertBefore(e, t.nextSibling)), M.isIE && window.URL) {
                                        ...
                                        Array.from(e).forEach((e => {
                                            const t = e.getAttribute("src"),
                                                i = Se(t);
                                            null !== i && i.hostname !== window.location.href.hostname && ["http:", "https:"].includes(i.protocol) && we(t, "blob").then((t => {
                                    ...
                                    if (S.boolean(n) || ({
                                        ...
                                        X.call(this, this.media.textTracks, e, Pe.update.bind(this))
                                    }
                                ...
                                update() {
                                    ...
                                    this.isHTML5 && this.isVideo && e.filter((e => !s.get(e))).forEach((e => {
                                        ...
                                        }), "showing" === e.mode && (e.mode = "hidden"), X.call(this, e, "cuechange", (() => Pe.updateCues.call(this)))
                                    })), (a && this.language !== i || !e.includes(n)) && (Pe.setLanguage.call(this, i), Pe.toggle.call(this, t && a)), this.elements && R(this.elements.container, this.config.classNames.captions.enabled, !S.empty(e)), S.array(this.config.controls) && this.config.controls.includes("settings") && this.config.settings.includes("captions") && Ae.setCaptionsMenu.call(this)
                                },
                                toggle(e, t = !0) {
                                    if (!this.supported.ui) return;
                                    const {
                                    ...
                                    if (n !== i) {
                                        if (t || (this.captions.active = n, this.storage.set({
                                            ...
                                            const e = Pe.getTracks.call(this),
                                                t = Pe.findTrack.call(this, [this.captions.language, ...this.captions.languages], !0);
                                            return this.captions.language = t.language, void Pe.set.call(this, e.indexOf(t))
                                        }
                                        this.elements.buttons.captions && (this.elements.buttons.captions.pressed = n), R(this.elements.container, s, n), this.captions.toggled = n, Ae.updateSetting.call(this, "captions"), Z.call(this, this.media, n ? "captionsenabled" : "captionsdisabled")
                                    }
                                    setTimeout((() => {
                                ...
                                set(e, t = !0) {
                                    const i = Pe.getTracks.call(this);
                                    if (-1 !== e)
                                        if (S.number(e))
                                            if (e in i) {
                                                if (this.captions.currentTrack !== e) {
                                                    ...
                                                    this.captions.currentTrackNode = s, Ae.updateSetting.call(this, "captions"), t || (this.captions.language = n, this.storage.set({
                                                        language: n
                                ...
                                setLanguage(e, t = !0) {
                                    ...
                                    const s = Pe.getTracks.call(this),
                                        n = Pe.findTrack.call(this, [i]);
                                    Pe.set.call(this, s.indexOf(n), t)
                                },
                                getTracks(e = !1) {
                                ...
                                getLabel(e) {
                                    let t = e;
                                    return !S.track(t) && K.textTracks && this.captions.toggled && (t = Pe.getCurrentTrack.call(this)), S.track(t) ? S.empty(t.label) ? S.empty(t.language) ? be.get("enabled", this.config) : e.language.toUpperCase() : t.label : be.get("disabled", this.config)
                                },
                                updateCues(e) {
                                    if (!this.supported.ui) return;
                                    ...
                                    let t = e;
                                    if (!t) {
                                        const e = Pe.getCurrentTrack.call(this);
                                        t = Array.from((e || {}).activeCues || []).map((e => e.getCueAsHTML())).map(fe)
                                    }
                        ...
                        class Oe {
                            constructor(t) {
                                e(this, "onChange", (() => {
                                    ...
                                    if (this.supported) {
                                        let e;
                                        e = this.forceFallback ? "Fallback (forced)" : Oe.nativeSupported ? "Native" : "Fallback", this.player.debug.log(`${e} fullscreen enabled`)
                                    } else this.player.debug.log("Fullscreen not supported and fallback disabled");
                                    R(this.player.elements.container, this.player.config.classNames.fullscreen.enabled, this.supported)
                                })), e(this, "enter", (() => {
                                    this.supported && (M.isIos && this.player.config.fullscreen.iosNative ? this.player.isVimeo ? this.player.embed.requestFullscreen() : this.target.webkitEnterFullscreen() : !Oe.nativeSupported || this.forceFallback ? this.toggleFallback(!0) : this.prefix ? S.empty(this.prefix) || this.target[`${this.prefix}Request${this.property}`]() : this.target.requestFullscreen({
                                        navigationUI: "hide"
                                    }))
                                })), e(this, "exit", (() => {
                                    if (this.supported)
                                        ...
                                        else if (!Oe.nativeSupported || this.forceFallback) this.toggleFallback(!1);
                                    else if (this.prefix) {
                                ...
                                })), this.player = t, this.prefix = Oe.prefix, this.property = Oe.property, this.scrollPosition = {
                                    x: 0,
                                    y: 0
                            ...
                            get useNative() {
                                return Oe.nativeSupported && !this.forceFallback
                            }
                            static get prefix() {
                            ...
                            get supported() {
                                return [this.player.config.fullscreen.enabled, this.player.isVideo, Oe.nativeSupported || this.player.config.fullscreen.fallback, !this.player.isYouTube || Oe.nativeSupported || !M.isIos || this.player.config.playsinline && !this.player.config.fullscreen.iosNative].every(Boolean)
                            }
                            get active() {
                                if (!this.supported) return !1;
                                if (!Oe.nativeSupported || this.forceFallback) return F(this.target, this.player.config.classNames.fullscreen.fallback);
                        ...
                        const je = {
                            ...
                            build() {
                                ...
                                S.element(this.elements.controls) || (Ae.inject.call(this), this.listeners.controls()), je.toggleNativeControls.call(this), this.isHTML5 && Pe.setup.call(this), this.volume = null, this.muted = null, this.loop = null, this.quality = null, this.speed = null, Ae.updateVolume.call(this), Ae.timeUpdate.call(this), Ae.durationUpdate.call(this), je.checkPlaying.call(this), R(this.elements.container, this.config.classNames.pip.supported, K.pip && this.isHTML5 && this.isVideo), R(this.elements.container, this.config.classNames.airplay.supported, K.airplay && this.isHTML5), R(this.elements.container, this.config.classNames.isTouch, this.touch), this.ready = !0, setTimeout((() => {
                                    Z.call(this, this.media, "ready")
                                }), 0), je.setTitle.call(this), this.poster && je.setPoster.call(this, this.poster, !1).catch((() => {})), this.config.duration && Ae.durationUpdate.call(this), this.config.mediaMetadata && Ae.setMediaMetadata.call(this)
                            },
                            setTitle() {
                                let e = be.get("play", this.config);
                                if (S.string(this.config.title) && !S.empty(this.config.title) && (e += `, ${this.config.title}`), Array.from(this.elements.buttons.play || []).forEach((t => {
                                    ...
                                    const t = S.empty(this.config.title) ? "video" : this.config.title,
                                        i = be.get("frameTitle", this.config);
                            ...
                            setPoster(e, t = !0) {
                                return t && this.poster ? Promise.reject(new Error("Poster already set")) : (this.media.setAttribute("data-poster", e), this.elements.poster.removeAttribute("hidden"), te.call(this).then((() => _e(e))).catch((t => {
                            ...
                            checkPlaying(e) {
                                R(this.elements.container, this.config.classNames.playing, this.playing), R(this.elements.container, this.config.classNames.paused, this.paused), R(this.elements.container, this.config.classNames.stopped, this.stopped), Array.from(this.elements.buttons.play || []).forEach((e => {
                                    ...
                                    }), e.setAttribute("aria-label", be.get(this.playing ? "pause" : "play", this.config))
                                })), S.event(e) && "timeupdate" === e.type || je.toggleControls.call(this)
                            },
                            checkLoading(e) {
                                this.loading = ["stalled", "waiting"].includes(e.type), clearTimeout(this.timers.loading), this.timers.loading = setTimeout((() => {
                                    R(this.elements.container, this.config.classNames.loading, this.loading), je.toggleControls.call(this)
                                }), this.loading ? 250 : 0)
                            },
                            toggleControls(e) {
                                const {
                            ...
                            constructor(t) {
                                e(this, "firstTouch", (() => {
                                    ...
                                    !t.keyboard.global && t.keyboard.focused && X.call(e, i.container, "keydown keyup", this.handleKey, !1), X.call(e, i.container, "mousemove mouseleave touchstart touchmove enterfullscreen exitfullscreen", (t => {
                                        ...
                                        let a = 0;
                                        ["touchstart", "touchmove", "mousemove"].includes(t.type) && (je.toggleControls.call(e, !0), a = e.touch ? 3e3 : 2e3), clearTimeout(s.controls), s.controls = setTimeout((() => je.toggleControls.call(e, !1)), a)
                                    }));
                                    const n = () => {
                                    ...
                                    X.call(e, i.container, "enterfullscreen exitfullscreen", (t => {
                                        ...
                                        s === i.container && (!e.isEmbed && S.empty(e.config.ratio) || (n(), ("enterfullscreen" === t.type ? X : J).call(e, window, "resize", a)))
                                    }))
                                })), e(this, "media", (() => {
                                    const {
                                        player: e
                                    ...
                                    if (X.call(e, e.media, "timeupdate seeking seeked", (t => Ae.timeUpdate.call(e, t))), X.call(e, e.media, "durationchange loadeddata loadedmetadata", (t => Ae.durationUpdate.call(e, t))), X.call(e, e.media, "ended", (() => {
                                            e.isHTML5 && e.isVideo && e.config.resetOnEnd && (e.restart(), e.pause())
                                        })), X.call(e, e.media, "progress playing seeking seeked", (t => Ae.updateProgress.call(e, t))), X.call(e, e.media, "volumechange", (t => Ae.updateVolume.call(e, t))), X.call(e, e.media, "playing play pause ended emptied timeupdate", (t => je.checkPlaying.call(e, t))), X.call(e, e.media, "waiting canplay seeked playing", (t => je.checkLoading.call(e, t))), e.supported.ui && e.config.clickToPlay && !e.isAudio) {
                                    ...
                                    e.supported.ui && e.config.disableContextMenu && X.call(e, t.wrapper, "contextmenu", (e => {
                                        ...
                                        Ae.updateSetting.call(e, "speed"), e.storage.set({
                                            speed: e.speed
                                        })
                                    })), X.call(e, e.media, "qualitychange", (t => {
                                        Ae.updateSetting.call(e, "quality", null, t.detail.quality)
                                    ...
                                    if (t.buttons.play && Array.from(t.buttons.play).forEach((t => {
                                            ...
                                            t.stopPropagation(), t.preventDefault(), Ae.toggleMenu.call(e, t)
                                        }), null, !1), this.bind(t.buttons.settings, "keyup", (t => {
                                            [" ", "Enter"].includes(t.key) && ("Enter" !== t.key ? (t.preventDefault(), t.stopPropagation(), Ae.toggleMenu.call(e, t)) : Ae.focusFirstMenuItem.call(e, null, !0))
                                    ...
                                    this.bind(t.inputs.seek, i, (t => {
                                    ...
                                    }), "seek"), this.bind(t.progress, "mouseenter mouseleave mousemove", (t => Ae.updateSeekTooltip.call(e, t))), this.bind(t.progress, "mousemove touchmove", (t => {
                                        const {
                                            previewThumbnails: i
                                        } = e;
                                        ...
                                        this.bind(t, "input", (t => Ae.updateRangeFill.call(e, t.target)))
                                    })), e.config.toggleInvert && !S.element(t.display.duration) && this.bind(t.display.currentTime, "click", (() => {
                                        0 !== e.currentTime && (e.config.invertTime = !e.config.invertTime, Ae.timeUpdate.call(e))
                                        ...
                                        R(t.controls, i.classNames.noTransition, !0), je.toggleControls.call(e, !0), setTimeout((() => {
                                            R(t.controls, i.classNames.noTransition, !1)
                                        }), 0);
                                        const n = this.touch ? 3e3 : 4e3;
                                        clearTimeout(s.controls), s.controls = setTimeout((() => je.toggleControls.call(e, !1)), n)
                        ...
                        const Fe = {
                            setup() {
                                const e = this;
                                R(e.elements.wrapper, e.config.classNames.embed, !0), e.options.speed = e.config.speed.options, ue.call(e), S.object(window.Vimeo) ? Fe.ready.call(e) : He(e.config.urls.vimeo.sdk).then((() => {
                                    Fe.ready.call(e)
                                })).catch((t => {
                            ...
                            ready() {
                                ...
                                t.customControls || we(me(e.config.urls.vimeo.api, d)).then((t => {
                                    !S.empty(t) && t.thumbnail_url && je.setPoster.call(e, t.thumbnail_url).catch((() => {}))
                                })), e.embed = new window.Vimeo.Player(h, {
                                    autopause: e.config.autopause,
                                    muted: e.muted
                                }), e.media.paused = !0, e.media.currentTime = 0, e.supported.ui && e.embed.disableTextTrack(), e.media.play = () => (Re.call(e, !0), e.embed.play()), e.media.pause = () => (Re.call(e, !1), e.embed.pause()), e.media.stop = () => {
                                ...
                                Object.defineProperty(e.media, "loop", {
                                    ...
                                    e.media.textTracks = t, Pe.setup.call(e)
                                    ...
                                    Pe.updateCues.call(e, i)
                                })), e.embed.on("loaded", (() => {
                                    e.embed.getPaused().then((t => {
                                        Re.call(e, !t), t || Z.call(e, e.media, "playing")
                                    ...
                                    Re.call(e, !0), Z.call(e, e.media, "playing")
                                })), e.embed.on("pause", (() => {
                                    Re.call(e, !1)
                        ...
                        const Be = {
                                setup() {
                                    if (R(this.elements.wrapper, this.config.classNames.embed, !0), S.object(window.YT) && S.function(window.YT.Player)) Be.ready.call(this);
                                    else {
                                        const e = window.onYouTubeIframeAPIReady;
                                        window.onYouTubeIframeAPIReady = () => {
                                            S.function(e) && e(), Be.ready.call(this)
                                        }, He(this.config.urls.youtube.sdk).catch((e => {
                                            this.debug.warn("YouTube API failed to load", e)
                                        }))
                                    }
                                },
                                getTitle(e) {
                                    we(me(this.config.urls.youtube.api, e)).then((e => {
                                        if (S.object(e)) {
                                            const {
                                                title: t,
                                                height: i,
                                            ...
                                            this.config.title = t, je.setTitle.call(this), this.embed.ratio = he(s, i)
                                        }
                                        ue.call(this)
                                    })).catch((() => {
                                        ue.call(this)
                                ...
                                ready() {
                                    ...
                                    if (e.media = q(l, e.media), t.customControls) {
                                        ...
                                        _e(t("maxres"), 121).catch((() => _e(t("sd"), 121))).catch((() => _e(t("hq")))).then((t => je.setPoster.call(e, t.src))).then((t => {
                                    ...
                                    e.embed = new window.YT.Player(e.media, {
                                        ...
                                        events: {
                                            ...
                                            onReady(i) {
                                                ...
                                                const s = i.target;
                                                Be.getTitle.call(e, n), e.media.play = () => {
                                                    Ve.call(e, !0), s.playVideo()
                                                }, e.media.pause = () => {
                                                    Ve.call(e, !1), s.pauseVideo()
                                                }, e.media.stop = () => {
                                                    s.stopVideo()
                                            ...
                                            onStateChange(i) {
                                                const s = i.target;
                                                switch (clearInterval(e.timers.playing), e.media.seeking && [1, 2].includes(i.data) && (e.media.seeking = !1, Z.call(e, e.media, "seeked")), i.data) {
                                                    case -1:
                                                        Z.call(e, e.media, "timeupdate"), e.media.buffered = s.getVideoLoadedFraction(), Z.call(e, e.media, "progress");
                                                        break;
                                                    case 0:
                                                        Ve.call(e, !1), e.media.loop ? (s.stopVideo(), s.playVideo()) : Z.call(e, e.media, "ended");
                                                        break;
                                                    case 1:
                                                        t.customControls && !e.config.autoplay && e.media.paused && !e.embed.hasPlayed ? e.media.pause() : (Ve.call(e, !0), Z.call(e, e.media, "playing"), e.timers.playing = setInterval((() => {
                            ...
                            We = {
                                setup() {
                                    ...
                                    }), this.elements.wrapper.appendChild(this.elements.poster)), this.isHTML5 ? de.setup.call(this) : this.isYouTube ? Be.setup.call(this) : this.isVimeo && Fe.setup.call(this)) : this.debug.warn("No media element found!")
                                }
                            };
                        class ze {
                            constructor(t) {
                                e(this, "load", (() => {
                                    this.enabled && (S.object(window.google) && S.object(window.google.ima) ? this.ready() : He(this.player.config.urls.googleIMA.sdk).then((() => {
                                        this.ready()
                                    })).catch((() => {
                                    ...
                                    this.countdownTimer = setInterval((() => {
                                        const e = Ce(Math.max(this.manager.getRemainingTime(), 0)),
                                            t = `${be.get("advertisement",this.player.config)} - ${e}`;
                            ...
                            get tagUrl() {
                                ...
                                return S.url(e.tagUrl) ? e.tagUrl : `https://go.aniview.com/api/adserver6/vast/?${Ee({AV_PUBLISHERID:"58c25bb0073ef448b1087ad6",AV_CHANNELID:"5a0458dc28a06145e4519d21",AV_URL:window.location.hostname,cb:Date.now(),AV_WIDTH:640,AV_HEIGHT:480,AV_CDIM2:e.publisherId})}`
                            }
                        }

                        function Ke(e = 0, t = 0, i = 255) {
                        ...
                        const Je = {
                            ...
                            change(e) {
                                x(e, "sources.length") ? (de.cancelRequests.call(this), this.destroy.call(this, (() => {
                                    this.options.quality = [], _(this.media), this.media = null, S.element(this.elements.container) && this.elements.container.removeAttribute("class");
                                    const {
                                        sources: t,
                                        type: i
                                    } = e, [{
                                    ...
                                    Object.assign(this, {
                                        ...
                                        media: $(a, l)
                                    }), this.elements.container.appendChild(this.media), S.boolean(e.autoplay) && (this.config.autoplay = e.autoplay), this.isHTML5 && (this.config.crossorigin && this.media.setAttribute("crossorigin", ""), this.config.autoplay && this.media.setAttribute("autoplay", ""), S.empty(e.poster) || (this.poster = e.poster), this.config.loop.active && this.media.setAttribute("loop", ""), this.config.muted && this.media.setAttribute("muted", ""), this.config.playsinline && this.media.setAttribute("playsinline", "")), je.addStyleHook.call(this), this.isHTML5 && Je.insertElements.call(this, "source", t), this.config.title = e.title, We.setup.call(this), this.isHTML5 && Object.keys(e).includes("tracks") && Je.insertElements.call(this, "track", e.tracks), (this.isHTML5 || this.isEmbed && !this.supported.ui) && je.build.call(this), this.isHTML5 && this.media.load(), S.empty(e.previewThumbnails) || (Object.assign(this.config.previewThumbnails, e.previewThumbnails), this.previewThumbnails && this.previewThumbnails.loaded && (this.previewThumbnails.destroy(), this.previewThumbnails = null), this.config.previewThumbnails.enabled && (this.previewThumbnails = new Xe(this))), this.fullscreen.update()
                        ...
                        class Ge {
                            constructor(t, i) {
                                if (e(this, "play", (() => S.function(this.media.play) ? (this.ads && this.ads.enabled && this.ads.managerPromise.then((() => this.ads.play())).catch((() => ie(this.media.play()))), this.media.play()) : null)), e(this, "pause", (() => this.playing && S.function(this.media.pause) ? this.media.pause() : null)), e(this, "togglePlay", (e => (S.boolean(e) ? e : !this.playing) ? this.play() : this.pause())), e(this, "stop", (() => {
                                        ...
                                        if (this.supported.ui && !this.isAudio) {
                                            ...
                                            if (s && S.array(this.config.controls) && this.config.controls.includes("settings") && !S.empty(this.config.settings) && Ae.toggleMenu.call(this, !1), s !== t) {
                                        ...
                                        const i = () => {
                                            document.body.style.overflow = "", this.embed = null, t ? (Object.keys(this.elements).length && (_(this.elements.buttons.play), _(this.elements.captions), _(this.elements.controls), _(this.elements.wrapper), this.elements.buttons.play = null, this.elements.captions = null, this.elements.controls = null, this.elements.wrapper = null), S.function(e) && e()) : (ee.call(this), de.cancelRequests.call(this), q(this.elements.original, this.elements.container), Z.call(this, this.elements.original, "destroyed", !0), S.function(e) && e.call(this.elements.original), this.ready = !1, setTimeout((() => {
                                                this.elements = null, this.media = null
                                            }), 200))
                                        };
                                        this.stop(), clearTimeout(this.timers.loading), clearTimeout(this.timers.controls), clearTimeout(this.timers.resized), this.isHTML5 ? (je.toggleNativeControls.call(this, !0), i()) : this.isYouTube ? (clearInterval(this.timers.buffering), clearInterval(this.timers.playing), null !== this.embed && S.function(this.embed.destroy) && this.embed.destroy(), i()) : this.isVimeo && (null !== this.embed && this.embed.unload().then(i), setTimeout(i, 200))
                                    })), e(this, "supports", (e => K.mime.call(this, e))), this.timers = {}, this.ready = !1, this.loading = !1, this.failed = !1, this.touch = K.touch, this.media = t, S.string(this.media) && (this.media = document.querySelectorAll(this.media)), (window.jQuery && this.media instanceof jQuery || S.nodeList(this.media) || S.array(this.media)) && (this.media = this.media[0]), this.config = N({}, Me, Ge.defaults, i || {}, (() => {
                                        try {
                                        ...
                                        speed: [],
                                        quality: []
                                    }, this.debug = new $e(this.config.debug), this.debug.log("Config", this.config), this.debug.log("Support", K), S.nullOrUndefined(this.media) || !S.element(this.media)) return void this.debug.error("Setup failed: no suitable element passed");
                                ...
                                switch (n) {
                                    case "div":
                                        if (a = this.media.querySelector("iframe"), S.element(a)) {
                                            if (l = Se(a.getAttribute("src")), this.provider = function(e) {
                                                    return /^(https?:\/\/)?(www\.)?(youtube\.com|youtube-nocookie\.com|youtu\.?be)\/.+$/.test(e) ? Ne.youtube : /^https?:\/\/player.vimeo.com\/video\/\d{0,9}(?=\b|\/)/.test(e) ? Ne.vimeo : null
                                        ...
                                        if (S.empty(this.provider) || !Object.values(Ne).includes(this.provider)) return void this.debug.error("Setup failed: Invalid provider");
                                        this.type = Le;
                                        break;
                                    case "video":
                                    case "audio":
                                        this.type = n, this.provider = Ne.html5, this.media.hasAttribute("crossorigin") && (this.config.crossorigin = !0), this.media.hasAttribute("autoplay") && (this.config.autoplay = !0), (this.media.hasAttribute("playsinline") || this.media.hasAttribute("webkit-playsinline")) && (this.config.playsinline = !0), this.media.hasAttribute("muted") && (this.config.muted = !0), this.media.hasAttribute("loop") && (this.config.loop.active = !0);
                                        break;
                                    default:
                                        return void this.debug.error("Setup failed: unsupported type")
                                }
                                this.supported = K.check(this.type, this.provider), this.supported.api ? (this.eventListeners = [], this.listeners = new qe(this), this.storage = new ve(this), this.media.plyr = this, S.element(this.elements.container) || (this.elements.container = $("div"), L(this.media, this.elements.container)), je.migrateStyles.call(this), je.addStyleHook.call(this), We.setup.call(this), this.config.debug && X.call(this, this.elements.container, this.config.events.join(" "), (e => {
                                    this.debug.log(`event: ${e.type}`)
                                })), this.fullscreen = new Oe(this), (this.isHTML5 || this.isEmbed && !this.supported.ui) && je.build.call(this), this.listeners.container(), this.listeners.global(), this.config.ads.enabled && (this.ads = new ze(this)), this.isHTML5 && this.config.autoplay && this.once("canplay", (() => ie(this.play()))), this.lastSeekTime = 0, this.config.previewThumbnails.enabled && (this.previewThumbnails = new Xe(this))) : this.debug.error("Setup failed: no support")
                            }
                            get isHTML5() {
                                return this.provider === Ne.html5
                            }
                            get isEmbed() {
                                return this.isYouTube || this.isVimeo
                            }
                            get isYouTube() {
                                return this.provider === Ne.youtube
                            }
                            get isVimeo() {
                                return this.provider === Ne.vimeo
                            }
                            get isVideo() {
                                return this.type === Le
                            }
                            ...
                            set speed(e) {
                                ...
                                t = Ke(t, i, s), this.config.speed.selected = t, setTimeout((() => {
                            ...
                            set download(e) {
                                S.url(e) && (this.config.urls.download = e, Ae.setDownloadUrl.call(this))
                            }
                            set poster(e) {
                            ...
                            set currentTrack(e) {
                                Pe.set.call(this, e, !1), Pe.setup.call(this)
                            }
                            get currentTrack() {
                                const {
                                    toggled: e,
                            ...
                            set pip(e) {
                                ...
                                S.function(this.media.webkitSetPresentationMode) && this.media.webkitSetPresentationMode(t ? xe : "inline"), S.function(this.media.requestPictureInPicture) && (!this.pip && t ? this.media.requestPictureInPicture() : this.pip && !t && document.exitPictureInPicture())
                            }
                            get pip() {
                                return K.pip ? S.empty(this.media.webkitPresentationMode) ? this.media === document.pictureInPictureElement : this.media.webkitPresentationMode === xe : null
                            }
                            setPreviewThumbnails(e) {
                                this.previewThumbnails && this.previewThumbnails.loaded && (this.previewThumbnails.destroy(), this.previewThumbnails = null), Object.assign(this.config.previewThumbnails, e), this.config.previewThumbnails.enabled && (this.previewThumbnails = new Xe(this))
                            }
                            ...
                            static setup(e, t = {}) {
                                let i = null;
                                return S.string(e) ? i = Array.from(document.querySelectorAll(e)) : S.nodeList(e) ? i = Array.from(e) : S.array(e) && (i = e.filter(S.element)), S.empty(i) ? null : i.map((e => new Ge(e, t)))
                            }
                        }
                        var Ze;
                        return Ge.defaults = (Ze = Me, JSON.parse(JSON.stringify(Ze))), Ge
                    }())
                }
            },
            t = {};
