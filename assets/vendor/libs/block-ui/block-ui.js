/*! For license information please see block-ui.js.LICENSE.txt */ ! function(e, t) {
    ...
    return function() {
        var t = {
                1715: function(e, t, o) {
                    ...
                    ! function() {
                        "use strict";
                        i = [o(1145)], void 0 === (s = "function" == typeof(n = function(e) {
                            ...
                            function a(a, d) {
                                ...
                                if (!(d = e.extend({}, e.blockUI.defaults, d || {})).ignoreIfBlocked || !e(a).data("blockUI.isBlocked")) {
                                    if (d.overlayCSS = e.extend({}, e.blockUI.defaults.overlayCSS, d.overlayCSS || {}), u = e.extend({}, e.blockUI.defaults.css, d.css || {}), d.onOverlayClick && (d.overlayCSS.cursor = "pointer"), b = e.extend({}, e.blockUI.defaults.themedCSS, d.themedCSS || {}), y = void 0 === y ? d.message : y, h && s && r(window, {
                                            fadeOut: 0
                                    ...
                                    var C = i && (!e.support.boxModel || e("object,embed", h ? null : a).length > 0);
                                    if (n || C) {
                                        if (h && d.allowBodyStretch && e.support.boxModel && e("html,body").css("height", "100%"), (n || !e.support.boxModel) && !h) var O = p(a, "borderTopWidth"),
                                    ...
                                    if (c(1, a, d), h ? (s = I[0], l = e(d.focusableElements, s), d.focusInput && setTimeout(f, 20)) : function(e, t, o) {
                                            var n = e.parentNode,
                                                i = e.style,
                            ...
                            function r(t, o) {
                                ...
                                f && (clearTimeout(f), r.removeData("blockUI.timeout")), o = e.extend({}, e.blockUI.defaults, o || {}), c(0, t, o), null === o.onUnblock && (o.onUnblock = r.data("blockUI.onUnblock"), r.removeData("blockUI.onUnblock")), i = a ? e("body").children().filter(".blockUI").add("body > .blockUI") : r.find(">.blockUI"), o.cursorReset && (i.length > 1 && (i[1].style.cursor = o.cursorReset), i.length > 2 && (i[2].style.cursor = o.cursorReset)), a && (s = l = null), o.fadeOut ? (n = i.length, i.stop().fadeOut(o.fadeOut, (function() {
                                    0 == --n && d(i, u, o, t)
                                }))) : d(i, u, o, t)
                            }
