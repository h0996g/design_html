/*! For license information please see chartjs.js.LICENSE.txt */ ! function(t, e) {
    ...
    return function() {
        ...
        const k = /^rgba?\(\s*([-+.\d]+)(%)?[\s,]+([-+.e\d]+)(%)?[\s,]+([-+.e\d]+)(%)?(?:[\s,/]+([-+.e\d]+)(%)?)?\s*\)$/,
            ...
            P = t => t <= .04045 ? t / 12.92 : Math.pow((t + .055) / 1.055, 2.4);

        function D(t, e, i) {
            if (t) {
                let s = b(t);
                s[e] = Math.max(0, Math.min(s[e] + s[e] * i, 0 === e ? 360 : 1)), s = _(s), t.r = s[0], t.g = s[1], t.b = s[2]
            }
        }
        ...
        function A(t) {
            return "r" === t.charAt(0) ? function(t) {
                ...
                if (e) {
                    ...
                    return i = +e[1], o = +e[3], a = +e[5], i = 255 & (e[2] ? n(i) : s(i, 0, 255)), o = 255 & (e[4] ? n(o) : s(o, 0, 255)), a = 255 & (e[6] ? n(a) : s(a, 0, 255)), {
                        r: i,
                        g: o,
                        b: a,
                        a: r
        ...
        class T {
            constructor(t) {
                ...
                let i;
                var s, n, o;
                "object" === e ? i = C(t) : "string" === e && (o = (s = t).length, "#" === s[0] && (4 === o || 5 === o ? n = {
                    r: 255 & 17 * l[s[1]],
                    g: 255 & 17 * l[s[2]],
                    b: 255 & 17 * l[s[3]],
                    a: 5 === o ? 17 * l[s[4]] : 255
                    ...
                    w || (w = function() {
                        ...
                        for (s = 0; s < e.length; s++) {
                            for (a = r = e[s], n = 0; n < i.length; n++) o = i[n], r = r.replace(o, v[o]);
                            o = parseInt(M[a], 16), t[r] = [o >> 16 & 255, o >> 8 & 255, 255 & o]
                        }
                        return t
                ...
                }(t) || A(t)), this._rgb = i, this._valid = !!i
            }
            get valid() {
                return this._valid
            }
            ...
            hexString() {
                return this._valid ? (t = this._rgb, e = (t => u(t.r) && u(t.g) && u(t.b) && u(t.a))(t) ? c : d, t ? "#" + e(t.r) + e(t.g) + e(t.b) + ((t, e) => t < 255 ? e(t) : "")(t.a, e) : void 0) : void 0;
                var t, e
            }
            hslString() {
            ...
            rotate(t) {
                return function(t, e) {
                    var i = b(t);
                    i[0] = y(i[0] + e), i = _(i), t.r = i[0], t.g = i[1], t.b = i[2]
                }(this._rgb, t), this
            }
        }
        ...
        const W = (t, e) => "string" == typeof t && t.endsWith("%") ? parseFloat(t) / 100 * e : +t;
        ...
        function K(t, e, i) {
            ...
            const s = e[t],
                n = i[t];
            z(s) && z(n) ? q(s, n) : Object.prototype.hasOwnProperty.call(e, t) || (e[t] = $(n))
        }
        const G = {
            "": t => t,
            x: t => t.x,
        ...
        function At(t, e) {
            ...
            if (!i) return;
            const s = i.listeners,
                n = s.indexOf(e); - 1 !== n && s.splice(n, 1), s.length > 0 || (Ct.forEach((e => {
                delete t[e]
            })), delete t._chartjs)
        }
        ...
        function zt(t, e, i) {
            ...
            if (t._sorted) {
                ...
                d && (n = kt(Math.min(Dt(r, l, h).lo, i ? s : Dt(e, l, a.getPixelForValue(h)).lo), 0, s - 1)), o = u ? kt(Math.max(Dt(r, a.axis, c, !0).hi + 1, i ? 0 : Dt(e, l, a.getPixelForValue(c), !0).hi + 1), n, s) - n : s - n
            }
            return {
                start: n,
                count: o
        ...
        const Vt = t => 0 === t || 1 === t,
            Bt = (t, e, i) => -Math.pow(2, 10 * (t -= 1)) * Math.sin((t - e) * st / i),
            Wt = (t, e, i) => Math.pow(2, -10 * t) * Math.sin((t - e) * st / i) + 1,
            Nt = {
                linear: t => t,
                easeInQuad: t => t * t,
                easeOutQuad: t => -t * (t - 2),
                ...
                easeInOutSine: t => -.5 * (Math.cos(it * t) - 1),
                easeInExpo: t => 0 === t ? 0 : Math.pow(2, 10 * (t - 1)),
                easeOutExpo: t => 1 === t ? 1 : 1 - Math.pow(2, -10 * t),
                easeInOutExpo: t => Vt(t) ? t : t < .5 ? .5 * Math.pow(2, 10 * (2 * t - 1)) : .5 * (2 - Math.pow(2, -10 * (2 * t - 1))),
                easeInCirc: t => t >= 1 ? t : -(Math.sqrt(1 - t * t) - 1),
                easeOutCirc: t => Math.sqrt(1 - (t -= 1) * t),
                easeInOutCirc: t => (t /= .5) < 1 ? -.5 * (Math.sqrt(1 - t * t) - 1) : .5 * (Math.sqrt(1 - (t -= 2) * t) + 1),
                easeInElastic: t => Vt(t) ? t : Bt(t, .075, .3),
                easeOutElastic: t => Vt(t) ? t : Wt(t, .075, .3),
                easeInOutElastic(t) {
                    const e = .1125;
                    return Vt(t) ? t : t < .5 ? .5 * Bt(2 * t, e, .45) : .5 + .5 * Wt(2 * t - 1, e, .45)
                },
                easeInBack(t) {
                    const e = 1.70158;
                    return t * t * ((e + 1) * t - e)
                ...
                easeInOutBounce: t => t < .5 ? .5 * Nt.easeInBounce(2 * t) : .5 * Nt.easeOutBounce(2 * t - 1) + .5
            };
        ...
        function $t(t) {
            return Ht(t) ? t : new T(t).saturate(.5).darken(.1).hexString()
        }
        ...
        const Kt = {
            ...
            logarithmic(t, e, i) {
                if (0 === t) return "0";
                const s = i[e].significand || t / Math.pow(10, Math.floor(ct(t)));
                return [1, 2, 3, 5, 10, 15].includes(s) || e > .8 * i.length ? Kt.numeric.call(this, t, e, i) : ""
            }
        };
        var Gt = {
            formatters: Kt
        ...
        function ne(t, e, i, s) {
            ...
            for (l = 0; l < r; l++)
                if (d = i[l], null == d || I(d)) {
                    if (I(d))
                        for (h = 0, c = d.length; h < c; h++) u = d[h], null == u || I(u) || (a = se(t, n, o, a, u))
                } else a = se(t, n, o, a, d);
            t.restore();
            const f = o.length / 2;
            if (f > i.length) {
        ...
        function le(t, e, i, s, n) {
            ...
            if (!(isNaN(p) || p <= 0)) {
                switch (t.beginPath(), f) {
                    default: n ? t.ellipse(i, s, n / 2, p, 0, 0, st) : t.arc(i, s, p, 0, st),
                    t.closePath();
                    break;
                    case "triangle":
                            c = n ? n / 2 : p,
        ...
        function me(t, e, i, s, n, o = {}) {
            ...
            for (t.save(), t.font = n.string, function(t, e) {
                ...
                }(t, o), l = 0; l < a.length; ++l) h = a[l], o.backdrop && pe(t, o.backdrop), r && (o.strokeColor && (t.strokeStyle = o.strokeColor), R(o.strokeWidth) || (t.lineWidth = o.strokeWidth), t.strokeText(h, i, s, o.maxWidth)), t.fillText(h, i, s, o.maxWidth), ge(t, i, s, h, o), s += Number(n.lineHeight);
            t.restore()
        }
        ...
        function be(t, e) {
            ...
            t.arc(i + a.topLeft, s + a.topLeft, a.topLeft, 1.5 * it, it, !0), t.lineTo(i, s + o - a.bottomLeft), t.arc(i + a.bottomLeft, s + o - a.bottomLeft, a.bottomLeft, it, rt, !0), t.lineTo(i + n - a.bottomRight, s + o), t.arc(i + n - a.bottomRight, s + o - a.bottomRight, a.bottomRight, rt, 0, !0), t.lineTo(i + n, s + a.topRight), t.arc(i + n - a.topRight, s + a.topRight, a.topRight, 0, -rt, !0), t.lineTo(i + a.topLeft, s)
        }
        const xe = /^(normal|(\d+(?:\.\d+)?)(px|em|%)?)$/,
            _e = /^(normal|italic|initial|inherit|unset|(oblique( -?[0-9]?[0-9]deg)?))$/;
        ...
        function Pe(t, e) {
            ...
            s && !("" + s).match(_e) && (console.warn('Invalid font style specified: "' + s + '"'), s = void 0);
            const n = {
        ...
        function De(t, e, i, s) {
            ...
            for (n = 0, o = t.length; n < o; ++n)
                if (a = t[n], void 0 !== a && (void 0 !== e && "function" == typeof a && (a = a(e), r = !1), void 0 !== i && I(a) && (a = a[i % a.length], r = !1), void 0 !== a)) return s && !r && (s.cacheable = !1), a
        }
        ...
        function Ce(t, e = [""], i, s, n = (() => t[0])) {
            ...
            return new Proxy(a, {
                ...
                get(i, s) {
                    return Re(i, s, (() => function(t, e, i, s) {
                        let n;
                        for (const o of e)
                            if (n = We(Le(o, t), i), void 0 !== n) return Ee(t, n) ? Ve(i, s, t, n) : n
                    }(s, e, t, i)))
                },
            ...
            return new Proxy(n, {
                ...
                get(t, e, i) {
                    return Re(t, e, (() => function(t, e, i) {
                        ...
                        let r = s[e];
                        return tt(r) && a.isScriptable(e) && (r = function(t, e, i, s) {
                            const {
                                _proxy: n,
                                _context: o,
                                _subProxy: a,
                            ...
                            r.add(t);
                            let l = e(o, a || s);
                            return r.delete(t), Ee(t, l) && (l = Ve(n._scopes, n, t, l)), l
                        }(e, r, t, i)), I(r) && r.length && (r = function(t, e, i, s) {
                            const {
                                _proxy: n,
                                _context: o,
                                _subProxy: a,
                            ...
                            return e
                        }(e, r, t, a.isIndexable)), Ee(e, r) && (r = Ae(r, n, o && o[e], a)), r
                    }(t, e, i)))
                },
        ...
        const Le = (t, e) => t ? t + J(e) : e,
            Ee = (t, e) => z(e) && "adapters" !== t && (null === Object.getPrototypeOf(e) || e.constructor === Object);
        ...
        const ze = (t, e) => !0 === t ? e : "string" == typeof t ? Z(e, t) : void 0;
        ...
        function Ve(t, e, i, s) {
            ...
            return null !== l && (void 0 === o || o === i || (l = Be(r, a, o, l, s), null !== l)) && Ce(Array.from(r), [""], n, o, (() => function(t, e, i) {
        ...
        function qe(t, e, i, s, n) {
            ...
            if (e.spanGaps && (t = t.filter((t => !t.skip))), "monotone" === e.cubicInterpolationMode) ! function(t, e = "x") {
                ...
                for (a = 0; a < s; ++a)
                    ...
                    for (let c = 0; c < s - 1; ++c) l = h, h = $e(t, c + 1), l && h && (ut(e[c], 0, je) ? i[c] = i[c + 1] = 0 : (n = i[c] / e[c], o = i[c + 1] / e[c], r = Math.pow(n, 2) + Math.pow(o, 2), r <= 9 || (a = 3 / Math.sqrt(r), i[c] = n * a * e[c], i[c + 1] = o * a * e[c])))
                }(t, n, o),
                function(t, e, i = "x") {
                    const s = Ye(i),
                        n = t.length;
            ...
            e.capBezierPoints && function(t, e) {
                ...
                for (i = 0, s = t.length; i < s; ++i) a = o, o = r, r = i < s - 1 && he(t[i + 1], e), o && (n = t[i], a && (n.cp1x = Xe(n.cp1x, e.left, e.right), n.cp1y = Xe(n.cp1y, e.top, e.bottom)), r && (n.cp2x = Xe(n.cp2x, e.left, e.right), n.cp2y = Xe(n.cp2y, e.top, e.bottom)))
            }(t, i)
        }
        ...
        function ii(t, e) {
            ...
            } = e, n = Je(i), o = "border-box" === n.boxSizing, a = ti(n, "padding"), r = ti(n, "border", "width"), {
                x: l,
                y: h,
                box: c
            } = function(t, e) {
        ...
        const oi = function() {
            ...
            try {
                ...
                Ke() && (window.addEventListener("test", null, e), window.removeEventListener("test", null, e))
            } catch (t) {}
            return t
        }();
        ...
        function pi(t, e, i) {
            ...
            let p, m, b, x = !1,
                _ = null;
            for (let t = c, i = c; t <= d; ++t) m = e[t % a], m.skip || (p = h(m[s]), p !== b && (x = l(p, n, o), null === _ && (x || l(n, b, p) && 0 !== r(n, b)) && (_ = 0 === r(p, n) ? t : i), null !== _ && (!x || 0 === r(o, p) || l(o, b, p)) && (g.push(gi({
                start: _,
                end: t,
                loop: u,
                count: a,
        ...
        function xi(t, e) {
            ...
            const i = [],
                s = function(t, e) {
                    return Ht(e) ? (i.includes(e) || i.push(e), i.indexOf(e)) : e
                };
        ...
        class wi {
            constructor(t, e, i, s) {
                ...
                this._active = !0, this._fn = t.fn || Mi[t.type || typeof o], this._easing = Nt[t.easing] || Nt.linear, this._start = Math.floor(Date.now() + (t.delay || 0)), this._duration = this._total = Math.floor(t.duration), this._loop = !!t.loop, this._target = e, this._prop = i, this._from = o, this._to = s, this._promises = void 0
            }
            active() {
                return this._active
            }
            update(t, e, i) {
                if (this._active) {
                    ...
                    const s = this._target[this._prop],
                        n = i - this._start,
                        o = this._duration - n;
                    this._start = i, this._duration = Math.floor(Math.max(o, t.duration)), this._total += n, this._loop = !!t.loop, this._to = De([t.to, e, s, t.from]), this._from = De([t.from, s, e])
                }
            }
            cancel() {
        ...
        class ki {
            ...
            _createAnimations(t, e) {
                ...
                for (r = o.length - 1; r >= 0; --r) {
                    ...
                    d && d.duration ? (n[l] = c = new wi(d, t, l, h), s.push(c)) : t[l] = h
                }
                return s
            }
            update(t, e) {
        ...
        function Di(t, e, i, s = {}) {
            ...
            if (null !== e) {
                for (a = 0, r = n.length; a < r; ++a) {
                    ...
                    h = t.values[l], F(h) && (o || 0 === e || dt(e) === dt(h)) && (e += h)
                }
                return e
            }
        }
        ...
        function Ti(t, e) {
            ...
            for (let t = 0; t < d; ++t) {
                ...
                u = (i._stacks || (i._stacks = {}))[h] = Ci(n, c, o), u[r] = d, u._top = Ai(u, a, !0, s.type), u._bottom = Ai(u, a, !1, s.type), (u._visualValues || (u._visualValues = {}))[r] = d
            }
        }
        ...
        class zi {
            ...
            initialize() {
                ...
                this.configure(), this.linkScales(), t._stacked = Oi(t.vScale, t), this.addElements(), this.options.fill && !this.chart.isPluginEnabled("filler") && console.warn("Tried to use the 'fill' option without the 'Filler' plugin enabled. Please import and register the 'Filler' plugin and make sure it is not disabled in the options")
            }
            updateIndex(t) {
            ...
            buildOrUpdateElements(t) {
                ...
                this._dataCheck();
                const n = e._stacked;
                e._stacked = Oi(e.vScale, e), e.stack !== i.stack && (s = !0, Ei(e), e.stack = i.stack), this._resyncElements(t), (s || n !== e._stacked) && Ti(this, e._parsed)
            }
            configure() {
            ...
            parse(t, e) {
                ...
                if (!1 === this._parsing) i._parsed = s, i._sorted = !0, h = s;
                    ...
                    h = I(s[t]) ? this.parseArrayData(i, s, t, e) : z(s[t]) ? this.parseObjectData(i, s, t, e) : this.parsePrimitiveData(i, s, t, e);
            ...
            updateRangeFromParsed(t, e, i, s) {
                ...
                s && a && (s.values = a, o = Di(s, n, this._cachedMeta.index)), t.min = Math.min(t.min, o), t.max = Math.max(t.max, o)
            }
            getMinMax(t, e) {
            ...
            getAllParsedValues(t) {
                const e = this._cachedMeta._parsed,
                    i = [];
                let s, n, o;
                for (s = 0, n = e.length; s < n; ++s) o = e[s][t.axis], F(o) && i.push(o);
                return i
            }
            getMaxOverflow() {
                return !1
            ...
            _update(t) {
                ...
                this.update(t || "default"), e._clip = function(t) {
                    let e, i, s, n;
                    return z(t) ? (e = t.top, i = t.right, s = t.bottom, n = t.left) : e = i = s = n = t, {
                        top: e,
                        right: i,
                        bottom: s,
                        left: n,
                ...
                }(B(this.options.clip, function(t, e, i) {
                    if (!1 === i) return !1;
                    const s = Si(t, i),
                        n = Si(e, i);
                    return {
            ...
            _resolveElementOptions(t, e = "default", i) {
                ...
                return f.$shared && (f.$shared = r, n[o] = Object.freeze(Ii(f, r))), f
            }
            ...
            updateElement(t, e, i, s) {
                Ri(s) ? Object.assign(t, i) : this._resolveAnimations(e, s).update(t, i)
            }
        ...
        function Fi(t) {
            ...
            const l = () => {
                32767 !== o && -32768 !== o && (Q(a) && (r = Math.min(r, Math.abs(o - a) || r)), a = o)
            };
        ...
        function Bi(t, e, i, s) {
            const n = t.iScale,
                ...
                l = [];
            let h, c, d, u;
            for (h = i, c = i + s; h < c; ++h) u = e[h], d = {}, d[n.axis] = r || n.parse(a[h], h), l.push(Vi(u, d, o, h));
            return l
        }
        ...
        function Ni(t, e, i, s) {
            ...
            "middle" === n && i && (t.enableBorderRadius = !0, (i._top || 0) === s ? n = h : (i._bottom || 0) === s ? n = c : (o[Hi(c, a, r, l)] = !0, n = h)), o[Hi(n, a, r, l)] = !0, t.borderSkipped = o
        }

        function Hi(t, e, i, s) {
            var n, o, a;
            return s ? (a = i, t = ji(t = (n = t) === (o = e) ? a : n === a ? o : n, i, e)) : t = ji(t, e, i), t
        }
        ...
        class Yi extends zi {
                    ...
                    } = this._getRotationExtents(),
                    {
                        ...
                        if (e < st) {
                            const r = t,
                                ...
                                d = Math.cos(l),
                                u = Math.sin(l),
                                f = (t, e, s) => wt(t, r, l, !0) ? 1 : Math.max(e, e * i, s, s * i),
                                g = (t, e, s) => wt(t, r, l, !0) ? -1 : Math.min(e, e * i, s, s * i),
                                p = f(0, h, d),
                                m = f(rt, c, u),
                                b = g(it, h, d),
                                x = g(it + rt, c, u);
            ...
            _circumference(t, e) {
                ...
                return e && i.animation.animateRotate || !this.chart.getDataVisibility(t) || null === s._parsed[t] || s.data[t].hidden ? 0 : this.calculateCircumference(s._parsed[t] * n / st)
            }
            updateElements(t, e, i, s) {
                const n = "reset" === s,
                    o = this.chart,
        ...
        var Xi = Object.freeze({
            ...
            BarController: class extends zi {
                ...
                parseObjectData(t, e, i, s) {
                    ...
                    let d, u, f, g;
                    for (d = i, u = i + s; d < u; ++d) g = e[d], f = {}, f[n.axis] = n.parse(Z(g, l), d), c.push(Vi(Z(g, h), f, o, d));
                    return c
                }
                updateRangeFromParsed(t, e, i, s) {
                ...
                getLabelAndValue(t) {
                    const e = this._cachedMeta,
                        ...
                        n = this.getParsed(t),
                        o = n._custom,
                        a = Wi(o) ? "[" + o.start + ", " + o.end + "]" : "" + s.getLabelForValue(n[s.axis]);
                    return {
                    ...
                    for (let u = e; u < e + i; u++) {
                        const e = this.getParsed(u),
                            ...
                            p = {
                                horizontal: l,
                                base: i.base,
                                enableBorderRadius: !g || Wi(e._custom) || o === g._top || o === g._bottom,
                                x: l ? i.head : f.center,
                                y: l ? f.center : i.head,
                        ...
                        Ni(p, m, g, o), $i(p, m, h.ratio), this.updateElement(t[u], u, p, s)
                    }
                }
                _getStacks(t, e) {
                    const {
                ...
                _calculateBarValuePixels(t) {
                    ...
                    } = this, a = n || 0, r = this.getParsed(t), l = r._custom, h = Wi(l);
                    let c, d, u = r[e.axis],
                        f = 0,
                        g = i ? this.applyStack(e, r, i) : u;
                    g !== u && (f = g - u, g = u), h && (u = l.barStart, g = l.barEnd - l.barStart, 0 !== u && dt(u) !== dt(l.barEnd) && (f = 0), f += u);
                    const p = R(n) || h ? f : n;
                    ...
                    if (c = this.chart.getDataVisibility(t) ? e.getPixelForValue(f + g) : m, d = c - m, Math.abs(d) < o) {
                        ...
                        const t = e.getPixelForDecimal(0),
                            ...
                            l = Math.min(t, n),
                            f = Math.max(t, n);
                        m = Math.max(Math.min(m, f), l), c = m + d, i && !h && (r._stacks[e.axis]._visualValues[s] = e.getValueForPixel(c) - e.getValueForPixel(m))
                    }
            ...
            BubbleController: class extends zi {
                ...
                parseArrayData(t, e, i, s) {
                    ...
                    for (let t = 0; t < n.length; t++) {
                        const s = e[i + t];
                        n[t]._custom = B(s[2], this.resolveDataElementOptions(t + i).radius)
                    }
                    return n
                }
                parseObjectData(t, e, i, s) {
                    ...
                    for (let t = 0; t < n.length; t++) {
                        const s = e[i + t];
                        n[t]._custom = B(s && s.r && +s.r, this.resolveDataElementOptions(t + i).radius)
                    }
                    return n
                }
                getMaxOverflow() {
                ...
                resolveDataElementOptions(t, e) {
                    ...
                    const n = s.radius;
                    return "active" !== e && (s.radius = 0), s.radius += B(i && i._custom, n), s
                }
            },
                ...
                updateElements(t, e, i, s) {
                    ...
                    for (let i = 0; i < x; ++i) {
                        ...
                        const y = this.getParsed(i),
                            ...
                            w = x[u] = n || v ? a.getBasePixel() : a.getPixelForValue(r ? this.applyStack(a, y, r) : y[u], i);
                        x.skip = isNaN(M) || isNaN(w) || v, x.stop = i > 0 && Math.abs(y[d] - _[d]) > p, g && (x.parsed = y, x.raw = l.data[i]), c && (x.options = h || this.resolveDataElementOptions(i, f.active ? "active" : s)), m || this.updateElement(f, i, x, s), _ = y
                    }
                }
                getMaxOverflow() {
                    const t = this._cachedMeta,
        ...
        function Qi(t, e, i, s, n) {
            const o = [];
            return n || t.isPointInArea(e) ? (Ji(t, i, e, (function(i, a, r) {
        ...
        function ts(t, e, i, s, n, o) {
            return o || t.isPointInArea(e) ? "r" !== i || s ? function(t, e, i, s, n, o) {
                ...
                return Ji(t, i, e, (function(i, h, c) {
                ...
                let n = [];
                return Ji(t, i, e, (function(t, i, o) {
                    const {
                        startAngle: a,
                        endAngle: r
            ...
            modes: {
                index(t, e, i, s) {
                    const n = ii(e, t),
                        ...
                        r = i.intersect ? Qi(t, n, o, s, a) : ts(t, n, o, !1, s, a),
                        l = [];
                ...
                dataset(t, e, i, s) {
                    const n = ii(e, t),
                        o = i.axis || "xy",
                        a = i.includeInvisible || !1;
                    let r = i.intersect ? Qi(t, n, o, s, a) : ts(t, n, o, !1, s, a);
                    if (r.length > 0) {
                ...
                point(t, e, i, s) {
                    return Qi(t, ii(e, t), i.axis || "xy", s, i.includeInvisible || !1)
                },
                nearest(t, e, i, s) {
                    const n = ii(e, t),
                        o = i.axis || "xy",
        ...
        function ds(t, e, i, s) {
            ...
            for (o = 0, a = t.length, h = 0; o < a; ++o) {
                r = t[o], l = r.box, l.update(r.width || e.w, r.height || e.h, cs(r.horizontal, e));
                const {
                    same: a,
                    other: d
                } = hs(e, i, r, s);
        ...
        function fs(t, e, i, s) {
            ...
            for (const r of t) {
                ...
                if (r.horizontal) {
                    const s = e.w * h,
                        o = l.size || t.height;
                    Q(l.start) && (a = l.start), t.fullSize ? us(t, n.left, a, i.outerWidth - n.right - n.left, o) : us(t, e.left + l.placed, a, s, o), l.start = a, l.placed += s, a = t.bottom
                } else {
                    const s = e.h * h,
                        a = l.size || t.width;
                    Q(l.start) && (o = l.start), t.fullSize ? us(t, o, n.top, a, i.outerHeight - n.bottom - n.top) : us(t, o, e.top + l.placed, a, s), l.start = o, l.placed += s, o = t.right
                }
            }
            e.x = o, e.y = a
        }
        var gs = {
            ...
            update(t, e, i, s) {
                ...
                const n = Se(t.options.layout.padding),
                    ...
                    r = function(t) {
                        const e = function(t) {
                            ...
                            i = as(e.filter((t => t.box.fullSize)), !0),
                            s = as(ns(e, "left"), !0),
                            n = as(ns(e, "right")),
                            o = as(ns(e, "top"), !0),
                            a = as(ns(e, "bottom")),
                ...
                ds(r.fullSize, f, d, g), ds(l, f, d, g), ds(h, f, d, g) && ds(l, f, d, g),
                    function(t) {
                    ...
                    }(f), fs(r.leftAndTop, f, d, g), f.x += f.w, f.y += f.h, fs(r.rightAndBottom, f, d, g), t.chartArea = {
                        left: f.left,
                        top: f.top,
                        right: f.left + f.w,
                        bottom: f.top + f.h,
        ...
        function vs(t, e, i) {
            t && t.canvas && t.canvas.removeEventListener(e, i, ys)
        }
        ...
        function Os(t, e, i) {
            ...
            return a.observe(n),
                function(t, e) {
                    Ss.size || window.addEventListener("resize", Ds), Ss.set(t, e)
                }(t, o), a
        }

        function Cs(t, e, i) {
            i && i.disconnect(), "resize" === e && function(t) {
                Ss.delete(t), Ss.size || window.removeEventListener("resize", Ds)
            }(t)
        }
        ...
        class Ts extends ps {
            acquireContext(t, e) {
                ...
                return i && i.canvas === t ? (function(t, e) {
                    ...
                    if (t[bs] = {
                        ...
                        }, i.display = i.display || "block", i.boxSizing = i.boxSizing || "border-box", _s(n)) {
                        const e = ai(t, "width");
                        void 0 !== e && (t.width = e)
                    }
                    if (_s(s))
            ...
            getMaximumSize(t, e, i, s) {
                return function(t, e, i, s) {
                    ...
                    return h = Math.max(0, h - o.width), c = Math.max(0, s ? h / s : c - o.height), h = si(Math.min(h, a, l.maxWidth)), c = si(Math.min(c, r, l.maxHeight)), h && !c && (c = si(h / 2)), (void 0 !== e || void 0 !== i) && s && l.height && c > l.height && (c = l.height, h = si(Math.floor(c * s))), {
                        width: h,
                        height: c
                    }
                }(t, e, i, s)
        ...
        const Rs = (t, e, i) => "top" === e || "left" === e ? t[e] + i : t[e] - i,
        ...
        class Ns extends Ls {
            ...
            getUserBounds() {
                ...
                return t = V(t, Number.POSITIVE_INFINITY), e = V(e, Number.NEGATIVE_INFINITY), i = V(i, Number.POSITIVE_INFINITY), s = V(s, Number.NEGATIVE_INFINITY), {
                    min: V(t, i),
                    max: V(e, s),
                    minDefined: F(t),
                    maxDefined: F(e)
            ...
            update(t, e, i) {
                ...
                this.beforeUpdate(), this.maxWidth = t, this.maxHeight = e, this._margins = i = Object.assign({
                    ...
                    const {
                        min: s,
                        max: n
                    } = t, o = W(e, (n - s) / 2), a = (t, e) => i && 0 === t ? 0 : t + e;
                    return {
                        min: a(s, -Math.abs(o)),
                        max: a(n, o)
                    }
                ...
                this._convertTicksToLabels(r ? zs(this.ticks, a) : this.ticks), this.configure(), this.beforeCalculateLabelRotation(), this.calculateLabelRotation(), this.afterCalculateLabelRotation(), o.display && (o.autoSkip || "auto" === o.source) && (this.ticks = function(t, e) {
                    ...
                    if (a > 0) {
                        ...
                        for (Es(e, h, c, R(s) ? 0 : r - s, r), t = 0, i = a - 1; t < i; t++) Es(e, h, c, o[t], o[t + 1]);
                        return Es(e, h, c, l, R(s) ? e.length : l + s), h
                    }
                    return Es(e, h, c), h
            ...
            _callHooks(t) {
                this.chart.notifyPlugins(t, this.getContext()), N(this.options[t], [this])
            }
            beforeDataLimits() {
            ...
            generateTickLabels(t) {
                ...
                let i, s, n;
                for (i = 0, s = t.length; i < s; i++) n = t[i], n.label = N(e.callback, [n.value, i, t], this)
            }
            ...
            calculateLabelRotation() {
                ...
                o = t.offset ? this.maxWidth / i : u / (i - 1), c + 6 > o && (o = u / (i - (t.offset ? .5 : 1)), a = this.maxHeight - Vs(t.grid) - e.padding - Bs(t.title, this.chart.options.font), r = Math.sqrt(c * c + d * d), l = bt(Math.min(Math.asin(kt((h.highest.height + 6) / o, -1, 1)), Math.asin(kt(a / r, -1, 1)) - Math.asin(kt(d / r, -1, 1)))), l = Math.max(s, Math.min(n, l))), this.labelRotation = l
            }
            ...
            fit() {
                ...
                if (o) {
                    ...
                    if (a ? (t.width = this.maxWidth, t.height = Vs(n) + o) : (t.height = this.maxHeight, t.width = Vs(n) + o), i.display && this.ticks.length) {
                        const {
                            first: e,
                            last: s,
                            widest: n,
                            highest: o
                        } = this._getLabelSizes(), r = 2 * i.padding, l = mt(this.labelRotation), h = Math.cos(l), c = Math.sin(l);
                        if (a) {
            ...
            _computeLabelSizes(t, e, i) {
                const {
                    ctx: s,
                    _longestTextCache: n
                } = this, o = [], a = [], r = Math.floor(e / Is(e, i));
                let l, h, c, d, u, f, g, p, m, b, x, _ = 0,
                    y = 0;
                for (l = 0; l < e; l += r) {
                    if (d = t[l].label, u = this._resolveTickFontOptions(l), s.font = f = u.string, g = n[f] = n[f] || {
                            data: {},
                            gc: []
                        }, p = u.lineHeight, m = b = 0, R(d) || I(d)) {
                        if (I(d))
                            for (h = 0, c = d.length; h < c; ++h) x = d[h], R(x) || I(x) || (m = se(s, g.data, g.gc, m, x), b += p)
            ...
            getPixelForDecimal(t) {
                ...
                return kt(this._alignToPixels ? oe(this.chart, e, 0) : e, -32768, 32767)
            }
            ...
            getContext(t) {
                ...
                return this.$context || (this.$context = Oe(this.chart.getContext(), {
                    scale: this,
                    type: "scale"
                }))
            }
            ...
            _computeGridLineItems(t) {
                ...
                for (b = 0; b < h; b += C) {
                    ...
                    x = Fs(this, b, r), void 0 !== x && (_ = oe(i, x, o), l ? y = M = k = P = _ : v = w = S = D = _, d.push({
                        tx1: y,
                        ty1: v,
                        tx2: M,
                        ty2: w,
            ...
            _computeLabelItems(t) {
                const e = this.axis,
                    ...
                    p = [];
                let m, b, x, _, y, v, M, w, k, S, P, D, O = "middle";
                ...
                for (m = 0, b = a.length; m < b; ++m) {
                    ...
                    w = this.getPixelForTick(m) + n.labelOffset, k = this._resolveTickFontOptions(m), S = k.lineHeight, P = I(_) ? _.length : 1;
                    const e = P / 2,
                        i = t.color,
                        r = t.textStrokeColor,
                        h = t.textStrokeWidth;
                    let d, u = M;
                    if (o ? (y = w, "inner" === M && (u = m === b - 1 ? this.options.reverse ? "left" : "right" : 0 === m ? this.options.reverse ? "right" : "left" : "center"), D = "top" === s ? "near" === l || 0 !== g ? -P * S + S / 2 : "center" === l ? -C.highest.height / 2 - e * S + S : -C.highest.height + S / 2 : "near" === l || 0 !== g ? S / 2 : "center" === l ? C.highest.height / 2 - e * S : C.highest.height - P * S, c && (D *= -1), 0 === g || t.showLabelBackdrop || (y += S / 2 * Math.sin(g))) : (v = w, D = (1 - P) * S / 2), t.showLabelBackdrop) {
            ...
            drawTitle() {
                ...
                "bottom" === e || "center" === e || z(e) ? (r += o.bottom, I(i.text) && (r += n.lineHeight * (i.text.length - 1))) : r += o.top;
                const {
                    titleX: l,
                    titleY: h,
                    maxWidth: c,
                    ...
                    if (t.isHorizontal()) {
                        ...
                        } else f = "center" === i ? (h.bottom + h.top) / 2 + p - e : Rs(t, i, e);
                        d = r - o
                    } else {
                        if (z(i)) {
                            const t = Object.keys(i)[0],
                        ...
                        } else u = "center" === i ? (h.left + h.right) / 2 - m + e : Rs(t, i, e);
        ...
        class Hs {
            ...
            register(t) {
                ...
                return n in s || (s[n] = t, function(t, e, i) {
                    const s = X(Object.create(null), [i ? ie.get(i) : {}, ie.get(e), t.defaults]);
                    ...
                    }(e, t.defaultRoutes), t.descriptors && ie.describe(e, t.descriptors)
            ...
            unregister(t) {
                const e = this.items,
                    i = t.id,
                    s = this.scope;
                i in e && delete e[i], s && i in ie[s] && (delete ie[s][i], this.override && delete Zt[i])
            }
        }
        class js {
            constructor() {
                this.controllers = new Hs(zi, "datasets", !0), this.elements = new Hs(Ls, "elements"), this.plugins = new Hs(Object, "plugins"), this.scales = new Hs(Ns, "scales"), this._typedRegistries = [this.controllers, this.scales, this.elements]
            }
            add(...t) {
            ...
            _each(t, e, i) {
                [...e].forEach((e => {
                    ...
                    i || s.isForType(e) || s === this.plugins && e.id ? this._exec(t, s, e) : H(e, (e => {
                        const s = i || this._getRegistryForType(e);
                        this._exec(t, s, e)
                    }))
                }))
        ...
        class Ys {
            ...
            _notify(t, e, i, s) {
                ...
                for (const n of t) {
                    const t = n.plugin;
                    if (!1 === N(t[i], [e, s, n.options], t) && s.cancelable) return !1
                }
                return !0
            }
            invalidate() {
            ...
            _createDescriptors(t, e) {
                const i = t && t.config,
                    ...
                    n = function(t) {
                        ...
                        for (let t = 0; t < s.length; t++) i.push($s.getPlugin(s[t]));
                        const n = t.plugins || [];
                        for (let t = 0; t < n.length; t++) {
        ...
        function Js(t) {
            ...
            e.plugins = B(e.plugins, {}), e.scales = function(t, e) {
                const i = Zt[t.type] || {
                        scales: {}
                    },
                    s = e.scales || {},
                ...
                return Object.keys(s).forEach((e => {
                    const a = s[e];
                    if (!z(a)) return console.error(`Invalid scale configuration for scale: ${e}`);
                    if (a._proxy) return console.warn(`Ignoring resolver passed as options for scale: ${e}`);
                    const r = Gs(e, a, function(t, e) {
                            if (e.data && e.data.datasets) {
                                const i = e.data.datasets.filter((e => e.xAxisID === t || e.yAxisID === t));
                                if (i.length) return Zs(t, "x", i[0]) || Zs(t, "y", i[0])
                            }
                            return {}
                        }(e, t), ie.scales[a.type]),
                        l = function(t, e) {
                    ...
                    Object.keys(r).forEach((t => {
                        const e = function(t, e) {
                            ...
                            n = i[e + "AxisID"] || e;
                        o[n] = o[n] || Object.create(null), q(o[n], [{
                            axis: e
                        }, s[n], r[t]])
                    }))
        ...
        class on {
            ...
            getOptionScopes(t, e, i) {
                ...
                const r = new Set;
                e.forEach((e => {
                    t && (r.add(t), e.forEach((e => nn(r, t, e)))), e.forEach((t => nn(r, s, t))), e.forEach((t => nn(r, Zt[n] || {}, t))), e.forEach((t => nn(r, ie, t))), e.forEach((t => nn(r, Jt, t)))
                }));
            ...
            resolveNamedOptions(t, e, i, s = [""]) {
                ...
                (function(t, e) {
                    ...
                    return !1
                })(o, e) && (n.$shared = !1, r = Ae(o, i = tt(i) ? i() : i, this.createResolver(t, i, a)));
        ...
        const rn = t => z(t) && Object.getOwnPropertyNames(t).some((e => tt(t[e]))),
        ...
        class xn {
            ...
            constructor(t, e) {
                ...
                this.platform = new(i.platform || function(t) {
                    return !Ke() || "undefined" != typeof OffscreenCanvas && t instanceof OffscreenCanvas ? ms : Ts
                }(s)), this.platform.updateConfig(i);
                const a = this.platform.acquireContext(s, o.aspectRatio),
                    r = a && a.canvas,
                    l = r && r.height,
                    h = r && r.width;
                this.id = E(), this.ctx = a, this.canvas = r, this.width = h, this.height = l, this._options = o, this._aspectRatio = this.aspectRatio, this._layers = [], this._metasets = [], this._stacks = void 0, this.boxes = [], this.currentDevicePixelRatio = void 0, this.chartArea = void 0, this._active = [], this._lastEvent = void 0, this._listeners = {}, this._responsiveListeners = void 0, this._sortedMetasets = [], this.scales = {}, this._plugins = new Ys, this.$proxies = {}, this._hiddenIndices = {}, this.attached = !1, this._animationsDisabled = void 0, this.$context = void 0, this._doResize = function(t, e) {
                    let i;
                    return function(...s) {
                        return e ? (clearTimeout(i), i = setTimeout(t, e, s)) : t.apply(this, s), e
                    }
                }((t => this.update(t)), o.resizeDelay || 0), this._dataChanges = [], gn[this.id] = this, a && r ? (yi.listen(this, "complete", dn), yi.listen(this, "progress", un), this._initialize(), this.attached && this.update()) : console.error("Failed to create chart: can't acquire context from the given item")
            }
            get aspectRatio() {
                const {
                    options: {
            ...
            resize(t, e) {
                yi.running(this) ? this._resizeBeforeDraw = {
                    width: t,
                    height: e
                } : this._resize(t, e)
            }
            _resize(t, e) {
                ...
                this.width = o.width, this.height = o.height, this._aspectRatio = this.aspectRatio, ni(this, a, !0) && (this.notifyPlugins("resize", {
                    size: o
                }), N(i.onResize, [this, o], this), this.attached && this._doResize(r) && this.render())
            }
            ensureScalesHaveIDs() {
            ...
            buildOrUpdateScales() {
                ...
                e && (n = n.concat(Object.keys(e).map((t => {
                    ...
                    let l = null;
                    o in i && i[o].type === r ? l = i[o] : (l = new($s.getScale(r))({
                        id: o,
                        type: r,
                        ctx: this.ctx,
                        chart: this
            ...
            buildOrUpdateControllers() {
                ...
                for (this._removeUnreferencedMetasets(), i = 0, s = e.length; i < s; i++) {
                    ...
                    if (n.type && n.type !== o && (this._destroyDatasetMeta(i), n = this.getDatasetMeta(i)), n.type = o, n.indexAxis = s.indexAxis || qs(o, this.options), n.order = s.order || 0, n.index = i, n.label = "" + s.label, n.visible = this.isDatasetVisible(i), n.controller) n.controller.updateIndex(i), n.controller.linkScales();
                    else {
            ...
            update(t) {
                ...
                o = this._minPadding = i.layout.autoPadding ? o : 0, this._updateLayout(o), s || H(n, (t => {
                    t.reset()
            ...
            _updateDatasets(t) {
                if (!1 !== this.notifyPlugins("beforeDatasetsUpdate", {
                    ...
                    for (let e = 0, i = this.data.datasets.length; e < i; ++e) this._updateDataset(e, tt(t) ? t({
                        datasetIndex: e
                    }) : t);
            ...
            render() {
                !1 !== this.notifyPlugins("beforeRender", {
                    cancelable: !0
                }) && (yi.has(this) ? this.attached && !yi.running(this) && yi.start(this) : (this.draw(), dn({
                    chart: this
                })))
            }
            draw() {
            ...
            _updateVisibility(t, e, i) {
                ...
                Q(e) ? (n.data[e].hidden = !i, this.update()) : (this.setDatasetVisibility(t, i), o.update(n, {
                    visible: i
            ...
            _stop() {
                let t, e;
                for (this.stop(), yi.remove(this), t = 0, e = this.data.datasets.length; t < e; ++t) this._destroyDatasetMeta(t)
            }
            destroy() {
                ...
                this._stop(), this.config.clearCache(), t && (this.unbindEvents(), ae(t, e), this.platform.releaseContext(e), this.canvas = null, this.ctx = null), delete gn[this.id], this.notifyPlugins("afterDestroy")
            }
            toBase64Image(...t) {
            ...
            setActiveElements(t) {
                ...
                !j(i, e) && (this._active = i, this._lastEvent = null, this._updateHoverStyles(i, e))
            }
            notifyPlugins(t, e, i) {
            ...
            _handleEvent(t, e, i) {
                ...
                i && (this._lastEvent = null, N(n.onHover, [t, a, this], this), r && N(n.onClick, [t, a, this], this));
                const h = !j(a, s);
        ...
        function _n() {
            return H(xn.instances, (t => t._plugins.invalidate()))
        }
        ...
        function vn(t, e, i, s, n, o) {
            ...
            const p = (g - Math.max(.001, g * d - i / it) / d) / 2,
                m = l + p + f,
                b = n - p - f,
                {
                    outerStart: x,
                    ...
                    const n = Me(t.options.borderRadius, ["outerStart", "outerEnd", "innerStart", "innerEnd"]),
                        o = (i - e) / 2,
                        a = Math.min(o, s * e / 2),
                        r = t => {
        ...
        function Mn(t, e, i = e) {
            t.lineCap = B(i.borderCapStyle, e.borderCapStyle), t.setLineDash(B(i.borderDash, e.borderDash)), t.lineDashOffset = B(i.borderDashOffset, e.borderDashOffset), t.lineJoin = B(i.borderJoinStyle, e.borderJoinStyle), t.lineWidth = B(i.borderWidth, e.borderWidth), t.strokeStyle = B(i.borderColor, e.borderColor)
        }
        ...
        function Sn(t, e, i, s) {
            const {
                ...
                loop: l,
                ilen: h
            } = kn(n, i, s), c = function(t) {
                return t.stepped ? ue : t.tension || "monotone" === t.cubicInterpolationMode ? fe : wn
            }(o);
            let d, u, f, {
                move: g = !0,
                reverse: p
        ...
        function Dn(t) {
            ...
            return t._decimated || t._loop || e.tension || "monotone" === e.cubicInterpolationMode || e.stepped || i ? Sn : Pn
        }
        ...
        class Cn extends Ls {
                            ...
                            for (const t of e) {
                                ...
                                for (u = d + 1; u <= t.end; u++) {
                                    ...
                                    e = bi(s.setContext(Oe(n, {
                                        ...
                                        p1DataIndex: u % l,
                                        datasetIndex: a
                                    }))), xi(e, c) && f(d, u - 1, t.loop, c), o = r, c = e
                                }
            ...
            interpolate(t, e) {
                ...
                const a = [],
                    r = function(t) {
                        return t.stepped ? li : t.tension || "monotone" === t.cubicInterpolationMode ? hi : ri
                    }(i);
                let l, h;
            ...
            draw(t, e, i, s) {
                ...
                (this.points || []).length && n.borderWidth && (t.save(), function(t, e, i, s) {
                    On && !e.options.segment ? function(t, e, i, s) {
                        let n = e._path;
                        n || (n = e._path = new Path2D, e.path(n, i, s) && n.closePath()), Mn(t, e.options), t.stroke(n)
                    }(t, e, i, s) : function(t, e, i, s) {
                        const {
                            segments: n,
                            options: o
                        } = e, a = Dn(e);
                        for (const r of n) Mn(t, o, r.style), t.beginPath(), a(t, e, r, {
                            start: i,
                            end: i + s - 1
        ...
        function En(t, e, i, s) {
            const n = null === e,
                o = null === i,
                a = t && !(n && o) && Tn(t, s);
            return a && (n || St(e, a.left, a.right)) && (o || St(i, a.top, a.bottom))
        }
        ...
        var zn = Object.freeze({
            ...
            ArcElement: class extends Ls {
                ...
                draw(t) {
                    ...
                    if (this.pixelMargin = "inner" === e.borderAlign ? .33 : 0, this.fullCircles = i > st ? Math.floor(i / st) : 0, 0 === i || this.innerRadius < 0 || this.outerRadius < 0) return;
                    t.save();
                    ...
                    t.fillStyle = e.backgroundColor, t.strokeStyle = e.borderColor,
                        ...
                        function(t, e, i, s, n) {
                            ...
                            f && function(t, e, i) {
                                ...
                                let h = n / r;
                                t.beginPath(), t.arc(o, a, r, s - h, i + h), l > n ? (h = n / l, t.arc(o, a, l, i + h, s - h, !0)) : t.arc(o, a, n, i + rt, s - rt), t.closePath(), t.clip()
                            }(t, e, g), o || (vn(t, e, i, s, g, n), t.stroke())
                        }(t, this, r, n, o), t.restore()
                }
            },
            BarElement: class extends Ls {
                ...
                draw(t) {
                    const {
                        ...
                        const e = Tn(t),
                            ...
                            o = function(t, e, i) {
                                ...
                                } = t.getProps(["enableBorderRadius"]), n = t.options.borderRadius, o = ke(n), a = Math.min(e, i), r = t.borderSkipped, l = s || z(n);
                                return {
                                    topLeft: Ln(!l || r.top || r.left, o.topLeft, 0, a),
                                    topRight: Ln(!l || r.top || r.right, o.topRight, 0, a),
                                    bottomLeft: Ln(!l || r.bottom || r.left, o.bottomLeft, 0, a),
                                    bottomRight: Ln(!l || r.bottom || r.right, o.bottomRight, 0, a)
                                }
                            }(t, i / 2, s / 2);
                        return {
                            outer: {
                    ...
                    }(this), a = (r = o.radius).topLeft || r.topRight || r.bottomLeft || r.bottomRight ? be : Rn;
                    var r;
                    t.save(), o.w === n.w && o.h === n.h || (t.beginPath(), a(t, In(o, e, n)), t.clip(), a(t, In(n, -e, o)), t.fillStyle = i, t.fill("evenodd")), t.beginPath(), a(t, In(n, e)), t.fillStyle = s, t.fill(), t.restore()
                }
                inRange(t, e, i) {
        ...
        const Fn = ["rgb(54, 162, 235)", "rgb(255, 99, 132)", "rgb(255, 159, 64)", "rgb(255, 205, 86)", "rgb(75, 192, 192)", "rgb(153, 102, 255)", "rgb(201, 203, 207)"],
            Vn = Fn.map((t => t.replace("rgb(", "rgba(").replace(")", ", 0.5)")));
        ...
        var Hn = {
            ...
            beforeLayout(t, e, i) {
                ...
                if (!i.forceOverride && (Nn(s) || (a = n) && (a.borderColor || a.backgroundColor) || o && Nn(o))) return;
                var a;
                const r = function(t) {
                    let e = 0;
                    return (i, s) => {
                        const n = t.getDatasetMeta(s).controller;
                        n instanceof Yi ? e = function(t, e) {
                            return t.backgroundColor = t.data.map((() => Bn(e++))), e
                        }(i, e) : n instanceof Ui ? e = function(t, e) {
                            return t.backgroundColor = t.data.map((() => Wn(e++))), e
                        }(i, e) : n && (e = function(t, e) {
                            return t.borderColor = Bn(e), t.backgroundColor = Wn(e), ++e
                        }(i, e))
                    }
                }(t);
                s.forEach(r)
            ...
            beforeElementsUpdate: (t, e, i) => {
                ...
                t.data.datasets.forEach(((e, n) => {
                    ...
                    let c, {
                        ...
                        return l && (n = kt(Dt(e, o.axis, a).lo, 0, i - 1)), s = h ? kt(Dt(e, o.axis, r).hi + 1, n, i) - n : i - n, {
                            start: n,
                            count: s
                        }
                    }(r, l);
                    if (u <= (i.threshold || 4 * s)) jn(e);
                    else {
                        switch (R(o) && (e._data = l, delete e.data, Object.defineProperty(e, "data", {
                            configurable: !0,
                            enumerable: !0,
                            get: function() {
        ...
        function Kn(t, e) {
            let i = [],
                s = !1;
            return I(t) ? (s = !0, i = t) : i = function(t, e) {
                const {
                    x: i = null,
                    y: s = null
                } = t || {}, n = e.points, o = [];
        ...
        function Jn(t, e, i) {
            ...
            let n = parseFloat(s);
            return F(n) && Math.floor(n) === n ? function(t, e, i, s) {
        ...
        function io(t, e, i) {
            const s = function(t) {
                    ...
                    const n = function(t) {
                        return (t.scale || {}).getPointPositionForValue ? function(t) {
                            const {
                                ...
                                let s;
                                return s = "start" === t ? i : "end" === t ? e.options.reverse ? e.min : e.max : z(t) ? t.value : e.getBaseValue(), s
                            }(i, e, o), r = [];
                            if (s.grid.circular) {
                            ...
                            const {
                                ...
                                let i = null;
                                return "start" === t ? i = e.bottom : "end" === t ? i = e.top : z(t) ? i = e.getPixelForValue(t.value) : e.getBasePixel && (i = e.getBasePixel()), i
                            }(i, e);
                            if (F(s)) {
                    ...
                    return n instanceof eo ? n : Kn(n, s)
                }(e),
                {
                    line: n,
                    scale: o,
            ...
            s && n.points.length && (ce(t, i), function(t, e) {
                ...
                t.save(), "x" === l && o !== n && (so(t, s, a.top), no(t, {
                    line: i,
                    target: s,
                    color: n,
                    scale: r,
                    property: l
                }), t.restore(), t.save(), so(t, s, a.bottom)), no(t, {
                    line: i,
                    target: s,
                    color: o,
                    scale: r,
        ...
        function no(t, e) {
            const {
                ...
                for (const t of s) {
                    ...
                    const h = mi(e, l);
                    for (const e of h) {
                        const s = Un(i, o[e.start], o[e.end], e.loop),
                            r = pi(t, n, s);
                        for (const t of r) a.push({
                            source: t,
                            target: e,
                            start: {
                                [i]: qn(l, s, "start", Math.max)
                            },
                            end: {
                                [i]: qn(l, s, "end", Math.min)
                            }
                        })
                    }
                }
            ...
            for (const {
                ...
                t.save(), t.fillStyle = r, oo(t, a, d && Un(n, h, c)), t.beginPath();
        ...
        var ro = {
            ...
            afterDatasetsUpdate(t, e, i) {
                const s = (t.data.datasets || []).length,
                    n = [];
                let o, a, r, l;
                for (a = 0; a < s; ++a) o = t.getDatasetMeta(a), r = o.dataset, l = null, r && r.options && r instanceof Cn && (l = {
                ...
                for (a = 0; a < s; ++a) l = n[a], l && !1 !== l.fill && (l.fill = Zn(n, a, i.propagate))
            },
            beforeDraw(t, e, i) {
                ...
                for (let e = n.length - 1; e >= 0; --e) {
                    const i = n[e].$filler;
                    i && (i.line.updateControlPoints(o, i.axis), s && i.fill && io(t.ctx, i, o))
                }
            },
            beforeDatasetsDraw(t, e, i) {
                ...
                for (let e = s.length - 1; e >= 0; --e) {
                    const i = s[e].$filler;
                    Gn(i) && io(t.ctx, i, t.chartArea)
                }
            },
            beforeDatasetDraw(t, e, i) {
                const s = e.meta.$filler;
                Gn(s) && "beforeDatasetDraw" === i.drawTime && io(t.ctx, s, t.chartArea)
            },
            defaults: {
                propagate: !0,
        ...
        class ho extends Ls {
                ...
                return this.legendItems.forEach(((t, o) => {
                    const {
                        ...
                        const o = function(t, e, i, s) {
                            ...
                            a = function(t, e, i) {
                                let s = t;
                                return "string" != typeof e.text && (s = co(e, i)), s
                            }(n, s, e.lineHeight);
                        return {
                            itemWidth: o,
                            itemHeight: a
            ...
            adjustHitBoxes() {
                ...
                if (this.isHorizontal()) {
                    ...
                    for (const r of e) n !== r.row && (n = r.row, a = It(i, this.left + s, this.right - this.lineWidths[n])), r.top += this.top + t + s, r.left = o.leftForLtr(o.x(a), r.width), a += r.width + s
                } else {
                    let n = 0,
                        a = It(i, this.top + t + s, this.bottom - this.columnSizes[n].height);
                    for (const r of e) r.col !== n && (n = r.col, a = It(i, this.top + t + s, this.bottom - this.columnSizes[n].height)), r.top = a, r.left += this.left + s, r.left = o.leftForLtr(o.x(r.left), r.width), a += r.height + s
                }
            }
            isHorizontal() {
            ...
            _draw() {
                const {
                    ...
                    align: n,
                    labels: o
                } = t, a = ie.color, r = ci(t.rtl, this.left, this.width), l = Pe(o.font), {
                    padding: h
                } = o, c = l.size, d = c / 2;
                let u;
                ...
                const {
                    ...
                    boxHeight: g,
                    itemHeight: p
                } = lo(o, c), m = this.isHorizontal(), b = this._computeTitleHeight();
                u = m ? {
                ...
                this.legendItems.forEach(((_, y) => {
                    ...
                    let k = u.x,
                        S = u.y;
                    if (r.setWidth(this.width), m ? y > 0 && k + w + h > this.right && (S = u.y += x, u.line++, k = u.x = It(n, this.left + h, this.right - i[u.line])) : y > 0 && S + x > this.bottom && (k = u.x = k + e[u.line].width + h, u.line++, S = u.y = It(n, this.top + b + h, this.bottom - e[u.line].height)), function(t, e, i) {
                            if (isNaN(f) || f <= 0 || isNaN(g) || g < 0) return;
                            s.save();
                            const n = B(i.lineWidth, 1);
                            if (s.fillStyle = B(i.fillStyle, a), s.lineCap = B(i.lineCap, "butt"), s.lineDashOffset = B(i.lineDashOffset, 0), s.lineJoin = B(i.lineJoin, "miter"), s.lineWidth = n, s.strokeStyle = B(i.strokeStyle, a), s.setLineDash(B(i.lineDash, [])), o.usePointStyle) {
                                const a = {
                                ...
                                const o = e + Math.max((c - g) / 2, 0),
                                    a = r.leftForLtr(t, f),
                                    l = ke(i.borderRadius);
                                s.beginPath(), Object.values(l).some((t => 0 !== t)) ? be(s, {
                                    x: a,
                                    y: o,
                                    w: f,
                                    h: g,
                                    radius: l
                                }) : s.rect(a, o, f, g), s.fill(), 0 !== n && s.stroke()
                            }
                            s.restore()
                        }(r.x(k), S, _), k = ((t, e, i, s) => t === (s ? "left" : "right") ? i : "center" === t ? (e + i) / 2 : e)(M, k + f + d, m ? k + w : this.right, t.rtl), function(t, e, i) {
            ...
            drawTitle() {
                ...
                let h, c = this.left,
                    d = this.width;
                if (this.isHorizontal()) d = Math.max(...this.lineWidths), h = this.top + l, c = It(t.align, c, this.right - d);
                else {
                    const e = this.columnSizes.reduce(((t, e) => Math.max(t, e.height)), 0);
                    h = l + It(t.align, this.top, this.bottom - e - t.labels.padding - this._computeTitleHeight())
                }
                const u = It(a, c, c + d);
                o.textAlign = n.textAlign(Rt(a)), o.textBaseline = "middle", o.strokeStyle = e.color, o.fillStyle = e.color, o.font = i.string, me(o, e.text, u, h, i)
            }
            _computeTitleHeight() {
            ...
            _getLegendItemAt(t, e) {
                let i, s, n;
                if (St(t, this.left, this.right) && St(e, this.top, this.bottom))
                    for (n = this.legendHitBoxes, i = 0; i < n.length; ++i)
                        if (s = n[i], St(t, s.left, s.left + s.width) && St(e, s.top, s.top + s.height)) return this.legendItems[i];
                return null
            }
            handleEvent(t) {
                ...
                if ("mousemove" === t.type || "mouseout" === t.type) {
                    ...
                    o && !a && N(e.onLeave, [t, o, this], this), this._hoveredItem = i, i && !a && N(e.onHover, [t, i, this], this)
        ...
        class fo extends Ls {
            ...
            _drawArgs(t) {
                ...
                let r, l, h, c = 0;
                return this.isHorizontal() ? (l = It(a, i, n), h = e + t, r = n - i) : ("left" === o.position ? (l = i + t, h = It(a, s, e), c = -.5 * it) : (l = n - t, h = It(a, e, s), c = .5 * it), r = s - e), {
                    titleX: l,
                    titleY: h,
                    maxWidth: r,
                    rotation: c
        ...
        var mo = {
            ...
            start(t, e, i) {
                ...
                gs.configure(t, s, i), gs.addBox(t, s), po.set(t, s)
            },
            stop(t) {
                gs.removeBox(t, po.get(t)), po.delete(t)
            },
            beforeUpdate(t, e, i) {
                const s = po.get(t);
                gs.configure(t, s, i), s.options = i
        ...
        function vo(t, e) {
            ...
            return i.save(), i.font = h.string, H(t.title, _), i.font = l.string, H(t.beforeBody.concat(t.afterBody), _), x = e.displayColors ? a + 2 + e.boxPadding : 0, H(s, (t => {
                H(t.before, _), H(t.lines, _), H(t.after, _)
            })), x = 0, i.font = c.string, H(t.footer, _), i.restore(), m += g.width, {
                width: m,
                height: p
            }
        }
        ...
        function Co(t, e, i, s) {
            ...
            return void 0 === n ? Oo[e].call(i, s) : n
        }
        class Ao extends Ls {
            static positioners = bo;
            constructor(t) {
            ...
            getTitle(t, e) {
                const {
                    callbacks: i
                } = e, s = Co(i, "beforeTitle", this, t), n = Co(i, "title", this, t), o = Co(i, "afterTitle", this, t);
                let a = [];
                return a = xo(a, _o(s)), a = xo(a, _o(n)), a = xo(a, _o(o)), a
            }
            getBeforeBody(t, e) {
                return Po(Co(e.callbacks, "beforeBody", this, t))
            }
            getBody(t, e) {
                const {
                    callbacks: i
                ...
                return H(t, (t => {
                    const e = {
                        ...
                        n = Do(i, t);
                    xo(e.before, _o(Co(n, "beforeLabel", this, t))), xo(e.lines, Co(n, "label", this, t)), xo(e.after, _o(Co(n, "afterLabel", this, t))), s.push(e)
                })), s
            }
            getAfterBody(t, e) {
                return Po(Co(e.callbacks, "afterBody", this, t))
            }
            getFooter(t, e) {
                const {
                    callbacks: i
                } = e, s = Co(i, "beforeFooter", this, t), n = Co(i, "footer", this, t), o = Co(i, "afterFooter", this, t);
                let a = [];
                return a = xo(a, _o(s)), a = xo(a, _o(n)), a = xo(a, _o(o)), a
            }
            _createItems(t) {
                ...
                return t.filter && (l = l.filter(((e, s, n) => t.filter(e, s, n, i)))), t.itemSort && (l = l.sort(((e, s) => t.itemSort(e, s, i)))), H(l, (e => {
                    const i = Do(t.callbacks, e);
                    s.push(Co(i, "labelColor", this, e)), n.push(Co(i, "labelPointStyle", this, e)), o.push(Co(i, "labelTextColor", this, e))
            ...
            drawTitle(t, e, i) {
                ...
                if (n) {
                    ...
                    for (t.x = So(this, i.titleAlign, i), e.textAlign = l.textAlign(i.titleAlign), e.textBaseline = "middle", o = Pe(i.titleFont), a = i.titleSpacing, e.fillStyle = i.titleColor, e.font = o.string, r = 0; r < n; ++r) e.fillText(s[r], l.x(t.x), t.y + o.lineHeight / 2), t.y += o.lineHeight + a, r + 1 === n && (t.y += i.titleMarginBottom - a)
                }
            }
            _drawColorBox(t, e, i, s, n) {
                ...
                if (n.usePointStyle) {
                    ...
                    const e = s.leftForLtr(d, l),
                        ...
                        a = ke(o.borderRadius);
                    Object.values(a).some((t => 0 !== t)) ? (t.beginPath(), t.fillStyle = n.multiKeyBackground, be(t, {
                        x: e,
                        y: f,
                        w: l,
                        h: r,
                        radius: a
                    }), t.fill(), t.stroke(), t.fillStyle = o.backgroundColor, t.beginPath(), be(t, {
                        x: i,
                        y: f + 1,
                        w: l - 2,
                        h: r - 2,
                        radius: a
                    }), t.fill()) : (t.fillStyle = n.multiKeyBackground, t.fillRect(e, f, l, r), t.strokeRect(e, f, l, r), t.fillStyle = o.backgroundColor, t.fillRect(i, f + 1, l - 2, r - 2))
                }
            ...
            drawBody(t, e, i) {
                ...
                const f = ci(i.rtl, this.x, this.width),
                    ...
                    p = f.textAlign(o);
                let m, b, x, _, y, v, M;
                for (e.textAlign = o, e.textBaseline = "middle", e.font = c.string, t.x = So(this, p, i), e.fillStyle = i.bodyColor, H(this.beforeBody, g), u = a && "right" !== p ? "center" === o ? l / 2 + h : l + 2 + h : 0, _ = 0, v = s.length; _ < v; ++_) {
                    for (m = s[_], b = this.labelTextColors[_], e.fillStyle = b, H(m.before, g), x = m.lines, a && x.length && (this._drawColorBox(e, t, _, f, i), d = Math.max(c.lineHeight, r)), y = 0, M = x.length; y < M; ++y) g(x[y]), d = c.lineHeight;
                    H(m.after, g)
                }
            ...
            drawFooter(t, e, i) {
                ...
                if (n) {
                    ...
                    for (t.x = So(this, i.footerAlign, i), t.y += i.footerMarginTop, e.textAlign = r.textAlign(i.footerAlign), e.textBaseline = "middle", o = Pe(i.footerFont), e.fillStyle = i.footerColor, e.font = o.string, a = 0; a < n; ++a) e.fillText(s[a], r.x(t.x), t.y + o.lineHeight / 2), t.y += o.lineHeight + i.footerSpacing
                }
            }
            ...
            draw(t) {
                ...
                e.enabled && a && (t.save(), t.globalAlpha = i, this.drawBackground(n, t, s, e), di(t, e.textDirection), n.y += o.top, this.drawTitle(n, t, e), this.drawBody(n, t, e), this.drawFooter(n, t, e), ui(t, e.textDirection), t.restore())
            }
            getActiveElements() {
                return this._active || []
            }
            ...
            buildTicks() {
                ...
                const s = function(t, e) {
                    const i = [],
                        ...
                        x = !R(l),
                        _ = (p - g) / (c + 1);
                    let y, v, M, w, k = ft((p - g) / f / u) * u;
                    if (k < 1e-14 && !m && !b) return [{
                        value: g
                    }, {
                        value: p
                    }];
                    w = Math.ceil(p / k) - Math.floor(g / k), w > f && (k = ft(w * k / f / u) * u), R(r) || (y = Math.pow(10, r), k = Math.ceil(k * y) / y), "ticks" === s ? (v = Math.floor(g / k) * k, M = Math.ceil(p / k) * k) : (v = g, M = p), m && b && n && function(t, e) {
                        const i = Math.round(t);
                        return i - e <= t && i + e >= t
                    }((a - o) / n, k / 1e3) ? (w = Math.round(Math.min((a - o) / k, h)), k = (a - o) / w, v = o, M = a) : x ? (v = m ? o : v, M = b ? a : M, w = l - 1, k = (M - v) / w) : (w = (M - v) / k, w = ut(w, Math.round(w), k / 1e3) ? Math.round(w) : Math.ceil(w));
                    const S = Math.max(xt(k), xt(v));
                    y = Math.pow(10, R(r) ? S : r), v = Math.round(v * y) / y, M = Math.round(M * y) / y;
                    let P = 0;
                    for (m && (d && v !== o ? (i.push({
                            value: o
                        }), v < o && P++, ut(Math.round((v + P * k) * y) / y, o, Ro(o, _, t)) && P++) : v < o && P++); P < w; ++P) {
                    ...
                    return b && d && M !== a ? i.length && ut(i[i.length - 1].value, a, Ro(a, _, t)) ? i[i.length - 1].value = a : i.push({
                        value: a
                    }) : b && M !== a || i.push({
                        value: M
                    }), i
                ...
                return "ticks" === t.bounds && pt(s, this, "value"), t.reverse ? (s.reverse(), this.start = this.max, this.end = this.min) : (this.start = this.min, this.end = this.max), s
            }
            configure() {
                const t = this.ticks;
                let e = this.min,
        ...
        const Fo = t => Math.floor(ct(t)),
            Vo = (t, e) => Math.pow(10, Fo(t) + e);

        function Bo(t) {
            return 1 == t / Math.pow(10, Fo(t))
        }
        ...
        class No extends Ns {
            ...
            parse(t, e) {
                const i = Io.prototype.parse.apply(this, [t, e]);
            ...
            determineDataLimits() {
                ...
                this.min = F(t) ? Math.max(0, t) : null, this.max = F(e) ? Math.max(0, e) : null, this.options.beginAtZero && (this._zero = !0), this._zero && this.min !== this._suggestedMin && !F(this._userMin) && (this.min = t === Vo(this.min, 0) ? Vo(this.min, -1) : Vo(this.min, 0)), this.handleTickRangeOptions()
            }
            handleTickRangeOptions() {
                const {
                    minDefined: t,
            ...
            buildTicks() {
                const t = this.options,
                    e = function(t, {
                        ...
                        let d = Math.floor((h - c) / Math.pow(10, o)),
                            u = V(t.min, Math.round((l + c + d * Math.pow(10, o)) * a) / a);
                        for (; u < i;) s.push({
                            value: u,
                            major: Bo(u),
                            significand: d
                        }), d >= 10 ? d = d < 15 ? 15 : 20 : d++, d >= 20 && (o++, d = 2, a = o >= 0 ? 1 : a), u = Math.round((l + c + d * Math.pow(10, o)) * a) / a;
                        const f = V(t.max, u);
                        return s.push({
                            value: f,
                            major: Bo(f),
                ...
                return "ticks" === t.bounds && pt(e, this, "value"), t.reverse ? (e.reverse(), this.start = this.max, this.end = this.min) : (this.start = this.min, this.end = this.max), e
            }
            getLabelForValue(t) {
            ...
            getPixelForValue(t) {
                return void 0 !== t && 0 !== t || (t = this.min), null === t || isNaN(t) ? NaN : this.getPixelForDecimal(t === this.min ? 0 : (ct(t) - this._startValue) / this._valueRange)
            }
            getValueForPixel(t) {
        ...
        function Yo(t, e, i) {
            const s = t.drawingArea,
                ...
                u = (f = l.x, g = r.w, "right" === (p = d) ? f -= g : "center" === p && (f -= g / 2), f);
            var f, g, p;
            return {
                visible: !0,
                x: l.x,
        ...
        function Xo(t, e, i) {
            ...
            if (!R(r)) {
                ...
                const h = s - l.left,
                    ...
                    d = o - s + l.width,
                    u = a - n + l.height;
                Object.values(i).some((t => 0 !== t)) ? (t.beginPath(), be(t, {
                    x: h,
                    y: c,
                    w: d,
                    h: u,
        ...
        class Ko extends Io {
            ...
            setDimensions() {
                const t = this._padding = Se(Ho(this.options) / 2),
            ...
            generateTickLabels(t) {
                Io.prototype.generateTickLabels.call(this, t), this._pointLabels = this.getLabels().map(((t, e) => {
                    const i = N(this.options.pointLabels.callback, [t, e], this);
                    return i || 0 === i ? i : ""
                ...
                t.display && t.pointLabels.display ? function(t) {
                    ...
                    for (let d = 0; d < o; d++) {
                        ...
                        const u = t.getPointPosition(d, t.drawingArea + n[d], r),
                            f = Pe(o.font),
                            g = (l = t.ctx, h = f, c = I(c = t._pointLabels[d]) ? c : [c], {
                                w: ne(l, h.string, c),
                        ...
                        const p = Mt(t.getIndexAngle(d) + r),
                            m = Math.round(bt(p));
                        $o(i, e, p, jo(m, u.x, g.w, 0, 180), jo(m, u.y, g.h, 90, 270))
                    }
                    var l, h, c;
                    t.setCenterPoint(e.l - i.l, i.r - e.r, e.t - i.t, i.b - e.b), t._pointLabelItems = function(t, e, i) {
                        ...
                        for (let o = 0; o < n; o++) {
                            ...
                            const n = Yo(t, o, l);
                            s.push(n), "auto" === r && (n.visible = Uo(n, h), n.visible && (h = n))
                        }
                        return s
                    }(t, s, n)
            ...
            getIndexAngle(t) {
                return Mt(t * (st / (this._pointLabels.length || 1)) + mt(this.options.startAngle || 0))
            }
            ...
            drawBackground() {
                ...
                if (t) {
                    const i = this.ctx;
                    i.save(), i.beginPath(), qo(this, this.getDistanceFromCenterForValue(this._endValue), e, this._pointLabels.length), i.closePath(), i.fillStyle = t, i.fill(), i.restore()
                }
            }
            drawGrid() {
                const t = this.ctx,
                ...
                if (e.pointLabels.display && function(t, e) {
                        ...
                        for (let n = e - 1; n >= 0; n--) {
                            ...
                            me(i, t._pointLabels[n], r, l + a.lineHeight / 2, a, {
                                color: o.color,
                                textAlign: h,
                                textBaseline: "middle"
                            })
                        ...
                        if (0 !== e || 0 === e && this.min < 0) {
                            ...
                            ! function(t, e, i, s, n) {
                                ...
                                !a && !s || !r || !l || i < 0 || (o.save(), o.strokeStyle = r, o.lineWidth = l, o.setLineDash(n.dash), o.lineDashOffset = n.dashOffset, o.beginPath(), qo(t, i, a, s), o.closePath(), o.stroke(), o.restore())
                            }(this, a, r, o, l)
                        }
                    })), i.display) {
        ...
        function Qo(t, e) {
            ...
            let a = e;
            return "function" == typeof s && (a = s(a)), F(a) || (a = "string" == typeof s ? i.parse(a, s) : i.parse(a)), null === a ? null : (n && (a = "week" !== n || !gt(o) && !0 !== o ? i.startOf(a, n) : i.startOf(a, "isoWeek", o)), +a)
        }
        ...
        class sa extends Ns {
            ...
            init(t, e = {}) {
                ...
                s.init(e), q(i.displayFormats, s.formats()), this._parseOpts = {
                    parser: i.parser,
                    round: i.round,
            ...
            determineDataLimits() {
                ...
                o && a || (r(this._getLabelBounds()), "ticks" === t.bounds && "labels" === t.ticks.source || r(this.getMinMax(!1))), s = F(s) && !isNaN(s) ? s : +e.startOf(Date.now(), i), n = F(n) && !isNaN(n) ? n : +e.endOf(Date.now(), i) + 1, this.min = Math.min(s, n - 1), this.max = Math.max(s + 1, n)
            }
            _getLabelBounds() {
            ...
            buildTicks() {
                ...
                return this._unit = e.unit || (i.autoSkip ? ta(e.minUnit, this.min, this.max, this._getLabelCapacity(n)) : function(t, e, i, s, n) {
                    for (let o = Zo.length - 1; o >= Zo.indexOf(i); o--) {
                        const i = Zo[o];
                        if (Go[i].common && t._adapter.diff(n, s, i) >= e - 1) return i
                    }
                    ...
                    for (let e = Zo.indexOf(t) + 1, i = Zo.length; e < i; ++e)
                        if (Go[Zo[e]].common) return Zo[e]
                }(this._unit) : void 0, this.initOffsets(s), t.reverse && o.reverse(), ia(this, o, this._majorUnit)
            }
            afterAutoSkip() {
            ...
            initOffsets(t = []) {
                ...
                s = kt(s, 0, o), n = kt(n, 0, o), this._offsets = {
                    start: s,
                    end: n,
                    factor: 1 / (s + 1 + n)
                }
            ...
            _generate() {
                const t = this._adapter,
                    ...
                    s = this.options,
                    n = s.time,
                    o = n.unit || ta(n.minUnit, e, i, this._getLabelCapacity(e)),
                ...
                for (c = u, d = 0; c < i; c = +t.add(c, a, o), d++) ea(h, c, f);
                return c !== i && "ticks" !== s.bounds && 1 !== d || ea(h, c, f), Object.keys(h).sort(Jo).map((t => +t))
            }
            getLabelForValue(t) {
            ...
            _getLabelCapacity(t) {
                const e = this.options.time,
                    ...
                    n = this._tickFormatFunction(t, 0, ia(this, [t], this._majorUnit), s),
            ...
            getLabelTimestamps() {
                ...
                for (e = 0, i = s.length; e < i; ++e) t.push(Qo(this, s[e]));
        ...
        var oa = Object.freeze({
            ...
            CategoryScale: class extends Ns {
                ...
                parse(t, e) {
                    ...
                    return ((t, e) => null === t ? null : kt(Math.round(t), 0, e))(e = isFinite(e) && i[e] === t ? e : function(t, e, i, s) {
                        const n = t.indexOf(e);
                        return -1 === n ? ((t, e, i, s) => ("string" == typeof e ? (i = t.push(e) - 1, s.unshift({
                            index: i,
                            label: e
                        })) : isNaN(e) && (i = null), i))(t, e, i, s) : n !== t.lastIndexOf(e) ? i : n
                    }(i, t, B(e, t), this._addedLabels), i.length - 1)
                }
                determineDataLimits() {
                    const {
                        minDefined: t,
            ...
            LinearScale: zo,
            LogarithmicScale: No,
            RadialLinearScale: Ko,
            TimeScale: sa,
            TimeSeriesScale: class extends sa {
                ...
                initOffsets() {
                    ...
                    this._minPos = na(e, this.min), this._tableRange = na(e, this.max) - this._minPos, super.initOffsets(t)
                }
                buildLookupTable(t) {
                    const {
                        min: e,
