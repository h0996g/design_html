                ...
                8764: function(t) {
                    t.exports = function() {
                        ...
                        var g = {},
                            ...
                            x = function(t, e) {
                                var n;
                                n = '"'.concat(t, '" is deprecated and will be removed in the next major release. Please use "').concat(e, '" instead.'), E.includes(n) || (E.push(n), P(n))
                            },
                            T = function(t) {
                            ...
                            et = function(t, e, n) {
                                if (function(t, e) {
                                    ...
                                    if ("string" != typeof e.customClass[n] && !e.customClass[n].forEach) return void P("Invalid type of customClass.".concat(n, '! Expected string or iterable object, got "').concat(r(e.customClass[n]), '"'));
                            ...
                            Ct = function(t) {
                                var e, n, o, i, r, a, c, u, s, l, d = !!(e = j()) && (e.remove(), at([document.documentElement, document.body], [w["no-backdrop"], w["toast-shown"], w["has-column"]]), !0);
                                if (bt()) B("SweetAlert2 requires document to initialize");
                                else {
                                    var f = document.createElement("div");
                                    f.className = w.container, d && rt(f, w["no-transition"]), Q(f, yt);
                                    ...
                                    p.appendChild(f),
                                        ...
                                        }(p), n = H(), o = ct(n, w.input), i = ct(n, w.file), r = n.querySelector(".".concat(w.range, " input")), a = n.querySelector(".".concat(w.range, " output")), c = ct(n, w.select), u = n.querySelector(".".concat(w.checkbox, " input")), s = ct(n, w.textarea), o.oninput = wt, i.onchange = wt, c.onchange = wt, u.onchange = wt, s.oninput = wt, r.oninput = function() {
                                            wt(), a.value = r.value
                                        }, r.onchange = function() {
                                            wt(), a.value = r.value
                                        }
                            ...
                            Et = function(t, e) {
                                ...
                                n && o && (e.showConfirmButton || e.showDenyButton || e.showCancelButton ? st(n) : lt(n), et(n, e, "actions"), function(t, e, n) {
                                    var o = F(),
                                        i = z(),
                                        r = U();
                                    o && i && r && (xt(o, "confirm", n), xt(i, "deny", n), xt(r, "cancel", n), function(t, e, n, o) {
                                        o.buttonsStyling ? (rt([t, e, n], w.styled), o.confirmButtonColor && (t.style.backgroundColor = o.confirmButtonColor, rt(t, w["default-outline"])), o.denyButtonColor && (e.style.backgroundColor = o.denyButtonColor, rt(e, w["default-outline"])), o.cancelButtonColor && (n.style.backgroundColor = o.cancelButtonColor, rt(n, w["default-outline"]))) : at([t, e, n], w.styled)
                        ...
                        var Tt = function(t, e) {
                            ...
                            n && (function(t, e) {
                                ...
                                e && (e in w ? rt(t, w[e]) : (P('The "position" parameter is not valid, defaulting to "center"'), rt(t, w.center)))
                        ...
                        var St = {
                            ...
                            Lt = function(t) {
                                if (t.input)
                                    ...
                                    } else B("Unexpected type of input! Expected ".concat(Object.keys(Vt).join(" | "), ', got "').concat(t.input, '"'))
                            },
                            jt = function(t, e) {
                                var n = nt(H(), t);
                                if (n)
                        ...
                        var _t = function(t, e) {
                                ...
                                (function(t, e) {
                                    ...
                                    function(t, e) {
                                        ...
                                        if (n) {
                                            ...
                                            o && 0 !== o.length && void 0 !== i ? (st(n), n.textContent = "", i >= o.length && P("Invalid currentProgressStep parameter, it should be less than progressSteps.length (currentProgressStep like JS arrays starts from 0)"), o.forEach((function(t, r) {
                                                var a = Kt(t);
                                    ...
                                    function(t, e) {
                                        ...
                                        if (o) {
                                            ...
                                            if (e.icon || e.iconHtml) {
                                                if (e.icon && -1 === Object.keys(C).indexOf(e.icon)) return B('Unknown icon! Expected "success", "error", "warning", "info" or "question", got "'.concat(e.icon, '"')), void lt(o);
                            ...
                            re = function(t, e, n) {
                                T(e.allowEscapeKey) && (t.preventDefault(), n(Jt.esc))
                            },
                            ae = {
                        ...
                        var ye = function(t) {
                            ...
                            Ce = function(t, e, n) {
                                var o = j(),
                                    i = Bt && ht(e);
                                "function" == typeof n.willClose && n.willClose(e), i ? Ae(t, e, o, n.returnFocus, n.didClose) : ve(t, o, n.returnFocus, n.didClose)
                            },
                            Ae = function(t, e, n, o, i) {
                                Bt && (g.swalCloseEventFinishedCallback = ve.bind(null, t, n, o, i), e.addEventListener(Bt, (function(t) {
                            ...
                            Pe = function(t) {
                                ...
                                if (e || new io, e = H()) {
                                    var n = W();
                                    G() ? lt(D()) : Be(e, t), st(n), e.setAttribute("data-loading", "true"), e.setAttribute("aria-busy", "true"), e.focus()
                                }
                            },
                            Be = function(t, e) {
                                var n = K(),
                            ...
                            Se = function(t, e) {
                                ...
                                if (n) {
                                    ...
                                    S(e.inputOptions) || L(e.inputOptions) ? (Pe(F()), O(e.inputOptions).then((function(e) {
                                        t.hideLoading(), o(e)
                            ...
                            Oe = function(t, e) {
                                ...
                                n && (lt(n), O(e.inputValue).then((function(o) {
                                    ...
                                    B("Error in inputValue promise: ".concat(e)), n.value = "", st(n), n.focus(), t.hideLoading()
                                })))
                            };
                        var Le = function t(e) {
                                var n = [];
                            ...
                            Ie = function(t, e) {
                                ...
                                } else B('The "input" parameter is needed to be set when using returnInputValueOn'.concat(k(e)))
                            },
                            He = function(t, e, n) {
                                var o = St.innerParams.get(t);
                            ...
                            De = function(t, e) {
                                ...
                                n.showLoaderOnDeny && Pe(z()), n.preDeny ? (t.isAwaitingPromise = !0, Promise.resolve().then((function() {
                                    return O(n.preDeny(e, n.validationMessage))
                                })).then((function(n) {
                                    !1 === n ? (t.hideLoading(), ye(t)) : t.close({
                                        isDenied: !0,
                                        value: void 0 === n ? e : n
                                    })
                                })).catch((function(e) {
                            ...
                            _e = function(t, e) {
                                var n = St.innerParams.get(t || Me);
                                n.showLoaderOnConfirm && Pe(), n.preConfirm ? (t.resetValidationMessage(), t.isAwaitingPromise = !0, Promise.resolve().then((function() {
                        ...
                        function un(t) {
                            ...
                            } else P("You're trying to update the closed or closing popup, that won't work. Use the update() method in preConfirm parameter or show a new popup.")
                        }
                        var sn = function(t) {
                            var e = {};
                        ...
                        var En, xn = function(t) {
                            ...
                            Tn = Object.freeze({
                                ...
                                bindClickHandler: function() {
                                    Bn[arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : "data-swal-template"] = this, Pn || (document.body.addEventListener("click", xn), Pn = !0)
                                },
                            ...
                            Nn = function t(e) {
                                ...
                                if (e.target === n && Bt) {
                                    var o = j();
                                    n.removeEventListener(Bt, t), o.style.overflowY = "auto"
                                }
                            },
                            Fn = function(t, e) {
                                Bt && ht(e) ? (t.style.overflowY = "hidden", e.addEventListener(Bt, Nn)) : t.style.overflowY = "auto"
                            },
                            Un = function(t, e, n) {
                                (function() {
                        ...
                        var Yn = new WeakMap,
                            Zn = function() {
                                return u((function e() {
                                    if (a(this, e), h(this, Yn, void 0), "undefined" != typeof window) {
                                        En = this;
                                        for (var n = arguments.length, o = new Array(n), i = 0; i < n; i++) o[i] = arguments[i];
                                        var r = Object.freeze(this.constructor.argsToParams(o));
                                        this.params = r, this.isAwaitingPromise = !1, c = Yn, u = this, s = this._main(En.params), c.set(t(c, u), s)
                                    }
                                    var c, u, s
                                }), [{
                                    key: "_main",
                                    value: function(t) {
                                        var e = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {};
                                        if (function(t) {
                                                for (var e in !1 === t.backdrop && t.allowOutsideClick && P('"allowOutsideClick" parameter requires `backdrop` parameter to be set to `true`'), t) rn(e), t.toast && an(e), cn(e)
                                            ...
                                            g.currentInstance._destroy(), o || n({
                                                isDismissed: !0
                                            }), X() && ce()
                                        }
                                        ...
                                        var r = Xn(En);
                                        return Zt(En, i), St.innerParams.set(En, i), $n(En, r, i)
                                    }
                                }, {
                                    key: "then",
                                    value: function(t) {
                            ...
                            $n = function(t, e, n) {
                                return new Promise((function(o, i) {
                                    ...
                                    ae.swalPromiseResolve.set(t, o), ae.swalPromiseReject.set(t, i), e.confirmButton.onclick = function() {
                                        ...
                                        function(t, e, n) {
                                            t.toast ? vn(t, e, n) : (bn(e), yn(e), wn(t, e, n))
                                        }(n, e, r),
                                        function(t, e, n) {
                                            Xt(t), e.toast || (t.keydownHandler = function(t) {
                                                return ee(e, t, n)
                                            }, t.keydownTarget = e.keydownListenerCapture ? window : H(), t.keydownListenerCapture = e.keydownListenerCapture, t.keydownTarget.addEventListener("keydown", t.keydownHandler, {
                                                capture: t.keydownListenerCapture
                                        ...
                                        function(t, e) {
                                            "select" === e.input || "radio" === e.input ? Se(t, e) : ["text", "email", "number", "tel", "textarea"].some((function(t) {
                                                return t === e.input
                                            })) && (S(e.inputValue) || L(e.inputValue)) && (Pe(F()), Oe(t, e))
                            ...
                            Jn = function(t, e) {
                                ...
                                return o.showClass = Object.assign({}, Xe.showClass, o.showClass), o.hideClass = Object.assign({}, Xe.hideClass, o.hideClass), !1 === o.animation && (o.showClass = {
