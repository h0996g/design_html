                    ...
                    t.exports = function() {
                        ...
                        var O = {
                            ...
                            render() {
                                var t, e, i = ((e = this.DOM.dropdown.cloneNode(!0)).style.cssText = "position:fixed; top:-9999px; opacity:0", document.body.appendChild(e), t = e.clientHeight, e.parentNode.removeChild(e), t),
                                    s = this.settings;
                                return "number" == typeof s.dropdown.enabled && s.dropdown.enabled >= 0 ? (this.DOM.scope.setAttribute("aria-expanded", !0), document.body.contains(this.DOM.dropdown) || (this.DOM.dropdown.classList.add(s.classNames.dropdownInital), this.dropdown.position(i), s.dropdown.appendTarget.appendChild(this.DOM.dropdown), setTimeout((() => this.DOM.dropdown.classList.remove(s.classNames.dropdownInital)))), this) : this
                            },
                            fill(t) {
                        ...
                        return S.prototype = {
                            ...
                            isTagDuplicate(t, e, i) {
                                ...
                                for (let n of this.value) s(this.trim("" + t), n.value, e) && i != n.__tagId && a++;
                                return a
                            },
                            ...
                            replaceTextWithNode(t, e) {
                                if (this.state.tag || e) {
                                    ...
                                    return n.splitText(a.anchorOffset - o), -1 == (i = n.nodeValue.lastIndexOf(e)) || (s = n.splitText(i), t && n.parentNode.replaceChild(t, s)), !0
                                }
                            },
                            selectTag(t, e) {
                                var i = this.settings;
