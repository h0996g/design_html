        ...
        var e = {
                1009: function(e, t, n) {
                    ! function e(t, n, o) {
                        ...
                        for (var r = void 0, a = 0; a < o.length; a++) i(o[a]);
                        return i
                    }({
                        1: [function(e, t, n) {
                            var o = e("dragula");
                            ! function() {
                                this.jKanban = function() {
                                    ...
                                    this._disallowedItemProperties = ["id", "title", "click", "drag", "dragend", "drop", "order"], this.element = "", this.container = "", this.boardContainer = [], this.handlers = [], this.dragula = o, this.drake = "", this.drakeBoard = "", this.itemAddOptions = n, this.itemHandleOptions = t;
                                    var i = {
                                        element: "",
                                        gutter: "15px",
                                        widthBoard: "250px",
                                    ...
                                    arguments[0] && "object" == typeof arguments[0] && (this.options = function(e, t) {
                                        ...
                                        ! function() {
                                            ...
                                            t.classList.add("kanban-container"), e.container = t, document.querySelector(e.options.element).dataset.hasOwnProperty("board") ? (url = document.querySelector(e.options.element).dataset.board, window.fetch(url, {
                                                ...
                                                console.log("Error: ", e)
                                            }))) : e.addBoards(e.options.boards, !0), e.element.appendChild(e.container)
                                        ...
                                        return i.classList.add("kanban-item"), void 0 !== n.id && "" !== n.id && i.setAttribute("data-eid", n.id), n.class && Array.isArray(n.class) && n.class.forEach((function(e) {
                                            i.classList.add(e)
                                        })), i.innerHTML = s(n.title), i.clickfn = n.click, i.dragfn = n.drag, i.dragendfn = n.dragend, i.dropfn = n.drop, d(i, n), r(i), e.options.itemHandleOptions.enabled && (i.style.cursor = "default"), o.appendChild(i), e
                                        ...
                                        for (var f in t) {
                                            var p = t[f];
                                            n || e.options.boards.push(p), e.options.responsivePercentage || ("" === e.container.style.width ? e.container.style.width = parseInt(o) + 2 * parseInt(e.options.gutter) + "px" : e.container.style.width = parseInt(e.container.style.width) + parseInt(o) + 2 * parseInt(e.options.gutter) + "px");
                                            var v = document.createElement("div");
                                            v.dataset.id = p.id, v.dataset.order = e.container.childNodes.length + 1, v.classList.add("kanban-board"), e.options.responsivePercentage ? v.style.width = o + "%" : v.style.width = o, v.style.marginLeft = e.options.gutter, v.style.marginRight = e.options.gutter;
                                            var m = document.createElement("header");
                                            if ("" !== p.class && void 0 !== p.class) var h = p.class.split(",");
                                            else h = [];
                                            m.classList.add("kanban-board-header"), h.map((function(e) {
                                                e = e.replace(/^[ ]+/g, ""), m.classList.add(e)
                                            })), m.innerHTML = '<div class="kanban-title-board">' + p.title + "</div>";
                                            var g = document.createElement("main");
                                            if (g.classList.add("kanban-drag"), "" !== p.bodyClass && void 0 !== p.bodyClass) var y = p.bodyClass.split(",");
                                            else y = [];
                                            for (var b in y.map((function(e) {
                                                    g.classList.add(e)
                                                })), e.boardContainer.push(g), p.item) {
                                                var w = p.item[b],
                                                    T = document.createElement("div");
                                                T.classList.add("kanban-item"), w.id && (T.dataset.eid = w.id), w.class && Array.isArray(w.class) && w.class.forEach((function(e) {
                                                    T.classList.add(e)
                                                })), T.innerHTML = s(w.title), T.clickfn = w.click, T.dragfn = w.drag, T.dragendfn = w.dragend, T.dropfn = w.drop, d(T, w), r(T), e.options.itemHandleOptions.enabled && (T.style.cursor = "default"), g.appendChild(T)
                                            }
                                            var E = document.createElement("footer");
                                            if (i) {
                                                var C = document.createElement("BUTTON"),
                                                    O = document.createTextNode(c || "+");
                                                C.setAttribute("class", l || "kanban-title-button btn btn-default btn-xs"), C.appendChild(O), u ? E.appendChild(C) : m.appendChild(C), a(C, p.id)
                                            }
                                            v.appendChild(m), v.appendChild(g), v.appendChild(E), e.container.appendChild(v)
                                        }
                                        return e
                                        ...
                                        var o = t;
                                        return "string" == typeof o && (o = e.element.querySelector('[data-eid="' + t + '"]')), o.innerHTML = n.title, o.clickfn = n.click, o.dragfn = n.drag, o.dragendfn = n.dragend, o.dropfn = n.drop, d(o, n), e
                            ...
                            (function(n) {
                                (function() {
                                    ...
                                    t.exports = function(e, t) {
                                        ...
                                        var N, _ = null,
                                            I = t || {};
                                        void 0 === I.moves && (I.moves = p), void 0 === I.accepts && (I.accepts = p), void 0 === I.invalid && (I.invalid = function() {
                                            return !1
                                        }), void 0 === I.containers && (I.containers = e || []), void 0 === I.isContainer && (I.isContainer = f), void 0 === I.copy && (I.copy = !1), void 0 === I.copySortSource && (I.copySortSource = !1), void 0 === I.revertOnSpill && (I.revertOnSpill = !1), void 0 === I.removeOnSpill && (I.removeOnSpill = !1), void 0 === I.direction && (I.direction = "vertical"), void 0 === I.ignoreInputTextSelection && (I.ignoreInputTextSelection = !0), void 0 === I.mirrorContainer && (I.mirrorContainer = a.body);
                                        var A = o({
                                        ...
                                        function H(e) {
                                            var t = e ? "remove" : "add";
                                            d(c, t, "mousedown", D), d(c, t, "mouseup", K)
                                        }
                                        ...
                                        function M(e) {
                                            var t = e ? "remove" : "add";
                                            i[t](c, "selectstart", q), i[t](c, "click", q)
                                        }
                                        ...
                                        function D(e) {
                                            if (O = e.clientX, S = e.clientY, 1 === s(e) && !e.metaKey && !e.ctrlKey) {
                                                var t = e.target,
                                                    n = Y(t);
                                                n && (N = n, j(), "mousedown" === e.type && (g(t) ? t.focus() : e.preventDefault()))
                                            }
                                        }
                                            ...
                                            if (N)
                                                if (0 !== s(e)) {
                                                    if (!(void 0 !== e.clientX && Math.abs(e.clientX - O) <= (I.slideFactorX || 0) && void 0 !== e.clientY && Math.abs(e.clientY - S) <= (I.slideFactorY || 0))) {
                                                        ...
                                                        E = w("pageX", e) - f.left, C = w("pageY", e) - f.top, r.add(L || T, "gu-transit"),
                                                            function() {
                                                                if (!n) {
                                                                    var e = T.getBoundingClientRect();
                                                                    (n = T.cloneNode(!0)).style.width = v(e) + "px", n.style.height = m(e) + "px", r.rm(n, "gu-transit"), r.add(n, "gu-mirror"), I.mirrorContainer.appendChild(n), d(c, "add", "mousemove", Q), r.add(I.mirrorContainer, "gu-unselectable"), A.emit("cloned", n, T, "mirror")
                                                                }
                                                            }(), Q(e)
                                                    }
                                                } else K({})
                                        ...
                                        function Y(e) {
                                            if (!(A.dragging && n || P(e))) {
                                                for (var t = e; h(e) && !1 === P(h(e));) {
                                                    if (I.invalid(e, t)) return;
                                                    if (!(e = h(e))) return
                                                }
                                                var o = h(e);
                                                if (o && !I.invalid(e, t) && I.moves(e, o, t, b(e))) return {
                                                    item: e,
                                                    source: o
                                                }
                                            }
                                        ...
                                        function F(e) {
                                            var t, n;
                                            t = e.item, n = e.source, ("boolean" == typeof I.copy ? I.copy : I.copy(t, n)) && (L = e.item.cloneNode(!0), A.emit("cloned", L, e.item, "copy")), y = e.source, T = e.item, x = k = b(e.item), A.dragging = !0, A.emit("drag", T, y)
                                        }
                                        ...
                                        function z(e, t) {
                                            var n = h(e);
                                            L && I.copySortSource && t === y && n.removeChild(T), $(t) ? A.emit("cancel", e, y, y) : A.emit("drop", e, t, y, k), V()
                                        }
                                        ...
                                        function W() {
                                            if (A.dragging) {
                                                var e = L || T,
                                                    t = h(e);
                                                t && t.removeChild(e), A.emit(L ? "cancel" : "remove", e, t, y), V()
                                            }
                                        }
                                        ...
                                        function G(e) {
                                            if (A.dragging) {
                                                var t = arguments.length > 0 ? e : I.revertOnSpill,
                                                    ...
                                                    o = h(n),
                                                    i = $(o);
                                                !1 === i && t && (L ? o && o.removeChild(L) : y.insertBefore(n, x)), i || t ? A.emit("cancel", n, y, y) : A.emit("drop", n, o, y, k), V()
                                            }
                                        }

                                        function V() {
                                            var e = L || T;
                                            U(), n && (r.rm(I.mirrorContainer, "gu-unselectable"), d(c, "remove", "mousemove", Q), h(n).removeChild(n), n = null), e && r.rm(e, "gu-transit"), B && clearTimeout(B), A.dragging = !1, _ && A.emit("out", e, _, y), A.emit("dragend", e), y = T = L = x = k = B = _ = null
                                        }

                                        function $(e, t) {
                                            var o;
                                            return o = void 0 !== t ? t : n ? k : b(L || T), e === y && o === x
                                        }
                                        ...
                                        function Q(e) {
                                            if (n) {
                                                ...
                                                var a = L || T,
                                                    ...
                                                    d = J(c, t, o),
                                                    s = null !== d && d !== _;
                                                (s || null === d) && (_ && v("out"), _ = d, s && v("over"));
                                                var l = h(a);
                                                if (d !== y || !L || I.copySortSource) {
                                                    var f, p = Z(d, c);
                                                    if (null !== p) f = ee(d, p, t, o);
                                                    else {
                                                        if (!0 !== I.revertOnSpill || L) return void(L && l && l.removeChild(a));
                                                        f = x, d = y
                                                    }(null === f && s || f !== a && f !== b(a)) && (k = f, d.insertBefore(a, f), A.emit("shadow", a, d, y))
