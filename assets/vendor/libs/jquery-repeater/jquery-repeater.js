                        ...
                        ! function(t) {
                            var e = function(t, e) {
                                ...
                                p = function(e) {
                                    ...
                                    }, r.equalTo = f, i.$().change((function(t) {
                                ...
                                m = function(t) {
                                    ...
                                    return r.getType = function() {
                                        ...
                                        r.$().val("" === t ? [] : n(t) ? t : [t])
                                    }, e.equalTo = f, r.$().change((function(t) {
                                        e.publishChange(t, this)
                                    })), r
                                },
                                g = function(t) {
                            ...
                            t.fn.inputVal = function(e) {
                                ...
                                return n.is("input, textarea, select") ? void 0 === e ? r[n.attr("name")].get() : (r[n.attr("name")].set(e), n) : void 0 === e ? o(r, "get") : (u(e, (function(t, e) {
                                    r[e].set(t)
                                })), n)
                            ...
                            return r((e = t(this).inputVal(), n = [], u(e, (function(t, e) {
                                var r = [];
                                "undefined" !== e && (r.push(e.match(/^[^\[]*/)[0]), r = r.concat(c(e.match(/\[[^\]]*\]/g), (function(t) {
                                    return t.replace(/[\[\]]/g, "")
                                }))), n.push({
                                    val: t,
                                    key: r
                            ...
                            return r = r || {}, t(this).each((function() {
                                var o = t(this),
                                    ...
                                    l = function(e, n) {
                                        return e.filter((function() {
                                            return !n || 0 === t(this).closest((e = n, c(e, (function(t) {
                                                return t.selector
                                            }))).join(",")).length;
                                            var e
                                        }))
                                        ...
                                        r.repeaters && e.each((function() {
                                            ...
                                            u(r.repeaters, (function(t) {
                                                e.find(t.selector).repeater(function() {
                                                    var t, e = {};
                                                    return u((t = arguments, Array.prototype.slice.call(t)), (function(t) {
                                                        u(t, (function(t, n) {
                                                            e[n] = t
                                                        }))
                                                    })), e
                                ...
                                b(h(), m(), r.repeaters), g(h()), r.initEmpty && h().remove(), r.ready && r.ready((function() {
                                    b(h(), m(), r.repeaters)
                                }));
                                var $, x = ($ = function(i, a, o) {
                                        if (a || r.defaultValues) {
                                            ...
                                            })), i.inputVal(c((s = a || r.defaultValues, p = function(t, e) {
                                                return f[e]
                                            }, n(s) ? (h = [], u(s, (function(t, e, n) {
                                                p(0, e) && h.push(t)
                                            }))) : (h = {}, u(s, (function(t, e, n) {
                                                p(0, e) && (h[e] = t)
                                            }))), h), e, (function(t) {
                                                return f[t]
                                            })))
                                            ...
                                            l(n.find("[data-repeater-item]"), e.repeaters).each((function() {
                                                ...
                                                if (a && a[r]) {
                                                    ...
                                                    n.find("[data-repeater-item]").remove(), u(a[r], (function(t) {
                                                        var r = i.clone();
                                                        $(r, t, e.repeaters || []), n.find("[data-repeater-list]").append(r)
                                                    }))
                                                } else $(t(this), e.defaultValues, e.repeaters || [])
                                            }))
                                        }))
                                    }, function(e, n) {
                                        p.append(e), b(h(), m(), r.repeaters), e.find("[name]").each((function() {
                                            t(this).inputClear()
