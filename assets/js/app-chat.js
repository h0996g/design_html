document.addEventListener("DOMContentLoaded", function() {
    {
        let e = document.querySelector(".app-chat-contacts .sidebar-body"),
            ...
            l = [].slice.call(document.querySelectorAll(".form-check-input[name='chat-user-status']")),
        ...
        e && new PerfectScrollbar(e, {
            ...
            e.addEventListener("click", e => {
                var t = document.querySelector(".chat-sidebar-left-user .avatar"),
                    ...
                    t = (t.removeAttribute("class"), Helpers._addClass("avatar avatar-xl chat-sidebar-avatar " + u[e], t), document.querySelector(".app-chat-contacts .avatar"));
                t.removeAttribute("class"), Helpers._addClass("flex-shrink-0 avatar " + u[e] + " me-3", t)
            })
        }), t.forEach(e => {
            e.addEventListener("click", e => {
                t.forEach(e => {
            ...
            e.preventDefault(), n.value && ((e = document.createElement("div")).className = "chat-message-text mt-2", e.innerHTML = '<p class="mb-0 text-break">' + n.value + "</p>", document.querySelector("li:last-child .chat-message-wrapper").appendChild(e), n.value = "", p())
        });
        let h = document.querySelector(".chat-history-header [data-target='#app-chat-contacts']"),
            m = document.querySelector(".app-chat-sidebar-left .close-sidebar");
        var b, f, y;
        h.addEventListener("click", e => {
            m.removeAttribute("data-overlay")
        }), d.length && null != (b = b || webkitSpeechRecognition) && (f = new b, y = !1, d.on("click", function() {
            let t = $(this);
            !(f.onspeechstart = function() {
                y = !0
            }) === y && f.start(), f.onerror = function(e) {
                y = !1
