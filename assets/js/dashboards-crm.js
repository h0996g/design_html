! function() {
    ...
    d = (l = isDarkStyle ? (o = config.colors_dark.cardColor, e = config.colors_dark.headingColor, r = config.colors_dark.textMuted, t = config.colors_dark.bodyColor, s = config.colors_dark.borderColor, a = "dark", i = "#333457", n = "#3c3e75", "#484b9b") : (o = config.colors.white, e = config.colors.headingColor, r = config.colors.textMuted, t = config.colors.bodyColor, s = config.colors.borderColor, a = "", i = "#ededff", n = "#d5d6ff", "#b7b9ff"), "#696cff");
    const c = {
        series1: "#66C732",
        series2: "#8DE45F",
        series3: "#AAEB87",
    ...
    var h = document.querySelectorAll(".chart-progress"),
        ...
        h = (null !== h && new ApexCharts(h, p).render(), document.querySelector("#salesActivityChart")),
        p = {
            chart: {
                type: "bar",
                height: 275,
        ...
        h = (null !== h && new ApexCharts(h, p).render(), document.querySelector("#reportBarChart")),
        p = {
            chart: {
                height: 120,
                type: "bar",
        ...
        h = (null !== h && new ApexCharts(h, p).render(), document.querySelector("#salesAnalyticsChart")),
        p = {
            chart: {
                height: 350,
                type: "heatmap",
        ...
        h = (null !== h && new ApexCharts(h, p).render(), document.querySelector("#salesStats")),
        p = {
            chart: {
                height: 340,
                type: "radialBar"
