$(function() {
        ...
        }), $(".dataTables_length").addClass("ms-n2 me-2"), $(".dt-action-buttons").addClass("pt-0"), $(".dataTables_filter").addClass("ms-n3 mb-0 mb-md-6"), $(".dt-buttons").addClass("d-flex flex-wrap")), $(".datatables-customers tbody").on("click", ".delete-record", function() {
