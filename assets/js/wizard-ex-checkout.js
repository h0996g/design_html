$(function() {
    ...
    function() {
        ...
        var e = document.querySelector(".credit-card-mask"),
            ...
            l = document.querySelector(".cvv-code-mask"),
            e = (e && new Cleave(e, {
                creditCard: !0,
        ...
        if (null !== e) {
            var r = e.querySelector("#wizard-checkout-form"),
                l = r.querySelector("#checkout-cart"),
                s = r.querySelector("#checkout-address"),
                u = r.querySelector("#checkout-payment"),
                c = r.querySelector("#checkout-confirmation"),
                d = [].slice.call(r.querySelectorAll(".btn-next")),
                r = [].slice.call(r.querySelectorAll(".btn-prev"));
            let t = new Stepper(e, {
                    linear: !1
                }),
                o = FormValidation.formValidation(l, {
                    fields: {},
                    plugins: {
                ...
                i = FormValidation.formValidation(s, {
                    fields: {},
                    plugins: {
                        trigger: new FormValidation.plugins.Trigger,
                        bootstrap5: new FormValidation.plugins.Bootstrap5({
                ...
                n = FormValidation.formValidation(u, {
                    fields: {},
                    plugins: {
                        trigger: new FormValidation.plugins.Trigger,
                        bootstrap5: new FormValidation.plugins.Bootstrap5({
                ...
                a = FormValidation.formValidation(c, {
                    fields: {},
                    plugins: {
                        trigger: new FormValidation.plugins.Trigger,
                        bootstrap5: new FormValidation.plugins.Bootstrap5({
