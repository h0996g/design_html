! function() {
    ...
    e && noUiSlider.create(e, d), t && noUiSlider.create(t, d), i && noUiSlider.create(i, d), n && noUiSlider.create(n, d), r && noUiSlider.create(r, d);
    ...
    l = document.getElementById("slider-vertical"), a = document.getElementById("slider-connect-upper"), o = document.getElementById("slider-vertical-tooltip"), e = document.getElementById("slider-vertical-limit");
