! function() {
    ...
    var a = document.querySelector("#orderChart"),
        ...
        a = (null !== a && new ApexCharts(a, n).render(), document.querySelector("#totalRevenueChart")),
        n = {
            series: [{
        ...
        a = (null !== a && new ApexCharts(a, n).render(), document.querySelector("#growthChart")),
        n = {
            series: [78],
            labels: ["Growth"],
            chart: {
        ...
        a = (null !== a && new ApexCharts(a, n).render(), document.querySelector("#revenueChart")),
        n = {
            chart: {
                height: 95,
                type: "bar",
        ...
        a = (null !== a && new ApexCharts(a, n).render(), document.querySelector("#profileReportChart")),
        n = {
            chart: {
                height: 75,
                type: "line",
        ...
        a = (null !== a && new ApexCharts(a, n).render(), document.querySelector("#orderStatisticsChart")),
        n = {
            chart: {
                height: 145,
                width: 110,
        ...
        a = (null !== a && new ApexCharts(a, n).render(), document.querySelector("#incomeChart")),
        n = {
            series: [{
        ...
        a = (null !== a && new ApexCharts(a, n).render(), document.querySelector("#expensesOfWeek")),
        n = {
            series: [65],
            chart: {
                width: 60,
