document.addEventListener("DOMContentLoaded", function() {
    {
        let e = document.querySelector(".email-list"),
            a = [].slice.call(document.querySelectorAll(".email-list-item")),
            l = [].slice.call(document.querySelectorAll(".email-list-item-input")),
            t = document.querySelector(".app-email-view-content"),
            r = document.querySelector(".email-filters"),
            o = [].slice.call(document.querySelectorAll(".email-filter-folders li")),
            i = document.querySelector(".email-editor"),
            s = document.querySelector(".app-email-sidebar"),
            c = document.querySelector(".app-overlay"),
            n = document.querySelector(".email-reply-editor"),
            d = [].slice.call(document.querySelectorAll(".email-list-item-bookmark")),
            m = document.getElementById("email-select-all"),
            u = document.querySelector(".email-search-input"),
            p = document.querySelector(".email-compose-toggle-cc"),
            v = document.querySelector(".email-compose-toggle-bcc"),
            g = document.querySelector(".app-email-compose"),
            h = document.querySelector(".email-list-delete"),
            S = document.querySelector(".email-list-read"),
            y = document.querySelector(".email-list-empty"),
            k = document.querySelector(".email-refresh"),
            b = document.getElementById("app-email-view"),
            f = [].slice.call(document.querySelectorAll(".email-filter-folders li")),
            L = [].slice.call(document.querySelectorAll(".email-list-item-actions li"));
        if (e && new PerfectScrollbar(e, {
                wheelPropagation: !1,
                suppressScrollX: !0
            }), r && new PerfectScrollbar(r, {
                wheelPropagation: !1,
                suppressScrollX: !0
            }), t && new PerfectScrollbar(t, {
                wheelPropagation: !1,
                suppressScrollX: !0
            }), i && new Quill(".email-editor", {
                modules: {
                    toolbar: ".email-editor-toolbar"
                },
                placeholder: "Message... ",
                theme: "snow"
            }), n && new Quill(".email-reply-editor", {
                modules: {
                ...
                e.addEventListener("click", e => {
                    var t = e.currentTarget.parentNode.parentNode.parentNode,
                ...
                e.currentTarget.checked ? l.forEach(e => e.checked = 1) : l.forEach(e => e.checked = 0)
            }), l && l.forEach(e => {
                e.addEventListener("click", e => {
                    e.stopPropagation();
                    let t = 0;
                    l.forEach(e => {
                        e.checked && t++
                    }), t < l.length ? 0 == t ? m.indeterminate = !1 : m.indeterminate = !0 : t == l.length ? (m.indeterminate = !1, m.checked = !0) : m.indeterminate = !1
                })
            }), u && u.addEventListener("keyup", e => {
                ...
                e.addEventListener("click", e => {
                    ...
                    s.classList.remove("show"), c.classList.remove("show"), Helpers._removeClass("active", o), t.classList.add("active"), a.forEach(e => {
            ...
            }), g.addEventListener("hidden.bs.modal", e => {
                document.querySelector(".email-editor .ql-editor").innerHTML = "", $("#emailContacts").val(""), C()
            }), h && h.addEventListener("click", e => {
                l.forEach(e => {
                    e.checked && e.parentNode.closest("li.email-list-item").remove()
                }), m.indeterminate = !1, m.checked = !1, 0 == document.querySelectorAll(".email-list-item").length && y.classList.remove("d-none")
                ...
                }), m.indeterminate = !1, m.checked = !1
            }), k && e) {
            let t = $(".email-list"),
                l = new PerfectScrollbar(e, {
                    wheelPropagation: !1,
                    suppressScrollX: !0
                });
