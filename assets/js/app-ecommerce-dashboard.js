! function() {
    ...
    l = isDarkStyle ? (o = config.colors_dark.cardColor, e = config.colors_dark.headingColor, r = config.colors_dark.textMuted, a = config.colors_dark.borderColor, t = "dark", s = "#4f51c0", i = "#595cd9", n = "#8789ff", "#c3c4ff") : (o = config.colors.cardColor, e = config.colors.headingColor, r = config.colors.textMuted, a = config.colors.borderColor, t = "", s = "#e1e2ff", i = "#c3c4ff", n = "#a5a7ff", "#696cff");
