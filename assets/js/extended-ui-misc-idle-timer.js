$(function() {
    var a = $("#document-Status"),
        ...
        l = (a.length && ($(document).on("idle.idleTimer", function(e, n, t) {
            ...
            return $(document).idleTimer("pause"), a.val(function(e, n) {
                return n + "Paused @ " + moment().format() + " \n"
            }), $(this).blur(), !1
        }), n.on("click", function() {
            return $(document).idleTimer("resume"), a.val(function(e, n) {
            ...
            return $(document).idleTimer("destroy"), a.val(function(e, n) {
                return n + "Destroyed: @ " + moment().format() + " \n"
            }).removeClass("alert-success").removeClass("alert-warning"), $(this).blur(), !1
        }), i.on("click", function() {
            return $(document).idleTimer({
                timeout: 5e3
            }), a.val(function(e, n) {
                return n + "Init: @ " + moment().format() + " \n"
            }), $(document).idleTimer("isIdle") ? a.removeClass("alert-success").addClass("alert-warning") : a.addClass("alert-success").removeClass("alert-warning"), $(this).blur(), !1
        }), a.val(""), $(document).idleTimer(5e3), $(document).idleTimer("isIdle") ? a.val(function(e, n) {
        ...
        }).addClass("alert-success").removeClass("alert-warning")), $("#element-Status")),
        e = $("#element-Reset"),
        n = $("#element-Remaining"),
        t = $("#element-LastActive"),
        r = $("#element-State");
    l.length && (l.on("idle.idleTimer", function(e, n, t) {
        e.stopPropagation(), l.val(function(e, n) {
            return n + "Idle @ " + moment().format() + " \n"
        }).removeClass("alert-success").addClass("alert-warning")
        ...
        }), $("#element-Status").idleTimer("isIdle") ? l.removeClass("alert-success").addClass("alert-warning") : l.addClass("alert-success").removeClass("alert-warning"), $(this).blur(), !1
    }), n.on("click", function() {
    ...
    }), l.val("").idleTimer(3e3), l.idleTimer("isIdle") ? l.val(function(e, n) {
