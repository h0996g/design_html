! function() {
    ...
    document.getElementsByClassName("plyr")[0].style.borderRadius = "6px", document.getElementsByClassName("plyr__poster")[0].style.display = "none";
