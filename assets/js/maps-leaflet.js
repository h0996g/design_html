! function() {
    var e = {
        ...
        t = (document.getElementById("basicMap") && (t = L.map("basicMap").setView([42.35, -71.08], 10), L.tileLayer("https://{s}.tile.osm.org/{z}/{x}/{y}.png", {
            attribution: 'Map data &copy; <a href="https://www.openstreetmap.org/">OpenStreetMap</a>',
            maxZoom: 18
        }).addTo(t)), document.getElementById("shapeMap")),
        t = (t && (t = L.map("shapeMap").setView([51.5, -.09], 12), L.marker([51.5, -.09]).addTo(t), L.circle([51.508, -.11], {
            color: "red",
            fillColor: "#f03",
            fillOpacity: .5,
            radius: 500
            ...
            [51.503, -.06],
            [51.51, -.047]
        ]).addTo(t), L.tileLayer("https://{s}.tile.osm.org/{z}/{x}/{y}.png", {
            attribution: 'Map data &copy; <a href="https://www.openstreetmap.org/">OpenStreetMap</a>',
            maxZoom: 18
        }).addTo(t)), document.getElementById("dragMap")),
        t = (t && (t = L.map("dragMap").setView([48.817152, 2.455], 12), L.marker([48.817152, 2.455], {
            draggable: "true"
        }).addTo(t).bindPopup("<b>You're here!</b>").openPopup(), L.tileLayer("https://{s}.tile.osm.org/{z}/{x}/{y}.png", {
            attribution: 'Map data &copy; <a href="https://www.openstreetmap.org/">OpenStreetMap</a>',
            maxZoom: 18
        }).addTo(t)), document.getElementById("userLocation"));
    if (t) {
        ...
        o.locate({
            ...
            var t = e.accuracy;
            L.marker(e.latlng).addTo(o).bindPopup("You are somewhere around " + t + " meters from this point").openPopup(), L.circle(e.latlng, t).addTo(o)
        }), L.tileLayer("https://{s}.tile.osm.org/{z}/{x}/{y}.png", {
            attribution: 'Map data &copy; <a href="https://www.openstreetmap.org/">OpenStreetMap</a>',
            maxZoom: 18
        }).addTo(o)
    }
    document.getElementById("customIcons") && (t = L.map("customIcons").setView([51.5, -.09], 10), o = L.icon({
        ...
        icon: a
    }).addTo(t), L.marker([51.4, -.51], {
        icon: o
    }).addTo(t), L.marker([51.49, -.45], {
        icon: r
    }).addTo(t), L.tileLayer("https://{s}.tile.osm.org/{z}/{x}/{y}.png", {
        attribution: 'Map data &copy; <a href="https://www.openstreetmap.org/">OpenStreetMap</a>',
        maxZoom: 18
    }).addTo(t));
    var o, r, a = document.getElementById("geoJson");
    a && (o = L.map("geoJson").setView([44.2669, -72.576], 3), L.geoJson(e).addTo(o), L.geoJson(e, {
        style: function(e) {
            return {
                fillColor: 1e3 < (e = e.properties.density) ? "#800026" : 500 < e ? "#BD0026" : 200 < e ? "#E31A1C" : 100 < e ? "#FC4E2A" : 50 < e ? "#FD8D3C" : 20 < e ? "#FEB24C" : 10 < e ? "#FED976" : "#FFEDA0",
                weight: 2,
                opacity: 1,
                color: "white",
                dashArray: "3",
    ...
    }).addTo(o), L.tileLayer("https://{s}.tile.osm.org/{z}/{x}/{y}.png", {
        attribution: 'Map data &copy; <a href="https://www.openstreetmap.org/">OpenStreetMap</a>',
        maxZoom: 18
    }).addTo(o)), document.getElementById("layerControl") && (r = L.marker([39.61, -105.02]).bindPopup("This is Littleton, CO."), t = L.marker([39.74, -104.99]).bindPopup("This is Denver, CO."), a = L.marker([39.73, -104.8]).bindPopup("This is Aurora, CO."), e = L.marker([39.77, -105.23]).bindPopup("This is Golden, CO."), o = L.layerGroup([r, t, a, e]), r = L.tileLayer("https://tile.openstreetmap.org/{z}/{x}/{y}.png", {
        maxZoom: 18,
        attribution: "© OpenStreetMap"
    }), t = L.tileLayer("https://{s}.tile.openstreetmap.fr/hot/{z}/{x}/{y}.png", {
        maxZoom: 19,
        ...
        Cities: o
    }).addTo(a), L.tileLayer("https://c.tile.osm.org/{z}/{x}/{y}.png", {
        attribution: 'Map data &copy; <a href="https://www.openstreetmap.org/">OpenStreetMap</a>',
        maxZoom: 18
    }).addTo(a))
}();